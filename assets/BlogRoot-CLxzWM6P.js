...
If you are designing a validation system with human fallback, assume the bot will fail. Design for failure. And the way to design for failure is to have plan B as first-class code, not as a \`catch\` branch.`,relatedIds:[`clean-architecture-los`,`catalog-driven-decision-engine`,`domain-exception-problemdetails-pipeline`]}].map(e=>({...e,readingTime:v(e.content)}));y.filter(e=>e.featured);function b(e,t){return e.filter(e=>{if(t.tags.length>0&&!t.tags.every(t=>e.tags.includes(t))||t.category&&e.category!==t.category)return!1;if(t.dateRange){let n=new Date(e.date),r=new Date(t.dateRange.start),i=new Date(t.dateRange.end);if(n<r||n>i)return!1}return!0})}var x=i(),S={tags:[],category:null,dateRange:null},C=(0,_.createContext)(null);function w({children:e}){let[t,n]=(0,_.useState)(S),[r,i]=(0,_.useState)(``),[a,o]=(0,_.useState)(null),[s,c]=(0,_.useState)(`list`),[l,u]=(0,_.useState)(1),d=(0,_.useCallback)(()=>{n(S),i(``),u(1)},[]),f={posts:y,filteredPosts:(0,_.useMemo)(()=>b([...y].sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime()),t),[t]),selectedPost:a,filter:t,searchQuery:r,currentRoute:s,page:l,setFilter:n,setSearchQuery:i,setSelectedPost:o,setCurrentRoute:c,setPage:u,clearFilters:d};return(0,x.jsx)(C.Provider,{value:f,children:e})}function T(){let e=(0,_.useContext)(C);if(!e)throw Error(`useBlogContext must be used within BlogProvider`);return e}function E(){let e=window.location.hash.slice(1);if(e===`blog/list`||e===`blog`||e===``)return{currentRoute:`list`,selectedSlug:null,currentParams:{}};let t=e.match(/^blog\/article\/(.+)$/);if(t)return{currentRoute:`article`,selectedSlug:t[1],currentParams:{}};let n=e.match(/^blog\/tag\/(.+)$/);if(n)return{currentRoute:`tag`,selectedSlug:n[1],currentParams:{tag:n[1]}};let r=e.match(/^blog\/search\?(.+)$/);if(r){let e=Object.fromEntries(new URLSearchParams(r[1]));return{currentRoute:`search`,selectedSlug:e.q??null,currentParams:e}}return{currentRoute:`list`,selectedSlug:null,currentParams:{}}}function D(){let[e,t]=(0,_.useState)(E);(0,_.useEffect)(()=>{let e=()=>t(E());return window.addEventListener(`hashchange`,e),window.addEventListener(`popstate`,e),()=>{window.removeEventListener(`hashchange`,e),window.removeEventListener(`popstate`,e)}},[]);let n=(0,_.useCallback)(e=>{window.location.hash=e},[]);return{...e,navigate:n}}function O({context:e,searchQuery:t=``}){let{lang:n}=a(),{title:r,description:i}={filters:{title:n===`es`?`Sin resultados`:`No results`,description:n===`es`?`No hay artículos que coincidan con los filtros seleccionados. Probá ajustando los criterios.`:`No posts match your current filters. Try adjusting your criteria.`},search:{title:n===`es`?`Sin resultados para "${t}"`:`No results for "${t}"`,description:n===`es`?`No encontramos artículos con ese término. Probá con otras palabras.`:`We couldn't find posts matching that term. Try different keywords.`},none:{title:n===`es`?`Próximamente`:`Coming soon`,description:n===`es`?`Todavía no hay artículos publicados. Volvé pronto.`:`No articles published yet. Check back soon.`}}[e];return(0,x.jsx)(c,{children:(0,x.jsx)(`div`,{className:`border-2 border-rule bg-paper-dark p-8 md:p-12 text-center`,children:(0,x.jsxs)(`div`,{className:`max-w-md mx-auto`,children:[(0,x.jsx)(`h3`,{className:`font-headline text-xl md:text-2xl font-bold text-ink mb-3`,children:r}),(0,x.jsx)(`p`,{className:`font-sans text-sm text-ink-light leading-relaxed`,children:i})]})})})}var k=6;function A({post:e,index:t,onRead:n}){let{lang:r}=a(),i=r===`es`?e.title:e.titleEn,o=r===`es`?e.excerpt:e.excerptEn;return(0,x.jsx)(c,{delay:t*.08,children:(0,x.jsx)(`article`,{className:`border-2 border-rule bg-paper shadow-pixel-sm hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 active:shadow-none active:translate-x-0.5 active:translate-y-0.5 transition-all duration-75 flex flex-col h-full`,children:(0,x.jsxs)(`div`,{className:`p-5 flex-1 flex flex-col gap-3`,children:[(0,x.jsx)(`div`,{className:`flex flex-wrap gap-1`,children:e.tags.slice(0,3).map(e=>(0,x.jsxs)(`span`,{className:`skill-tag text-[9px] flex items-center gap-1`,children:[(0,x.jsx)(g,{size:7}),` `,e]},e))}),(0,x.jsx)(`h3`,{className:`font-headline text-lg font-bold text-ink leading-tight line-clamp-2`,children:i}),(0,x.jsx)(`p`,{className:`font-sans text-xs text-ink-light leading-relaxed line-clamp-3 flex-1`,children:o}),(0,x.jsxs)(`div`,{className:`flex items-center justify-between pt-3 border-t border-rule-light mt-auto`,children:[(0,x.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,x.jsx)(`span`,{className:`font-mono text-[10px] text-ink-muted`,children:e.date}),(0,x.jsxs)(`span`,{className:`font-mono text-[10px] text-ink-muted flex items-center gap-1`,children:[(0,x.jsx)(m,{size:9}),` `,e.readingTime,` min`]})]}),(0,x.jsxs)(`button`,{onClick:n,className:`font-mono text-[10px] font-bold uppercase tracking-wider text-accent hover:text-accent-dark flex items-center gap-1 transition-colors cursor-pointer`,children:[r===`es`?`Leer`:`Read`,` `,(0,x.jsx)(d,{size:10})]})]})]})})})}function ee(){let{lang:e}=a(),{filteredPosts:t,page:n,setPage:r}=T(),[i,s]=(0,_.useState)(!1),c=t.length,l=i?c:Math.min(n*k,c),u=l<c,d=()=>{r(n+1)},f=()=>{s(!0)},p=e=>{window.location.hash=`#blog/article/${e.slug}`};return c===0?(0,x.jsx)(O,{context:`filters`}):(0,x.jsxs)(`div`,{children:[(0,x.jsx)(`div`,{className:`grid md:grid-cols-2 lg:grid-cols-3 gap-5`,children:t.slice(0,l).map((e,t)=>(0,x.jsx)(o.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.3,delay:t%k*.05},children:(0,x.jsx)(A,{post:e,index:t,onRead:()=>p(e)})},e.id))}),(0,x.jsxs)(`div`,{className:`flex justify-center gap-3 mt-8`,children:[u&&(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`button`,{onClick:d,className:`px-btn`,children:e===`es`?`Cargar más`:`Load more`}),(0,x.jsx)(`button`,{onClick:f,className:`px-btn px-btn-outline`,children:e===`es`?`Mostrar todos`:`Show all`})]}),!u&&c>k&&(0,x.jsxs)(`p`,{className:`font-mono text-[10px] text-ink-muted`,children:[c,` `,e===`es`?`artículos`:`articles`]})]})]})}var j=document.createElement(`i`);function M(e){let t=`&`+e+`;`;j.innerHTML=t;let n=j.textContent;return n.charCodeAt(n.length-1)===59&&e!==`semi`||n===t?!1:n}function N(e,t,n,r){let i=e.length,a=0,o;if(t=t<0?-t>i?0:i+t:t>i?i:t,n=n>0?n:0,r.length<1e4)o=Array.from(r),o.unshift(t,n),e.splice(...o);else for(n&&e.splice(t,n);a<r.length;)o=r.slice(a,a+1e4),o.unshift(t,0),e.splice(...o),a+=1e4,t+=1e4}function P(e,t){return e.length>0?(N(e,e.length,0,t),e):t}var F={}.hasOwnProperty;function I(e){let t={},n=-1;for(;++n<e.length;)L(t,e[n]);return t}function L(e,t){let n;for(n in t){let r=(F.call(e,n)?e[n]:void 0)||(e[n]={}),i=t[n],a;if(i)for(a in i){F.call(r,a)||(r[a]=[]);let e=i[a];te(r[a],Array.isArray(e)?e:e?[e]:[])}}}function te(e,t){let n=-1,r=[];for(;++n<t.length;)(t[n].add===`after`?e:r).push(t[n]);N(e,0,0,r)}function ne(e){let t={},n=-1;for(;++n<e.length;)re(t,e[n]);return t}function re(e,t){let n;for(n in t){let r=(F.call(e,n)?e[n]:void 0)||(e[n]={}),i=t[n],a;if(i)for(a in i)r[a]=i[a]}}function ie(e,t){let n=Number.parseInt(e,t);return n<9||n===11||n>13&&n<32||n>126&&n<160||n>55295&&n<57344||n>64975&&n<65008||(n&65535)==65535||(n&65535)==65534||n>1114111?`�`:String.fromCodePoint(n)}var ae={'"':`quot`,"&":`amp`,"<":`lt`,">":`gt`};function oe(e){return e.replace(/["&<>]/g,t);function t(e){return`&`+ae[e]+`;`}}function R(e){return e.replace(/[\t\n\r ]+/g,` `).replace(/^ | $/g,``).toLowerCase().toUpperCase()}var z=G(/[A-Za-z]/),B=G(/[\dA-Za-z]/),se=G(/[#-'*+\--9=?A-Z^-~]/);function V(e){return e!==null&&(e<32||e===127)}var ce=G(/\d/),le=G(/[\dA-Fa-f]/),ue=G(/[!-/:-@[-`{-~]/);function H(e){return e!==null&&e<-2}function U(e){return e!==null&&(e<0||e===32)}function W(e){return e===-2||e===-1||e===32}var de=G(/\p{P}|\p{S}/u),fe=G(/\s/);function G(e){return t;function t(t){return t!==null&&t>-1&&e.test(String.fromCharCode(t))}}function pe(e,t){let n=oe(me(e||``));if(!t)return n;let r=n.indexOf(`:`),i=n.indexOf(`?`),a=n.indexOf(`#`),o=n.indexOf(`/`);return r<0||o>-1&&r>o||i>-1&&r>i||a>-1&&r>a||t.test(n.slice(0,r))?n:``}function me(e){let t=[],n=-1,r=0,i=0;for(;++n<e.length;){let a=e.charCodeAt(n),o=``;if(a===37&&B(e.charCodeAt(n+1))&&B(e.charCodeAt(n+2)))i=2;else if(a<128)/[!#$&-;=?-Z_a-z~]/.test(String.fromCharCode(a))||(o=String.fromCharCode(a));else if(a>55295&&a<57344){let t=e.charCodeAt(n+1);a<56320&&t>56319&&t<57344?(o=String.fromCharCode(a,t),i=1):o=`�`}else o=String.fromCharCode(a);o&&=(t.push(e.slice(r,n),encodeURIComponent(o)),r=n+i+1,``),i&&=(n+=i,0)}return t.join(``)+e.slice(r)}var he={}.hasOwnProperty,ge=/^(https?|ircs?|mailto|xmpp)$/i,_e=/^https?$/i;function ve(e){let t=e||{},n=!0,r={},i=[[]],a=[],o=[],s=ne([{enter:{blockQuote:A,codeFenced:F,codeFencedFenceInfo:h,codeFencedFenceMeta:h,codeIndented:te,codeText:Me,content:K,definition:W,definitionDestinationString:fe,definitionLabelString:h,definitionTitleString:h,emphasis:je,htmlFlow:Oe,htmlText:Ae,image:ae,label:h,link:z,listItemMarker:E,listItemValue:T,listOrdered:C,listUnordered:w,paragraph:j,reference:h,resource:ce,resourceDestinationString:le,resourceTitleString:h,setextHeading:be,strong:J},exit:{atxHeading:Se,atxHeadingSequence:ye,autolinkEmail:Be,autolinkProtocol:ze,blockQuote:ee,characterEscapeValue:q,characterReferenceMarkerHexadecimal:Le,characterReferenceMarkerNumeric:Le,characterReferenceValue:Re,codeFenced:re,codeFencedFence:L,codeFencedFenceInfo:I,codeFencedFenceMeta:S,codeFlowValue:Ee,codeIndented:re,codeText:Ne,codeTextData:q,data:q,definition:ve,definitionDestinationString:G,definitionLabelString:de,definitionTitleString:me,emphasis:Pe,hardBreakEscape:De,hardBreakTrailing:De,htmlFlow:ke,htmlFlowData:q,htmlText:ke,htmlTextData:q,image:U,label:se,labelText:B,lineEnding:Te,link:U,listOrdered:D,listUnordered:O,paragraph:N,reference:S,referenceString:V,resource:S,resourceDestinationString:ue,resourceTitleString:H,setextHeading:we,setextHeadingLineSequence:Ce,setextHeadingText:xe,strong:Fe,thematicBreak:Ie}},...t.htmlExtensions||[]]),c={definitions:r,tightStack:o},l={buffer:h,encode:x,getData:m,lineEndingIfNeeded:b,options:t,raw:v,resume:g,setData:p,tag:_},u=t.defaultLineEnding;return d;function d(e){let t=-1,n=0,r=[],a=[],o=[];for(;++t<e.length;)!u&&(e[t][1].type===`lineEnding`||e[t][1].type===`lineEndingBlank`)&&(u=e[t][2].sliceSerialize(e[t][1])),(e[t][1].type===`listOrdered`||e[t][1].type===`listUnordered`)&&(e[t][0]===`enter`?r.push(t):f(e.slice(r.pop(),t))),e[t][1].type===`definition`&&(e[t][0]===`enter`?(o=P(o,e.slice(n,t)),n=t):(a=P(a,e.slice(n,t+1)),n=t+1));a=P(a,o),a=P(a,e.slice(n)),t=-1;let c=a;for(s.enter.null&&s.enter.null.call(l);++t<e.length;){let e=s[c[t][0]],n=c[t][1].type,r=e[n];he.call(e,n)&&r&&r.call({sliceSerialize:c[t][2].sliceSerialize,...l},c[t][1])}return s.exit.null&&s.exit.null.call(l),i[0].join(``)}function f(e){let t=e.length,n=0,r=0,i=!1,a;for(;++n<t;){let t=e[n];if(t[1]._container)a=void 0,t[0]===`enter`?r++:r--;else switch(t[1].type){case`listItemPrefix`:t[0]===`exit`&&(a=!0);break;case`linePrefix`:break;case`lineEndingBlank`:t[0]===`enter`&&!r&&(a?a=void 0:i=!0);break;default:a=void 0}}e[0][1]._loose=i}function p(e,t){c[e]=t}function m(e){return c[e]}function h(){i.push([])}function g(){return i.pop().join(``)}function _(e){n&&(p(`lastWasTag`,!0),i[i.length-1].push(e))}function v(e){p(`lastWasTag`),i[i.length-1].push(e)}function y(){v(u||`
`)}function b(){let e=i[i.length-1],t=e[e.length-1],n=t?t.charCodeAt(t.length-1):null;n===10||n===13||n===null||y()}function x(e){return m(`ignoreEncode`)?e:oe(e)}function S(){g()}function C(e){o.push(!e._loose),b(),_(`<ol`),p(`expectFirstItem`,!0)}function w(e){o.push(!e._loose),b(),_(`<ul`),p(`expectFirstItem`,!0)}function T(e){if(m(`expectFirstItem`)){let t=Number.parseInt(this.sliceSerialize(e),10);t!==1&&_(` start="`+x(String(t))+`"`)}}function E(){m(`expectFirstItem`)?_(`>`):k(),b(),_(`<li>`),p(`expectFirstItem`),p(`lastWasTag`)}function D(){k(),o.pop(),y(),_(`</ol>`)}function O(){k(),o.pop(),y(),_(`</ul>`)}function k(){m(`lastWasTag`)&&!m(`slurpAllLineEndings`)&&b(),_(`</li>`),p(`slurpAllLineEndings`)}function A(){o.push(!1),b(),_(`<blockquote>`)}function ee(){o.pop(),b(),_(`</blockquote>`),p(`slurpAllLineEndings`)}function j(){o[o.length-1]||(b(),_(`<p>`)),p(`slurpAllLineEndings`)}function N(){o[o.length-1]?p(`slurpAllLineEndings`,!0):_(`</p>`)}function F(){b(),_(`<pre><code`),p(`fencesCount`,0)}function I(){_(` class="language-`+g()+`"`)}function L(){let e=m(`fencesCount`)||0;e||(_(`>`),p(`slurpOneLineEnding`,!0)),p(`fencesCount`,e+1)}function te(){b(),_(`<pre><code>`)}function re(){let e=m(`fencesCount`);e!==void 0&&e<2&&c.tightStack.length>0&&!m(`lastWasTag`)&&y(),m(`flowCodeSeenData`)&&b(),_(`</code></pre>`),e!==void 0&&e<2&&b(),p(`flowCodeSeenData`),p(`fencesCount`),p(`slurpOneLineEnding`)}function ae(){a.push({image:!0}),n=void 0}function z(){a.push({})}function B(e){a[a.length-1].labelId=this.sliceSerialize(e)}function se(){a[a.length-1].label=g()}function V(e){a[a.length-1].referenceId=this.sliceSerialize(e)}function ce(){h(),a[a.length-1].destination=``}function le(){h(),p(`ignoreEncode`,!0)}function ue(){a[a.length-1].destination=g(),p(`ignoreEncode`)}function H(){a[a.length-1].title=g()}function U(){let e=a.length-1,i=a[e],o=i.referenceId||i.labelId,s=i.destination===void 0?r[R(o)]:i;for(n=!0;e--;)if(a[e].image){n=void 0;break}i.image?(_(`<img src="`+pe(s.destination,t.allowDangerousProtocol?void 0:_e)+`" alt="`),v(i.label),_(`"`)):_(`<a href="`+pe(s.destination,t.allowDangerousProtocol?void 0:ge)+`"`),_(s.title?` title="`+s.title+`"`:``),i.image?_(` />`):(_(`>`),v(i.label),_(`</a>`)),a.pop()}function W(){h(),a.push({})}function de(e){g(),a[a.length-1].labelId=this.sliceSerialize(e)}function fe(){h(),p(`ignoreEncode`,!0)}function G(){a[a.length-1].destination=g(),p(`ignoreEncode`)}function me(){a[a.length-1].title=g()}function ve(){let e=a[a.length-1],t=R(e.labelId);g(),he.call(r,t)||(r[t]=a[a.length-1]),a.pop()}function K(){p(`slurpAllLineEndings`,!0)}function ye(e){m(`headingRank`)||(p(`headingRank`,this.sliceSerialize(e).length),b(),_(`<h`+m(`headingRank`)+`>`))}function be(){h(),p(`slurpAllLineEndings`)}function xe(){p(`slurpAllLineEndings`,!0)}function Se(){_(`</h`+m(`headingRank`)+`>`),p(`headingRank`)}function Ce(e){p(`headingRank`,this.sliceSerialize(e).charCodeAt(0)===61?1:2)}function we(){let e=g();b(),_(`<h`+m(`headingRank`)+`>`),v(e),_(`</h`+m(`headingRank`)+`>`),p(`slurpAllLineEndings`),p(`headingRank`)}function q(e){v(x(this.sliceSerialize(e)))}function Te(e){if(!m(`slurpAllLineEndings`)){if(m(`slurpOneLineEnding`)){p(`slurpOneLineEnding`);return}if(m(`inCodeText`)){v(` `);return}v(x(this.sliceSerialize(e)))}}function Ee(e){v(x(this.sliceSerialize(e))),p(`flowCodeSeenData`,!0)}function De(){_(`<br />`)}function Oe(){b(),Ae()}function ke(){p(`ignoreEncode`)}function Ae(){t.allowDangerousHtml&&p(`ignoreEncode`,!0)}function je(){_(`<em>`)}function J(){_(`<strong>`)}function Me(){p(`inCodeText`,!0),_(`<code>`)}function Ne(){p(`inCodeText`),_(`</code>`)}function Pe(){_(`</em>`)}function Fe(){_(`</strong>`)}function Ie(){b(),_(`<hr />`)}function Le(e){p(`characterReferenceType`,e.type)}function Re(e){let t=this.sliceSerialize(e);v(x(m(`characterReferenceType`)?ie(t,m(`characterReferenceType`)===`characterReferenceMarkerNumeric`?10:16):M(t))),p(`characterReferenceType`)}function ze(e){let n=this.sliceSerialize(e);_(`<a href="`+pe(n,t.allowDangerousProtocol?void 0:ge)+`">`),v(x(n)),_(`</a>`)}function Be(e){let t=this.sliceSerialize(e);_(`<a href="`+pe(`mailto:`+t)+`">`),v(x(t)),_(`</a>`)}}function K(e,t,n,r){let i=r?r-1:1/0,a=0;return o;function o(r){return W(r)?(e.enter(n),s(r)):t(r)}function s(r){return W(r)&&a++<i?(e.consume(r),s):(e.exit(n),t(r))}}var ye={tokenize:be};function be(e){let t=e.attempt(this.parser.constructs.contentInitial,r,i),n;return t;function r(n){if(n===null){e.consume(n);return}return e.enter(`lineEnding`),e.consume(n),e.exit(`lineEnding`),K(e,t,`linePrefix`)}function i(t){return e.enter(`paragraph`),a(t)}function a(t){let r=e.enter(`chunkText`,{contentType:`text`,previous:n});return n&&(n.next=r),n=r,o(t)}function o(t){if(t===null){e.exit(`chunkText`),e.exit(`paragraph`),e.consume(t);return}return H(t)?(e.consume(t),e.exit(`chunkText`),a):(e.consume(t),o)}}var xe={tokenize:Ce},Se={tokenize:we};function Ce(e){let t=this,n=[],r=0,i,a,o;return s;function s(i){if(r<n.length){let a=n[r];return t.containerState=a[1],e.attempt(a[0].continuation,c,l)(i)}return l(i)}function c(e){if(r++,t.containerState._closeFlow){t.containerState._closeFlow=void 0,i&&v();let n=t.events.length,a=n,o;for(;a--;)if(t.events[a][0]===`exit`&&t.events[a][1].type===`chunkFlow`){o=t.events[a][1].end;break}_(r);let s=n;for(;s<t.events.length;)t.events[s][1].end={...o},s++;return N(t.events,a+1,0,t.events.slice(n)),t.events.length=s,l(e)}return s(e)}function l(a){if(r===n.length){if(!i)return f(a);if(i.currentConstruct&&i.currentConstruct.concrete)return m(a);t.interrupt=!!(i.currentConstruct&&!i._gfmTableDynamicInterruptHack)}return t.containerState={},e.check(Se,u,d)(a)}function u(e){return i&&v(),_(r),f(e)}function d(e){return t.parser.lazy[t.now().line]=r!==n.length,o=t.now().offset,m(e)}function f(n){return t.containerState={},e.attempt(Se,p,m)(n)}function p(e){return r++,n.push([t.currentConstruct,t.containerState]),f(e)}function m(n){if(n===null){i&&v(),_(0),e.consume(n);return}return i||=t.parser.flow(t.now()),e.enter(`chunkFlow`,{_tokenizer:i,contentType:`flow`,previous:a}),h(n)}function h(n){if(n===null){g(e.exit(`chunkFlow`),!0),_(0),e.consume(n);return}return H(n)?(e.consume(n),g(e.exit(`chunkFlow`)),r=0,t.interrupt=void 0,s):(e.consume(n),h)}function g(e,n){let s=t.sliceStream(e);if(n&&s.push(null),e.previous=a,a&&(a.next=e),a=e,i.defineSkip(e.start),i.write(s),t.parser.lazy[e.start.line]){let e=i.events.length;for(;e--;)if(i.events[e][1].start.offset<o&&(!i.events[e][1].end||i.events[e][1].end.offset>o))return;let n=t.events.length,a=n,s,c;for(;a--;)if(t.events[a][0]===`exit`&&t.events[a][1].type===`chunkFlow`){if(s){c=t.events[a][1].end;break}s=!0}for(_(r),e=n;e<t.events.length;)t.events[e][1].end={...c},e++;N(t.events,a+1,0,t.events.slice(n)),t.events.length=e}}function _(r){let i=n.length;for(;i-- >r;){let r=n[i];t.containerState=r[1],r[0].exit.call(t,e)}n.length=r}function v(){i.write([null]),a=void 0,i=void 0,t.containerState._closeFlow=void 0}}function we(e,t,n){return K(e,e.attempt(this.parser.constructs.document,t,n),`linePrefix`,this.parser.constructs.disable.null.includes(`codeIndented`)?void 0:4)}function q(e){if(e===null||U(e)||fe(e))return 1;if(de(e))return 2}function Te(e,t,n){let r=[],i=-1;for(;++i<e.length;){let a=e[i].resolveAll;a&&!r.includes(a)&&(t=a(t,n),r.push(a))}return t}var Ee={name:`attention`,resolveAll:De,tokenize:Oe};function De(e,t){let n=-1,r,i,a,o,s,c,l,u;for(;++n<e.length;)if(e[n][0]===`enter`&&e[n][1].type===`attentionSequence`&&e[n][1]._close){for(r=n;r--;)if(e[r][0]===`exit`&&e[r][1].type===`attentionSequence`&&e[r][1]._open&&t.sliceSerialize(e[r][1]).charCodeAt(0)===t.sliceSerialize(e[n][1]).charCodeAt(0)){if((e[r][1]._close||e[n][1]._open)&&(e[n][1].end.offset-e[n][1].start.offset)%3&&!((e[r][1].end.offset-e[r][1].start.offset+e[n][1].end.offset-e[n][1].start.offset)%3))continue;c=e[r][1].end.offset-e[r][1].start.offset>1&&e[n][1].end.offset-e[n][1].start.offset>1?2:1;let d={...e[r][1].end},f={...e[n][1].start};ke(d,-c),ke(f,c),o={type:c>1?`strongSequence`:`emphasisSequence`,start:d,end:{...e[r][1].end}},s={type:c>1?`strongSequence`:`emphasisSequence`,start:{...e[n][1].start},end:f},a={type:c>1?`strongText`:`emphasisText`,start:{...e[r][1].end},end:{...e[n][1].start}},i={type:c>1?`strong`:`emphasis`,start:{...o.start},end:{...s.end}},e[r][1].end={...o.start},e[n][1].start={...s.end},l=[],e[r][1].end.offset-e[r][1].start.offset&&(l=P(l,[[`enter`,e[r][1],t],[`exit`,e[r][1],t]])),l=P(l,[[`enter`,i,t],[`enter`,o,t],[`exit`,o,t],[`enter`,a,t]]),l=P(l,Te(t.parser.constructs.insideSpan.null,e.slice(r+1,n),t)),l=P(l,[[`exit`,a,t],[`enter`,s,t],[`exit`,s,t],[`exit`,i,t]]),e[n][1].end.offset-e[n][1].start.offset?(u=2,l=P(l,[[`enter`,e[n][1],t],[`exit`,e[n][1],t]])):u=0,N(e,r-1,n-r+3,l),n=r+l.length-u-2;break}}for(n=-1;++n<e.length;)e[n][1].type===`attentionSequence`&&(e[n][1].type=`data`);return e}function Oe(e,t){let n=this.parser.constructs.attentionMarkers.null,r=this.previous,i=q(r),a;return o;function o(t){return a=t,e.enter(`attentionSequence`),s(t)}function s(o){if(o===a)return e.consume(o),s;let c=e.exit(`attentionSequence`),l=q(o),u=!l||l===2&&i||n.includes(o),d=!i||i===2&&l||n.includes(r);return c._open=!!(a===42?u:u&&(i||!d)),c._close=!!(a===42?d:d&&(l||!u)),t(o)}}function ke(e,t){e.column+=t,e.offset+=t,e._bufferIndex+=t}var Ae={name:`autolink`,tokenize:je};function je(e,t,n){let r=0;return i;function i(t){return e.enter(`autolink`),e.enter(`autolinkMarker`),e.consume(t),e.exit(`autolinkMarker`),e.enter(`autolinkProtocol`),a}function a(t){return z(t)?(e.consume(t),o):t===64?n(t):l(t)}function o(e){return e===43||e===45||e===46||B(e)?(r=1,s(e)):l(e)}function s(t){return t===58?(e.consume(t),r=0,c):(t===43||t===45||t===46||B(t))&&r++<32?(e.consume(t),s):(r=0,l(t))}function c(r){return r===62?(e.exit(`autolinkProtocol`),e.enter(`autolinkMarker`),e.consume(r),e.exit(`autolinkMarker`),e.exit(`autolink`),t):r===null||r===32||r===60||V(r)?n(r):(e.consume(r),c)}function l(t){return t===64?(e.consume(t),u):se(t)?(e.consume(t),l):n(t)}function u(e){return B(e)?d(e):n(e)}function d(n){return n===46?(e.consume(n),r=0,u):n===62?(e.exit(`autolinkProtocol`).type=`autolinkEmail`,e.enter(`autolinkMarker`),e.consume(n),e.exit(`autolinkMarker`),e.exit(`autolink`),t):f(n)}function f(t){if((t===45||B(t))&&r++<63){let n=t===45?f:d;return e.consume(t),n}return n(t)}}var J={partial:!0,tokenize:Me};function Me(e,t,n){return r;function r(t){return W(t)?K(e,i,`linePrefix`)(t):i(t)}function i(e){return e===null||H(e)?t(e):n(e)}}var Ne={continuation:{tokenize:Fe},exit:Ie,name:`blockQuote`,tokenize:Pe};function Pe(e,t,n){let r=this;return i;function i(t){if(t===62){let n=r.containerState;return n.open||=(e.enter(`blockQuote`,{_container:!0}),!0),e.enter(`blockQuotePrefix`),e.enter(`blockQuoteMarker`),e.consume(t),e.exit(`blockQuoteMarker`),a}return n(t)}function a(n){return W(n)?(e.enter(`blockQuotePrefixWhitespace`),e.consume(n),e.exit(`blockQuotePrefixWhitespace`),e.exit(`blockQuotePrefix`),t):(e.exit(`blockQuotePrefix`),t(n))}}function Fe(e,t,n){let r=this;return i;function i(t){return W(t)?K(e,a,`linePrefix`,r.parser.constructs.disable.null.includes(`codeIndented`)?void 0:4)(t):a(t)}function a(r){return e.attempt(Ne,t,n)(r)}}function Ie(e){e.exit(`blockQuote`)}var Le={name:`characterEscape`,tokenize:Re};function Re(e,t,n){return r;function r(t){return e.enter(`characterEscape`),e.enter(`escapeMarker`),e.consume(t),e.exit(`escapeMarker`),i}function i(r){return ue(r)?(e.enter(`characterEscapeValue`),e.consume(r),e.exit(`characterEscapeValue`),e.exit(`characterEscape`),t):n(r)}}var ze={name:`characterReference`,tokenize:Be};function Be(e,t,n){let r=this,i=0,a,o;return s;function s(t){return e.enter(`characterReference`),e.enter(`characterReferenceMarker`),e.consume(t),e.exit(`characterReferenceMarker`),c}function c(t){return t===35?(e.enter(`characterReferenceMarkerNumeric`),e.consume(t),e.exit(`characterReferenceMarkerNumeric`),l):(e.enter(`characterReferenceValue`),a=31,o=B,u(t))}function l(t){return t===88||t===120?(e.enter(`characterReferenceMarkerHexadecimal`),e.consume(t),e.exit(`characterReferenceMarkerHexadecimal`),e.enter(`characterReferenceValue`),a=6,o=le,u):(e.enter(`characterReferenceValue`),a=7,o=ce,u(t))}function u(s){if(s===59&&i){let i=e.exit(`characterReferenceValue`);return o===B&&!M(r.sliceSerialize(i))?n(s):(e.enter(`characterReferenceMarker`),e.consume(s),e.exit(`characterReferenceMarker`),e.exit(`characterReference`),t)}return o(s)&&i++<a?(e.consume(s),u):n(s)}}var Ve={partial:!0,tokenize:We},He={concrete:!0,name:`codeFenced`,tokenize:Ue};function Ue(e,t,n){let r=this,i={partial:!0,tokenize:x},a=0,o=0,s;return c;function c(e){return l(e)}function l(t){let n=r.events[r.events.length-1];return a=n&&n[1].type===`linePrefix`?n[2].sliceSerialize(n[1],!0).length:0,s=t,e.enter(`codeFenced`),e.enter(`codeFencedFence`),e.enter(`codeFencedFenceSequence`),u(t)}function u(t){return t===s?(o++,e.consume(t),u):o<3?n(t):(e.exit(`codeFencedFenceSequence`),W(t)?K(e,d,`whitespace`)(t):d(t))}function d(n){return n===null||H(n)?(e.exit(`codeFencedFence`),r.interrupt?t(n):e.check(Ve,h,b)(n)):(e.enter(`codeFencedFenceInfo`),e.enter(`chunkString`,{contentType:`string`}),f(n))}function f(t){return t===null||H(t)?(e.exit(`chunkString`),e.exit(`codeFencedFenceInfo`),d(t)):W(t)?(e.exit(`chunkString`),e.exit(`codeFencedFenceInfo`),K(e,p,`whitespace`)(t)):t===96&&t===s?n(t):(e.consume(t),f)}function p(t){return t===null||H(t)?d(t):(e.enter(`codeFencedFenceMeta`),e.enter(`chunkString`,{contentType:`string`}),m(t))}function m(t){return t===null||H(t)?(e.exit(`chunkString`),e.exit(`codeFencedFenceMeta`),d(t)):t===96&&t===s?n(t):(e.consume(t),m)}function h(t){return e.attempt(i,b,g)(t)}function g(t){return e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),_}function _(t){return a>0&&W(t)?K(e,v,`linePrefix`,a+1)(t):v(t)}function v(t){return t===null||H(t)?e.check(Ve,h,b)(t):(e.enter(`codeFlowValue`),y(t))}function y(t){return t===null||H(t)?(e.exit(`codeFlowValue`),v(t)):(e.consume(t),y)}function b(n){return e.exit(`codeFenced`),t(n)}function x(e,t,n){let i=0;return a;function a(t){return e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),c}function c(t){return e.enter(`codeFencedFence`),W(t)?K(e,l,`linePrefix`,r.parser.constructs.disable.null.includes(`codeIndented`)?void 0:4)(t):l(t)}function l(t){return t===s?(e.enter(`codeFencedFenceSequence`),u(t)):n(t)}function u(t){return t===s?(i++,e.consume(t),u):i>=o?(e.exit(`codeFencedFenceSequence`),W(t)?K(e,d,`whitespace`)(t):d(t)):n(t)}function d(r){return r===null||H(r)?(e.exit(`codeFencedFence`),t(r)):n(r)}}}function We(e,t,n){let r=this;return i;function i(t){return t===null?n(t):(e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),a)}function a(e){return r.parser.lazy[r.now().line]?n(e):t(e)}}var Ge={name:`codeIndented`,tokenize:qe},Ke={partial:!0,tokenize:Je};function qe(e,t,n){let r=this;return i;function i(t){return e.enter(`codeIndented`),K(e,a,`linePrefix`,5)(t)}function a(e){let t=r.events[r.events.length-1];return t&&t[1].type===`linePrefix`&&t[2].sliceSerialize(t[1],!0).length>=4?o(e):n(e)}function o(t){return t===null?c(t):H(t)?e.attempt(Ke,o,c)(t):(e.enter(`codeFlowValue`),s(t))}function s(t){return t===null||H(t)?(e.exit(`codeFlowValue`),o(t)):(e.consume(t),s)}function c(n){return e.exit(`codeIndented`),t(n)}}function Je(e,t,n){let r=this;return i;function i(t){return r.parser.lazy[r.now().line]?n(t):H(t)?(e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),i):K(e,a,`linePrefix`,5)(t)}function a(e){let a=r.events[r.events.length-1];return a&&a[1].type===`linePrefix`&&a[2].sliceSerialize(a[1],!0).length>=4?t(e):H(e)?i(e):n(e)}}var Ye={name:`codeText`,previous:Ze,resolve:Xe,tokenize:Qe};function Xe(e){let t=e.length-4,n=3,r,i;if((e[n][1].type===`lineEnding`||e[n][1].type===`space`)&&(e[t][1].type===`lineEnding`||e[t][1].type===`space`)){for(r=n;++r<t;)if(e[r][1].type===`codeTextData`){e[n][1].type=`codeTextPadding`,e[t][1].type=`codeTextPadding`,n+=2,t-=2;break}}for(r=n-1,t++;++r<=t;)i===void 0?r!==t&&e[r][1].type!==`lineEnding`&&(i=r):(r===t||e[r][1].type===`lineEnding`)&&(e[i][1].type=`codeTextData`,r!==i+2&&(e[i][1].end=e[r-1][1].end,e.splice(i+2,r-i-2),t-=r-i-2,r=i+2),i=void 0);return e}function Ze(e){return e!==96||this.events[this.events.length-1][1].type===`characterEscape`}function Qe(e,t,n){let r=0,i,a;return o;function o(t){return e.enter(`codeText`),e.enter(`codeTextSequence`),s(t)}function s(t){return t===96?(e.consume(t),r++,s):(e.exit(`codeTextSequence`),c(t))}function c(t){return t===null?n(t):t===32?(e.enter(`space`),e.consume(t),e.exit(`space`),c):t===96?(a=e.enter(`codeTextSequence`),i=0,u(t)):H(t)?(e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),c):(e.enter(`codeTextData`),l(t))}function l(t){return t===null||t===32||t===96||H(t)?(e.exit(`codeTextData`),c(t)):(e.consume(t),l)}function u(n){return n===96?(e.consume(n),i++,u):i===r?(e.exit(`codeTextSequence`),e.exit(`codeText`),t(n)):(a.type=`codeTextData`,l(n))}}var $e=class{constructor(e){this.left=e?[...e]:[],this.right=[]}get(e){if(e<0||e>=this.left.length+this.right.length)throw RangeError("Cannot access index `"+e+"` in a splice buffer of size `"+(this.left.length+this.right.length)+"`");return e<this.left.length?this.left[e]:this.right[this.right.length-e+this.left.length-1]}get length(){return this.left.length+this.right.length}shift(){return this.setCursor(0),this.right.pop()}slice(e,t){let n=t??1/0;return n<this.left.length?this.left.slice(e,n):e>this.left.length?this.right.slice(this.right.length-n+this.left.length,this.right.length-e+this.left.length).reverse():this.left.slice(e).concat(this.right.slice(this.right.length-n+this.left.length).reverse())}splice(e,t,n){let r=t||0;this.setCursor(Math.trunc(e));let i=this.right.splice(this.right.length-r,1/0);return n&&Y(this.left,n),i.reverse()}pop(){return this.setCursor(1/0),this.left.pop()}push(e){this.setCursor(1/0),this.left.push(e)}pushMany(e){this.setCursor(1/0),Y(this.left,e)}unshift(e){this.setCursor(0),this.right.push(e)}unshiftMany(e){this.setCursor(0),Y(this.right,e.reverse())}setCursor(e){if(!(e===this.left.length||e>this.left.length&&this.right.length===0||e<0&&this.left.length===0))if(e<this.left.length){let t=this.left.splice(e,1/0);Y(this.right,t.reverse())}else{let t=this.right.splice(this.left.length+this.right.length-e,1/0);Y(this.left,t.reverse())}}};function Y(e,t){let n=0;if(t.length<1e4)e.push(...t);else for(;n<t.length;)e.push(...t.slice(n,n+1e4)),n+=1e4}function et(e){let t={},n=-1,r,i,a,o,s,c,l,u=new $e(e);for(;++n<u.length;){for(;n in t;)n=t[n];if(r=u.get(n),n&&r[1].type===`chunkFlow`&&u.get(n-1)[1].type===`listItemPrefix`&&(c=r[1]._tokenizer.events,a=0,a<c.length&&c[a][1].type===`lineEndingBlank`&&(a+=2),a<c.length&&c[a][1].type===`content`))for(;++a<c.length&&c[a][1].type!==`content`;)c[a][1].type===`chunkText`&&(c[a][1]._isInFirstContentOfListItem=!0,a++);if(r[0]===`enter`)r[1].contentType&&(Object.assign(t,tt(u,n)),n=t[n],l=!0);else if(r[1]._container){for(a=n,i=void 0;a--;)if(o=u.get(a),o[1].type===`lineEnding`||o[1].type===`lineEndingBlank`)o[0]===`enter`&&(i&&(u.get(i)[1].type=`lineEndingBlank`),o[1].type=`lineEnding`,i=a);else if(!(o[1].type===`linePrefix`||o[1].type===`listItemIndent`))break;i&&(r[1].end={...u.get(i)[1].start},s=u.slice(i,n),s.unshift(r),u.splice(i,n-i+1,s))}}return N(e,0,1/0,u.slice(0)),!l}function tt(e,t){let n=e.get(t)[1],r=e.get(t)[2],i=t-1,a=[],o=n._tokenizer;o||(o=r.parser[n.contentType](n.start),n._contentTypeTextTrailing&&(o._contentTypeTextTrailing=!0));let s=o.events,c=[],l={},u,d,f=-1,p=n,m=0,h=0,g=[h];for(;p;){for(;e.get(++i)[1]!==p;);a.push(i),p._tokenizer||(u=r.sliceStream(p),p.next||u.push(null),d&&o.defineSkip(p.start),p._isInFirstContentOfListItem&&(o._gfmTasklistFirstContentOfListItem=!0),o.write(u),p._isInFirstContentOfListItem&&(o._gfmTasklistFirstContentOfListItem=void 0)),d=p,p=p.next}for(p=n;++f<s.length;)s[f][0]===`exit`&&s[f-1][0]===`enter`&&s[f][1].type===s[f-1][1].type&&s[f][1].start.line!==s[f][1].end.line&&(h=f+1,g.push(h),p._tokenizer=void 0,p.previous=void 0,p=p.next);for(o.events=[],p?(p._tokenizer=void 0,p.previous=void 0):g.pop(),f=g.length;f--;){let t=s.slice(g[f],g[f+1]),n=a.pop();c.push([n,n+t.length-1]),e.splice(n,2,t)}for(c.reverse(),f=-1;++f<c.length;)l[m+c[f][0]]=m+c[f][1],m+=c[f][1]-c[f][0]-1;return l}var nt={resolve:it,tokenize:at},rt={partial:!0,tokenize:ot};function it(e){return et(e),e}function at(e,t){let n;return r;function r(t){return e.enter(`content`),n=e.enter(`chunkContent`,{contentType:`content`}),i(t)}function i(t){return t===null?a(t):H(t)?e.check(rt,o,a)(t):(e.consume(t),i)}function a(n){return e.exit(`chunkContent`),e.exit(`content`),t(n)}function o(t){return e.consume(t),e.exit(`chunkContent`),n.next=e.enter(`chunkContent`,{contentType:`content`,previous:n}),n=n.next,i}}function ot(e,t,n){let r=this;return i;function i(t){return e.exit(`chunkContent`),e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),K(e,a,`linePrefix`)}function a(i){if(i===null||H(i))return n(i);let a=r.events[r.events.length-1];return!r.parser.constructs.disable.null.includes(`codeIndented`)&&a&&a[1].type===`linePrefix`&&a[2].sliceSerialize(a[1],!0).length>=4?t(i):e.interrupt(r.parser.constructs.flow,n,t)(i)}}function st(e,t,n,r,i,a,o,s,c){let l=c||1/0,u=0;return d;function d(t){return t===60?(e.enter(r),e.enter(i),e.enter(a),e.consume(t),e.exit(a),f):t===null||t===32||t===41||V(t)?n(t):(e.enter(r),e.enter(o),e.enter(s),e.enter(`chunkString`,{contentType:`string`}),h(t))}function f(n){return n===62?(e.enter(a),e.consume(n),e.exit(a),e.exit(i),e.exit(r),t):(e.enter(s),e.enter(`chunkString`,{contentType:`string`}),p(n))}function p(t){return t===62?(e.exit(`chunkString`),e.exit(s),f(t)):t===null||t===60||H(t)?n(t):(e.consume(t),t===92?m:p)}function m(t){return t===60||t===62||t===92?(e.consume(t),p):p(t)}function h(i){return!u&&(i===null||i===41||U(i))?(e.exit(`chunkString`),e.exit(s),e.exit(o),e.exit(r),t(i)):u<l&&i===40?(e.consume(i),u++,h):i===41?(e.consume(i),u--,h):i===null||i===32||i===40||V(i)?n(i):(e.consume(i),i===92?g:h)}function g(t){return t===40||t===41||t===92?(e.consume(t),h):h(t)}}function ct(e,t,n,r,i,a){let o=this,s=0,c;return l;function l(t){return e.enter(r),e.enter(i),e.consume(t),e.exit(i),e.enter(a),u}function u(l){return s>999||l===null||l===91||l===93&&!c||l===94&&!s&&`_hiddenFootnoteSupport`in o.parser.constructs?n(l):l===93?(e.exit(a),e.enter(i),e.consume(l),e.exit(i),e.exit(r),t):H(l)?(e.enter(`lineEnding`),e.consume(l),e.exit(`lineEnding`),u):(e.enter(`chunkString`,{contentType:`string`}),d(l))}function d(t){return t===null||t===91||t===93||H(t)||s++>999?(e.exit(`chunkString`),u(t)):(e.consume(t),c||=!W(t),t===92?f:d)}function f(t){return t===91||t===92||t===93?(e.consume(t),s++,d):d(t)}}function lt(e,t,n,r,i,a){let o;return s;function s(t){return t===34||t===39||t===40?(e.enter(r),e.enter(i),e.consume(t),e.exit(i),o=t===40?41:t,c):n(t)}function c(n){return n===o?(e.enter(i),e.consume(n),e.exit(i),e.exit(r),t):(e.enter(a),l(n))}function l(t){return t===o?(e.exit(a),c(o)):t===null?n(t):H(t)?(e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),K(e,l,`linePrefix`)):(e.enter(`chunkString`,{contentType:`string`}),u(t))}function u(t){return t===o||t===null||H(t)?(e.exit(`chunkString`),l(t)):(e.consume(t),t===92?d:u)}function d(t){return t===o||t===92?(e.consume(t),u):u(t)}}function X(e,t){let n;return r;function r(i){return H(i)?(e.enter(`lineEnding`),e.consume(i),e.exit(`lineEnding`),n=!0,r):W(i)?K(e,r,n?`linePrefix`:`lineSuffix`)(i):t(i)}}var ut={name:`definition`,tokenize:ft},dt={partial:!0,tokenize:pt};function ft(e,t,n){let r=this,i;return a;function a(t){return e.enter(`definition`),o(t)}function o(t){return ct.call(r,e,s,n,`definitionLabel`,`definitionLabelMarker`,`definitionLabelString`)(t)}function s(t){return i=R(r.sliceSerialize(r.events[r.events.length-1][1]).slice(1,-1)),t===58?(e.enter(`definitionMarker`),e.consume(t),e.exit(`definitionMarker`),c):n(t)}function c(t){return U(t)?X(e,l)(t):l(t)}function l(t){return st(e,u,n,`definitionDestination`,`definitionDestinationLiteral`,`definitionDestinationLiteralMarker`,`definitionDestinationRaw`,`definitionDestinationString`)(t)}function u(t){return e.attempt(dt,d,d)(t)}function d(t){return W(t)?K(e,f,`whitespace`)(t):f(t)}function f(a){return a===null||H(a)?(e.exit(`definition`),r.parser.defined.push(i),t(a)):n(a)}}function pt(e,t,n){return r;function r(t){return U(t)?X(e,i)(t):n(t)}function i(t){return lt(e,a,n,`definitionTitle`,`definitionTitleMarker`,`definitionTitleString`)(t)}function a(t){return W(t)?K(e,o,`whitespace`)(t):o(t)}function o(e){return e===null||H(e)?t(e):n(e)}}var mt={name:`hardBreakEscape`,tokenize:ht};function ht(e,t,n){return r;function r(t){return e.enter(`hardBreakEscape`),e.consume(t),i}function i(r){return H(r)?(e.exit(`hardBreakEscape`),t(r)):n(r)}}var gt={name:`headingAtx`,resolve:_t,tokenize:vt};function _t(e,t){let n=e.length-2,r=3,i,a;return e[r][1].type===`whitespace`&&(r+=2),n-2>r&&e[n][1].type===`whitespace`&&(n-=2),e[n][1].type===`atxHeadingSequence`&&(r===n-1||n-4>r&&e[n-2][1].type===`whitespace`)&&(n-=r+1===n?2:4),n>r&&(i={type:`atxHeadingText`,start:e[r][1].start,end:e[n][1].end},a={type:`chunkText`,start:e[r][1].start,end:e[n][1].end,contentType:`text`},N(e,r,n-r+1,[[`enter`,i,t],[`enter`,a,t],[`exit`,a,t],[`exit`,i,t]])),e}function vt(e,t,n){let r=0;return i;function i(t){return e.enter(`atxHeading`),a(t)}function a(t){return e.enter(`atxHeadingSequence`),o(t)}function o(t){return t===35&&r++<6?(e.consume(t),o):t===null||U(t)?(e.exit(`atxHeadingSequence`),s(t)):n(t)}function s(n){return n===35?(e.enter(`atxHeadingSequence`),c(n)):n===null||H(n)?(e.exit(`atxHeading`),t(n)):W(n)?K(e,s,`whitespace`)(n):(e.enter(`atxHeadingText`),l(n))}function c(t){return t===35?(e.consume(t),c):(e.exit(`atxHeadingSequence`),s(t))}function l(t){return t===null||t===35||U(t)?(e.exit(`atxHeadingText`),s(t)):(e.consume(t),l)}}var yt=`address.article.aside.base.basefont.blockquote.body.caption.center.col.colgroup.dd.details.dialog.dir.div.dl.dt.fieldset.figcaption.figure.footer.form.frame.frameset.h1.h2.h3.h4.h5.h6.head.header.hr.html.iframe.legend.li.link.main.menu.menuitem.nav.noframes.ol.optgroup.option.p.param.search.section.summary.table.tbody.td.tfoot.th.thead.title.tr.track.ul`.split(`.`),bt=[`pre`,`script`,`style`,`textarea`],xt={concrete:!0,name:`htmlFlow`,resolveTo:wt,tokenize:Tt},St={partial:!0,tokenize:Dt},Ct={partial:!0,tokenize:Et};function wt(e){let t=e.length;for(;t--&&!(e[t][0]===`enter`&&e[t][1].type===`htmlFlow`););return t>1&&e[t-2][1].type===`linePrefix`&&(e[t][1].start=e[t-2][1].start,e[t+1][1].start=e[t-2][1].start,e.splice(t-2,2)),e}function Tt(e,t,n){let r=this,i,a,o,s,c;return l;function l(e){return u(e)}function u(t){return e.enter(`htmlFlow`),e.enter(`htmlFlowData`),e.consume(t),d}function d(s){return s===33?(e.consume(s),f):s===47?(e.consume(s),a=!0,h):s===63?(e.consume(s),i=3,r.interrupt?t:F):z(s)?(e.consume(s),o=String.fromCharCode(s),g):n(s)}function f(a){return a===45?(e.consume(a),i=2,p):a===91?(e.consume(a),i=5,s=0,m):z(a)?(e.consume(a),i=4,r.interrupt?t:F):n(a)}function p(i){return i===45?(e.consume(i),r.interrupt?t:F):n(i)}function m(i){return i===`CDATA[`.charCodeAt(s++)?(e.consume(i),s===6?r.interrupt?t:O:m):n(i)}function h(t){return z(t)?(e.consume(t),o=String.fromCharCode(t),g):n(t)}function g(s){if(s===null||s===47||s===62||U(s)){let c=s===47,l=o.toLowerCase();return!c&&!a&&bt.includes(l)?(i=1,r.interrupt?t(s):O(s)):yt.includes(o.toLowerCase())?(i=6,c?(e.consume(s),_):r.interrupt?t(s):O(s)):(i=7,r.interrupt&&!r.parser.lazy[r.now().line]?n(s):a?v(s):y(s))}return s===45||B(s)?(e.consume(s),o+=String.fromCharCode(s),g):n(s)}function _(i){return i===62?(e.consume(i),r.interrupt?t:O):n(i)}function v(t){return W(t)?(e.consume(t),v):E(t)}function y(t){return t===47?(e.consume(t),E):t===58||t===95||z(t)?(e.consume(t),b):W(t)?(e.consume(t),y):E(t)}function b(t){return t===45||t===46||t===58||t===95||B(t)?(e.consume(t),b):x(t)}function x(t){return t===61?(e.consume(t),S):W(t)?(e.consume(t),x):y(t)}function S(t){return t===null||t===60||t===61||t===62||t===96?n(t):t===34||t===39?(e.consume(t),c=t,C):W(t)?(e.consume(t),S):w(t)}function C(t){return t===c?(e.consume(t),c=null,T):t===null||H(t)?n(t):(e.consume(t),C)}function w(t){return t===null||t===34||t===39||t===47||t===60||t===61||t===62||t===96||U(t)?x(t):(e.consume(t),w)}function T(e){return e===47||e===62||W(e)?y(e):n(e)}function E(t){return t===62?(e.consume(t),D):n(t)}function D(t){return t===null||H(t)?O(t):W(t)?(e.consume(t),D):n(t)}function O(t){return t===45&&i===2?(e.consume(t),j):t===60&&i===1?(e.consume(t),M):t===62&&i===4?(e.consume(t),I):t===63&&i===3?(e.consume(t),F):t===93&&i===5?(e.consume(t),P):H(t)&&(i===6||i===7)?(e.exit(`htmlFlowData`),e.check(St,L,k)(t)):t===null||H(t)?(e.exit(`htmlFlowData`),k(t)):(e.consume(t),O)}function k(t){return e.check(Ct,A,L)(t)}function A(t){return e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),ee}function ee(t){return t===null||H(t)?k(t):(e.enter(`htmlFlowData`),O(t))}function j(t){return t===45?(e.consume(t),F):O(t)}function M(t){return t===47?(e.consume(t),o=``,N):O(t)}function N(t){if(t===62){let n=o.toLowerCase();return bt.includes(n)?(e.consume(t),I):O(t)}return z(t)&&o.length<8?(e.consume(t),o+=String.fromCharCode(t),N):O(t)}function P(t){return t===93?(e.consume(t),F):O(t)}function F(t){return t===62?(e.consume(t),I):t===45&&i===2?(e.consume(t),F):O(t)}function I(t){return t===null||H(t)?(e.exit(`htmlFlowData`),L(t)):(e.consume(t),I)}function L(n){return e.exit(`htmlFlow`),t(n)}}function Et(e,t,n){let r=this;return i;function i(t){return H(t)?(e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),a):n(t)}function a(e){return r.parser.lazy[r.now().line]?n(e):t(e)}}function Dt(e,t,n){return r;function r(r){return e.enter(`lineEnding`),e.consume(r),e.exit(`lineEnding`),e.attempt(J,t,n)}}var Ot={name:`htmlText`,tokenize:kt};function kt(e,t,n){let r=this,i,a,o;return s;function s(t){return e.enter(`htmlText`),e.enter(`htmlTextData`),e.consume(t),c}function c(t){return t===33?(e.consume(t),l):t===47?(e.consume(t),x):t===63?(e.consume(t),y):z(t)?(e.consume(t),w):n(t)}function l(t){return t===45?(e.consume(t),u):t===91?(e.consume(t),a=0,m):z(t)?(e.consume(t),v):n(t)}function u(t){return t===45?(e.consume(t),p):n(t)}function d(t){return t===null?n(t):t===45?(e.consume(t),f):H(t)?(o=d,M(t)):(e.consume(t),d)}function f(t){return t===45?(e.consume(t),p):d(t)}function p(e){return e===62?j(e):e===45?f(e):d(e)}function m(t){return t===`CDATA[`.charCodeAt(a++)?(e.consume(t),a===6?h:m):n(t)}function h(t){return t===null?n(t):t===93?(e.consume(t),g):H(t)?(o=h,M(t)):(e.consume(t),h)}function g(t){return t===93?(e.consume(t),_):h(t)}function _(t){return t===62?j(t):t===93?(e.consume(t),_):h(t)}function v(t){return t===null||t===62?j(t):H(t)?(o=v,M(t)):(e.consume(t),v)}function y(t){return t===null?n(t):t===63?(e.consume(t),b):H(t)?(o=y,M(t)):(e.consume(t),y)}function b(e){return e===62?j(e):y(e)}function x(t){return z(t)?(e.consume(t),S):n(t)}function S(t){return t===45||B(t)?(e.consume(t),S):C(t)}function C(t){return H(t)?(o=C,M(t)):W(t)?(e.consume(t),C):j(t)}function w(t){return t===45||B(t)?(e.consume(t),w):t===47||t===62||U(t)?T(t):n(t)}function T(t){return t===47?(e.consume(t),j):t===58||t===95||z(t)?(e.consume(t),E):H(t)?(o=T,M(t)):W(t)?(e.consume(t),T):j(t)}function E(t){return t===45||t===46||t===58||t===95||B(t)?(e.consume(t),E):D(t)}function D(t){return t===61?(e.consume(t),O):H(t)?(o=D,M(t)):W(t)?(e.consume(t),D):T(t)}function O(t){return t===null||t===60||t===61||t===62||t===96?n(t):t===34||t===39?(e.consume(t),i=t,k):H(t)?(o=O,M(t)):W(t)?(e.consume(t),O):(e.consume(t),A)}function k(t){return t===i?(e.consume(t),i=void 0,ee):t===null?n(t):H(t)?(o=k,M(t)):(e.consume(t),k)}function A(t){return t===null||t===34||t===39||t===60||t===61||t===96?n(t):t===47||t===62||U(t)?T(t):(e.consume(t),A)}function ee(e){return e===47||e===62||U(e)?T(e):n(e)}function j(r){return r===62?(e.consume(r),e.exit(`htmlTextData`),e.exit(`htmlText`),t):n(r)}function M(t){return e.exit(`htmlTextData`),e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),N}function N(t){return W(t)?K(e,P,`linePrefix`,r.parser.constructs.disable.null.includes(`codeIndented`)?void 0:4)(t):P(t)}function P(t){return e.enter(`htmlTextData`),o(t)}}var At={name:`labelEnd`,resolveAll:Pt,resolveTo:Ft,tokenize:It},jt={tokenize:Lt},Mt={tokenize:Rt},Nt={tokenize:zt};function Pt(e){let t=-1,n=[];for(;++t<e.length;){let r=e[t][1];if(n.push(e[t]),r.type===`labelImage`||r.type===`labelLink`||r.type===`labelEnd`){let e=r.type===`labelImage`?4:2;r.type=`data`,t+=e}}return e.length!==n.length&&N(e,0,e.length,n),e}function Ft(e,t){let n=e.length,r=0,i,a,o,s;for(;n--;)if(i=e[n][1],a){if(i.type===`link`||i.type===`labelLink`&&i._inactive)break;e[n][0]===`enter`&&i.type===`labelLink`&&(i._inactive=!0)}else if(o){if(e[n][0]===`enter`&&(i.type===`labelImage`||i.type===`labelLink`)&&!i._balanced&&(a=n,i.type!==`labelLink`)){r=2;break}}else i.type===`labelEnd`&&(o=n);let c={type:e[a][1].type===`labelLink`?`link`:`image`,start:{...e[a][1].start},end:{...e[e.length-1][1].end}},l={type:`label`,start:{...e[a][1].start},end:{...e[o][1].end}},u={type:`labelText`,start:{...e[a+r+2][1].end},end:{...e[o-2][1].start}};return s=[[`enter`,c,t],[`enter`,l,t]],s=P(s,e.slice(a+1,a+r+3)),s=P(s,[[`enter`,u,t]]),s=P(s,Te(t.parser.constructs.insideSpan.null,e.slice(a+r+4,o-3),t)),s=P(s,[[`exit`,u,t],e[o-2],e[o-1],[`exit`,l,t]]),s=P(s,e.slice(o+1)),s=P(s,[[`exit`,c,t]]),N(e,a,e.length,s),e}function It(e,t,n){let r=this,i=r.events.length,a,o;for(;i--;)if((r.events[i][1].type===`labelImage`||r.events[i][1].type===`labelLink`)&&!r.events[i][1]._balanced){a=r.events[i][1];break}return s;function s(t){return a?a._inactive?d(t):(o=r.parser.defined.includes(R(r.sliceSerialize({start:a.end,end:r.now()}))),e.enter(`labelEnd`),e.enter(`labelMarker`),e.consume(t),e.exit(`labelMarker`),e.exit(`labelEnd`),c):n(t)}function c(t){return t===40?e.attempt(jt,u,o?u:d)(t):t===91?e.attempt(Mt,u,o?l:d)(t):o?u(t):d(t)}function l(t){return e.attempt(Nt,u,d)(t)}function u(e){return t(e)}function d(e){return a._balanced=!0,n(e)}}function Lt(e,t,n){return r;function r(t){return e.enter(`resource`),e.enter(`resourceMarker`),e.consume(t),e.exit(`resourceMarker`),i}function i(t){return U(t)?X(e,a)(t):a(t)}function a(t){return t===41?u(t):st(e,o,s,`resourceDestination`,`resourceDestinationLiteral`,`resourceDestinationLiteralMarker`,`resourceDestinationRaw`,`resourceDestinationString`,32)(t)}function o(t){return U(t)?X(e,c)(t):u(t)}function s(e){return n(e)}function c(t){return t===34||t===39||t===40?lt(e,l,n,`resourceTitle`,`resourceTitleMarker`,`resourceTitleString`)(t):u(t)}function l(t){return U(t)?X(e,u)(t):u(t)}function u(r){return r===41?(e.enter(`resourceMarker`),e.consume(r),e.exit(`resourceMarker`),e.exit(`resource`),t):n(r)}}function Rt(e,t,n){let r=this;return i;function i(t){return ct.call(r,e,a,o,`reference`,`referenceMarker`,`referenceString`)(t)}function a(e){return r.parser.defined.includes(R(r.sliceSerialize(r.events[r.events.length-1][1]).slice(1,-1)))?t(e):n(e)}function o(e){return n(e)}}function zt(e,t,n){return r;function r(t){return e.enter(`reference`),e.enter(`referenceMarker`),e.consume(t),e.exit(`referenceMarker`),i}function i(r){return r===93?(e.enter(`referenceMarker`),e.consume(r),e.exit(`referenceMarker`),e.exit(`reference`),t):n(r)}}var Bt={name:`labelStartImage`,resolveAll:At.resolveAll,tokenize:Vt};function Vt(e,t,n){let r=this;return i;function i(t){return e.enter(`labelImage`),e.enter(`labelImageMarker`),e.consume(t),e.exit(`labelImageMarker`),a}function a(t){return t===91?(e.enter(`labelMarker`),e.consume(t),e.exit(`labelMarker`),e.exit(`labelImage`),o):n(t)}function o(e){return e===94&&`_hiddenFootnoteSupport`in r.parser.constructs?n(e):t(e)}}var Ht={name:`labelStartLink`,resolveAll:At.resolveAll,tokenize:Ut};function Ut(e,t,n){let r=this;return i;function i(t){return e.enter(`labelLink`),e.enter(`labelMarker`),e.consume(t),e.exit(`labelMarker`),e.exit(`labelLink`),a}function a(e){return e===94&&`_hiddenFootnoteSupport`in r.parser.constructs?n(e):t(e)}}var Wt={name:`lineEnding`,tokenize:Gt};function Gt(e,t){return n;function n(n){return e.enter(`lineEnding`),e.consume(n),e.exit(`lineEnding`),K(e,t,`linePrefix`)}}var Kt={name:`thematicBreak`,tokenize:qt};function qt(e,t,n){let r=0,i;return a;function a(t){return e.enter(`thematicBreak`),o(t)}function o(e){return i=e,s(e)}function s(a){return a===i?(e.enter(`thematicBreakSequence`),c(a)):r>=3&&(a===null||H(a))?(e.exit(`thematicBreak`),t(a)):n(a)}function c(t){return t===i?(e.consume(t),r++,c):(e.exit(`thematicBreakSequence`),W(t)?K(e,s,`whitespace`)(t):s(t))}}var Z={continuation:{tokenize:Zt},exit:$t,name:`list`,tokenize:Xt},Jt={partial:!0,tokenize:en},Yt={partial:!0,tokenize:Qt};function Xt(e,t,n){let r=this,i=r.events[r.events.length-1],a=i&&i[1].type===`linePrefix`?i[2].sliceSerialize(i[1],!0).length:0,o=0;return s;function s(t){let i=r.containerState.type||(t===42||t===43||t===45?`listUnordered`:`listOrdered`);if(i===`listUnordered`?!r.containerState.marker||t===r.containerState.marker:ce(t)){if(r.containerState.type||(r.containerState.type=i,e.enter(i,{_container:!0})),i===`listUnordered`)return e.enter(`listItemPrefix`),t===42||t===45?e.check(Kt,n,l)(t):l(t);if(!r.interrupt||t===49)return e.enter(`listItemPrefix`),e.enter(`listItemValue`),c(t)}return n(t)}function c(t){return ce(t)&&++o<10?(e.consume(t),c):(!r.interrupt||o<2)&&(r.containerState.marker?t===r.containerState.marker:t===41||t===46)?(e.exit(`listItemValue`),l(t)):n(t)}function l(t){return e.enter(`listItemMarker`),e.consume(t),e.exit(`listItemMarker`),r.containerState.marker=r.containerState.marker||t,e.check(J,r.interrupt?n:u,e.attempt(Jt,f,d))}function u(e){return r.containerState.initialBlankLine=!0,a++,f(e)}function d(t){return W(t)?(e.enter(`listItemPrefixWhitespace`),e.consume(t),e.exit(`listItemPrefixWhitespace`),f):n(t)}function f(n){return r.containerState.size=a+r.sliceSerialize(e.exit(`listItemPrefix`),!0).length,t(n)}}function Zt(e,t,n){let r=this;return r.containerState._closeFlow=void 0,e.check(J,i,a);function i(n){return r.containerState.furtherBlankLines=r.containerState.furtherBlankLines||r.containerState.initialBlankLine,K(e,t,`listItemIndent`,r.containerState.size+1)(n)}function a(n){return r.containerState.furtherBlankLines||!W(n)?(r.containerState.furtherBlankLines=void 0,r.containerState.initialBlankLine=void 0,o(n)):(r.containerState.furtherBlankLines=void 0,r.containerState.initialBlankLine=void 0,e.attempt(Yt,t,o)(n))}function o(i){return r.containerState._closeFlow=!0,r.interrupt=void 0,K(e,e.attempt(Z,t,n),`linePrefix`,r.parser.constructs.disable.null.includes(`codeIndented`)?void 0:4)(i)}}function Qt(e,t,n){let r=this;return K(e,i,`listItemIndent`,r.containerState.size+1);function i(e){let i=r.events[r.events.length-1];return i&&i[1].type===`listItemIndent`&&i[2].sliceSerialize(i[1],!0).length===r.containerState.size?t(e):n(e)}}function $t(e){e.exit(this.containerState.type)}function en(e,t,n){let r=this;return K(e,i,`listItemPrefixWhitespace`,r.parser.constructs.disable.null.includes(`codeIndented`)?void 0:5);function i(e){let i=r.events[r.events.length-1];return!W(e)&&i&&i[1].type===`listItemPrefixWhitespace`?t(e):n(e)}}var tn={name:`setextUnderline`,resolveTo:nn,tokenize:rn};function nn(e,t){let n=e.length,r,i,a;for(;n--;)if(e[n][0]===`enter`){if(e[n][1].type===`content`){r=n;break}e[n][1].type===`paragraph`&&(i=n)}else e[n][1].type===`content`&&e.splice(n,1),!a&&e[n][1].type===`definition`&&(a=n);let o={type:`setextHeading`,start:{...e[r][1].start},end:{...e[e.length-1][1].end}};return e[i][1].type=`setextHeadingText`,a?(e.splice(i,0,[`enter`,o,t]),e.splice(a+1,0,[`exit`,e[r][1],t]),e[r][1].end={...e[a][1].end}):e[r][1]=o,e.push([`exit`,o,t]),e}function rn(e,t,n){let r=this,i;return a;function a(t){let a=r.events.length,s;for(;a--;)if(r.events[a][1].type!==`lineEnding`&&r.events[a][1].type!==`linePrefix`&&r.events[a][1].type!==`content`){s=r.events[a][1].type===`paragraph`;break}return!r.parser.lazy[r.now().line]&&(r.interrupt||s)?(e.enter(`setextHeadingLine`),i=t,o(t)):n(t)}function o(t){return e.enter(`setextHeadingLineSequence`),s(t)}function s(t){return t===i?(e.consume(t),s):(e.exit(`setextHeadingLineSequence`),W(t)?K(e,c,`lineSuffix`)(t):c(t))}function c(r){return r===null||H(r)?(e.exit(`setextHeadingLine`),t(r)):n(r)}}var an={tokenize:on};function on(e){let t=this,n=e.attempt(J,r,e.attempt(this.parser.constructs.flowInitial,i,K(e,e.attempt(this.parser.constructs.flow,i,e.attempt(nt,i)),`linePrefix`)));return n;function r(r){if(r===null){e.consume(r);return}return e.enter(`lineEndingBlank`),e.consume(r),e.exit(`lineEndingBlank`),t.currentConstruct=void 0,n}function i(r){if(r===null){e.consume(r);return}return e.enter(`lineEnding`),e.consume(r),e.exit(`lineEnding`),t.currentConstruct=void 0,n}}var sn={resolveAll:dn()},cn=un(`string`),ln=un(`text`);function un(e){return{resolveAll:dn(e===`text`?fn:void 0),tokenize:t};function t(t){let n=this,r=this.parser.constructs[e],i=t.attempt(r,a,o);return a;function a(e){return c(e)?i(e):o(e)}function o(e){if(e===null){t.consume(e);return}return t.enter(`data`),t.consume(e),s}function s(e){return c(e)?(t.exit(`data`),i(e)):(t.consume(e),s)}function c(e){if(e===null)return!0;let t=r[e],i=-1;if(t)for(;++i<t.length;){let e=t[i];if(!e.previous||e.previous.call(n,n.previous))return!0}return!1}}}function dn(e){return t;function t(t,n){let r=-1,i;for(;++r<=t.length;)i===void 0?t[r]&&t[r][1].type===`data`&&(i=r,r++):(!t[r]||t[r][1].type!==`data`)&&(r!==i+2&&(t[i][1].end=t[r-1][1].end,t.splice(i+2,r-i-2),r=i+2),i=void 0);return e?e(t,n):t}}function fn(e,t){let n=0;for(;++n<=e.length;)if((n===e.length||e[n][1].type===`lineEnding`)&&e[n-1][1].type===`data`){let r=e[n-1][1],i=t.sliceStream(r),a=i.length,o=-1,s=0,c;for(;a--;){let e=i[a];if(typeof e==`string`){for(o=e.length;e.charCodeAt(o-1)===32;)s++,o--;if(o)break;o=-1}else if(e===-2)c=!0,s++;else if(e!==-1){a++;break}}if(t._contentTypeTextTrailing&&n===e.length&&(s=0),s){let i={type:n===e.length||c||s<2?`lineSuffix`:`hardBreakTrailing`,start:{_bufferIndex:a?o:r.start._bufferIndex+o,_index:r.start._index+a,line:r.end.line,column:r.end.column-s,offset:r.end.offset-s},end:{...r.end}};r.end={...i.start},r.start.offset===r.end.offset?Object.assign(r,i):(e.splice(n,0,[`enter`,i,t],[`exit`,i,t]),n+=2)}n++}return e}var pn=l({attentionMarkers:()=>xn,contentInitial:()=>hn,disable:()=>Sn,document:()=>mn,flow:()=>_n,flowInitial:()=>gn,insideSpan:()=>bn,string:()=>vn,text:()=>yn}),mn={42:Z,43:Z,45:Z,48:Z,49:Z,50:Z,51:Z,52:Z,53:Z,54:Z,55:Z,56:Z,57:Z,62:Ne},hn={91:ut},gn={[-2]:Ge,[-1]:Ge,32:Ge},_n={35:gt,42:Kt,45:[tn,Kt],60:xt,61:tn,95:Kt,96:He,126:He},vn={38:ze,92:Le},yn={[-5]:Wt,[-4]:Wt,[-3]:Wt,33:Bt,38:ze,42:Ee,60:[Ae,Ot],91:Ht,92:[mt,Le],93:At,95:Ee,96:Ye},bn={null:[Ee,sn]},xn={null:[42,95]},Sn={null:[]};function Cn(e,t,n){let r={_bufferIndex:-1,_index:0,line:n&&n.line||1,column:n&&n.column||1,offset:n&&n.offset||0},i={},a=[],o=[],s=[],c={attempt:C(x),check:C(S),consume:v,enter:y,exit:b,interrupt:C(S,{interrupt:!0})},l={code:null,containerState:{},defineSkip:h,events:[],now:m,parser:e,previous:null,sliceSerialize:f,sliceStream:p,write:d},u=t.tokenize.call(l,c);return t.resolveAll&&a.push(t),l;function d(e){return o=P(o,e),g(),o[o.length-1]===null?(w(t,0),l.events=Te(a,l.events,l),l.events):[]}function f(e,t){return Tn(p(e),t)}function p(e){return wn(o,e)}function m(){let{_bufferIndex:e,_index:t,line:n,column:i,offset:a}=r;return{_bufferIndex:e,_index:t,line:n,column:i,offset:a}}function h(e){i[e.line]=e.column,E()}function g(){let e;for(;r._index<o.length;){let t=o[r._index];if(typeof t==`string`)for(e=r._index,r._bufferIndex<0&&(r._bufferIndex=0);r._index===e&&r._bufferIndex<t.length;)_(t.charCodeAt(r._bufferIndex));else _(t)}}function _(e){u=u(e)}function v(e){H(e)?(r.line++,r.column=1,r.offset+=e===-3?2:1,E()):e!==-1&&(r.column++,r.offset++),r._bufferIndex<0?r._index++:(r._bufferIndex++,r._bufferIndex===o[r._index].length&&(r._bufferIndex=-1,r._index++)),l.previous=e}function y(e,t){let n=t||{};return n.type=e,n.start=m(),l.events.push([`enter`,n,l]),s.push(n),n}function b(e){let t=s.pop();return t.end=m(),l.events.push([`exit`,t,l]),t}function x(e,t){w(e,t.from)}function S(e,t){t.restore()}function C(e,t){return n;function n(n,r,i){let a,o,s,u;return Array.isArray(n)?f(n):`tokenize`in n?f([n]):d(n);function d(e){return t;function t(t){let n=t!==null&&e[t],r=t!==null&&e.null;return f([...Array.isArray(n)?n:n?[n]:[],...Array.isArray(r)?r:r?[r]:[]])(t)}}function f(e){return a=e,o=0,e.length===0?i:p(e[o])}function p(e){return n;function n(n){return u=T(),s=e,e.partial||(l.currentConstruct=e),e.name&&l.parser.constructs.disable.null.includes(e.name)?h(n):e.tokenize.call(t?Object.assign(Object.create(l),t):l,c,m,h)(n)}}function m(t){return e(s,u),r}function h(e){return u.restore(),++o<a.length?p(a[o]):i}}}function w(e,t){e.resolveAll&&!a.includes(e)&&a.push(e),e.resolve&&N(l.events,t,l.events.length-t,e.resolve(l.events.slice(t),l)),e.resolveTo&&(l.events=e.resolveTo(l.events,l))}function T(){let e=m(),t=l.previous,n=l.currentConstruct,i=l.events.length,a=Array.from(s);return{from:i,restore:o};function o(){r=e,l.previous=t,l.currentConstruct=n,l.events.length=i,s=a,E()}}function E(){r.line in i&&r.column<2&&(r.column=i[r.line],r.offset+=i[r.line]-1)}}function wn(e,t){let n=t.start._index,r=t.start._bufferIndex,i=t.end._index,a=t.end._bufferIndex,o;if(n===i)o=[e[n].slice(r,a)];else{if(o=e.slice(n,i),r>-1){let e=o[0];typeof e==`string`?o[0]=e.slice(r):o.shift()}a>0&&o.push(e[i].slice(0,a))}return o}function Tn(e,t){let n=-1,r=[],i;for(;++n<e.length;){let a=e[n],o;if(typeof a==`string`)o=a;else switch(a){case-5:o=`\r`;break;case-4:o=`
`;break;case-3:o=`\r
`;break;case-2:o=t?` `:`	`;break;case-1:if(!t&&i)continue;o=` `;break;default:o=String.fromCharCode(a)}i=a===-2,r.push(o)}return r.join(``)}function En(e){let t={constructs:I([pn,...(e||{}).extensions||[]]),content:n(ye),defined:[],document:n(xe),flow:n(an),lazy:{},string:n(cn),text:n(ln)};return t;function n(e){return n;function n(n){return Cn(t,e,n)}}}function Dn(e){for(;!et(e););return e}var On=/[\0\t\n\r]/g;function kn(){let e=1,t=``,n=!0,r;return i;function i(i,a,o){let s=[],c,l,u,d,f;for(i=t+(typeof i==`string`?i.toString():new TextDecoder(a||void 0).decode(i)),u=0,t=``,n&&=(i.charCodeAt(0)===65279&&u++,void 0);u<i.length;){if(On.lastIndex=u,c=On.exec(i),d=c&&c.index!==void 0?c.index:i.length,f=i.charCodeAt(d),!c){t=i.slice(u);break}if(f===10&&u===d&&r)s.push(-3),r=void 0;else switch(r&&=(s.push(-5),void 0),u<d&&(s.push(i.slice(u,d)),e+=d-u),f){case 0:s.push(65533),e++;break;case 9:for(l=Math.ceil(e/4)*4,s.push(-2);e++<l;)s.push(-1);break;case 10:s.push(-4),e=1;break;default:r=!0,e=1}u=d+1}return o&&(r&&s.push(-5),t&&s.push(t),s.push(null)),s}}function An(e,t,n){return typeof t!=`string`&&(n=t,t=void 0),ve(n)(Dn(En(n).document().write(kn()(e,t,!0))))}function jn(e){return An(e,{allowDangerousHtml:!1})}function Mn(e,t,n=3){let r=t.filter(t=>t.id!==e.id).map(t=>{let n=t.tags.filter(t=>e.tags.includes(t)).length,r=(Date.now()-new Date(t.date).getTime())/(1e3*60*60*24),i=Math.max(0,14-r)*.1;return{...t,score:n+i}});return r.sort((e,t)=>t.score-e.score),r.slice(0,n)}function Nn(e,t,n=3){return(0,_.useMemo)(()=>Mn(e,t,n),[e,t,n])}function Pn({currentPost:e}){let{lang:t}=a(),{posts:n}=T(),r=Nn(e,n,3);if(n.length<2||r.length===0)return null;let{setSelectedPost:i}=T(),s=e=>{i(e),history.pushState(null,``,`#blog/article/${e.slug}`)};return(0,x.jsx)(c,{children:(0,x.jsxs)(`div`,{className:`border-t-4 border-rule pt-6 mt-10 mb-8`,children:[(0,x.jsx)(`h3`,{className:`font-headline text-xl md:text-2xl font-bold text-ink mb-5`,children:t===`es`?`Artículos relacionados`:`Related posts`}),(0,x.jsx)(`div`,{className:`grid md:grid-cols-3 gap-4`,children:r.map((e,n)=>{let r=t===`es`?e.title:e.titleEn,i=t===`es`?e.excerpt:e.excerptEn;return(0,x.jsx)(o.article,{initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{duration:.25,delay:n*.08},className:`border-2 border-rule bg-paper shadow-pixel-sm hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 active:shadow-none active:translate-x-0.5 active:translate-y-0.5 transition-all duration-75 flex flex-col`,children:(0,x.jsxs)(`button`,{onClick:()=>s(e),className:`flex flex-col h-full text-left cursor-pointer p-4 gap-2`,children:[(0,x.jsx)(`div`,{className:`flex flex-wrap gap-1`,children:e.tags.slice(0,2).map(e=>(0,x.jsxs)(`span`,{className:`skill-tag text-[8px] flex items-center gap-1`,children:[(0,x.jsx)(g,{size:6}),` `,e]},e))}),(0,x.jsx)(`h4`,{className:`font-headline text-sm font-bold text-ink leading-tight line-clamp-2`,children:r}),(0,x.jsx)(`p`,{className:`font-sans text-[11px] text-ink-light leading-relaxed line-clamp-2 flex-1`,children:i}),(0,x.jsxs)(`span`,{className:`font-mono text-[9px] font-bold uppercase tracking-wider text-accent hover:text-accent-dark flex items-center gap-1 mt-auto pt-2 transition-colors`,children:[t===`es`?`Leer`:`Read`,` `,(0,x.jsx)(d,{size:9})]})]})},e.id)})})]})})}function Fn(){let{lang:e}=a(),{filteredPosts:t,selectedPost:n,setSelectedPost:i}=T(),s=(0,_.useRef)(null),c=n,l=t.findIndex(e=>e.id===c?.id),u=l>0?t[l-1]:null,p=l>=0&&l<t.length-1?t[l+1]:null;(0,_.useEffect)(()=>{s.current&&s.current.scrollIntoView({block:`start`,behavior:`smooth`}),window.scrollTo({top:0,behavior:`smooth`})},[c?.id]);let h=()=>{history.pushState(null,``,`#blog`),window.dispatchEvent(new HashChangeEvent(`hashchange`))},g=()=>{u&&(i(u),history.pushState(null,``,`#blog/article/${u.slug}`))},v=()=>{p&&(i(p),history.pushState(null,``,`#blog/article/${p.slug}`))};if(!c)return null;let y=e===`es`?c.title:c.titleEn,b=e===`es`?c.content:c.contentEn,S=e===`es`?`Volver a artículos`:`Back to articles`;return(0,x.jsx)(o.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},transition:{duration:.25},ref:s,children:(0,x.jsxs)(`article`,{className:`max-w-4xl mx-auto`,children:[(0,x.jsxs)(`button`,{onClick:h,className:`flex items-center gap-1.5 font-mono text-[11px] font-bold uppercase tracking-wider text-ink-muted hover:text-accent transition-colors mb-6 cursor-pointer`,children:[(0,x.jsx)(r,{size:14}),S]}),(0,x.jsx)(`div`,{className:`border-t-4 border-rule mb-1`}),(0,x.jsx)(`div`,{className:`border-t border-rule mb-6`}),(0,x.jsx)(`h1`,{className:`font-headline text-3xl md:text-5xl lg:text-6xl font-black text-ink leading-[1.05] tracking-tight mb-4`,children:y}),(0,x.jsxs)(`div`,{className:`flex flex-wrap items-center gap-x-4 gap-y-1 mb-6 pb-4 border-b border-rule-light`,children:[(0,x.jsxs)(`span`,{className:`font-mono text-xs text-ink-muted flex items-center gap-1.5`,children:[(0,x.jsx)(f,{size:12}),c.date]}),(0,x.jsxs)(`span`,{className:`font-mono text-xs text-ink-muted flex items-center gap-1.5`,children:[(0,x.jsx)(m,{size:12}),c.readingTime,` min `,e===`es`?`de lectura`:`read`]}),(0,x.jsx)(`span`,{className:`hidden md:inline font-mono text-[10px] text-ink-muted uppercase tracking-wider`,children:`Por Edwin Trigos`})]}),(0,x.jsx)(`div`,{className:`flex flex-wrap gap-1.5 mb-8`,children:c.tags.map(e=>(0,x.jsx)(`span`,{className:`skill-tag text-[10px]`,children:e},e))}),(0,x.jsx)(`div`,{className:`
            blog-article-body
          ...
          `,dangerouslySetInnerHTML:{__html:jn(b)}}),(0,x.jsx)(`div`,{className:`border-t-4 border-rule mt-12 mb-1`}),(0,x.jsx)(`div`,{className:`border-t border-rule mb-6`}),(0,x.jsxs)(`nav`,{className:`flex justify-between items-stretch gap-4 mb-10`,children:[u?(0,x.jsxs)(`button`,{onClick:g,className:`flex-1 flex flex-col items-start gap-1 border-2 border-rule bg-paper p-4 shadow-pixel-sm hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 active:shadow-none active:translate-x-0.5 active:translate-y-0.5 transition-all duration-75 text-left cursor-pointer`,children:[(0,x.jsxs)(`span`,{className:`font-mono text-[9px] uppercase tracking-wider text-ink-muted flex items-center gap-1`,children:[(0,x.jsx)(r,{size:10}),` `,e===`es`?`Anterior`:`Previous`]}),(0,x.jsx)(`span`,{className:`font-headline text-sm font-bold text-ink leading-tight line-clamp-2`,children:e===`es`?u.title:u.titleEn})]}):(0,x.jsx)(`div`,{className:`flex-1`}),p?(0,x.jsxs)(`button`,{onClick:v,className:`flex-1 flex flex-col items-end gap-1 border-2 border-rule bg-paper p-4 shadow-pixel-sm hover:shadow-none hover:-translate-x-0.5 hover:translate-y-0.5 active:shadow-none active:-translate-x-0.5 active:translate-y-0.5 transition-all duration-75 text-right cursor-pointer`,children:[(0,x.jsxs)(`span`,{className:`font-mono text-[9px] uppercase tracking-wider text-ink-muted flex items-center gap-1`,children:[e===`es`?`Siguiente`:`Next`,` `,(0,x.jsx)(d,{size:10})]}),(0,x.jsx)(`span`,{className:`font-headline text-sm font-bold text-ink leading-tight line-clamp-2`,children:e===`es`?p.title:p.titleEn})]}):(0,x.jsx)(`div`,{className:`flex-1`})]}),(0,x.jsxs)(`button`,{onClick:h,className:`flex items-center gap-1.5 font-mono text-[11px] font-bold uppercase tracking-wider text-ink-muted hover:text-accent transition-colors mb-6 cursor-pointer`,children:[(0,x.jsx)(r,{size:14}),S]}),c&&(0,x.jsx)(Pn,{currentPost:c})]})},`article-${c.id}`)}var In=[{name:`arquitectura`,label:`Arquitectura`,labelEn:`Architecture`,color:`red`},{name:`.NET`,label:`.NET`,labelEn:`.NET`,color:`blue`},{name:`clean architecture`,label:`Clean Architecture`,labelEn:`Clean Architecture`,color:`green`},{name:`DDD`,label:`DDD`,labelEn:`DDD`,color:`purple`},{name:`patrones`,label:`Patrones`,labelEn:`Patterns`,color:`orange`},{name:`C#`,label:`C#`,labelEn:`C#`,color:`blue`},{name:`design patterns`,label:`Design Patterns`,labelEn:`Design Patterns`,color:`green`}],Ln=[`arquitectura`];function Rn(){let{lang:e}=a(),{filter:n,setFilter:r,clearFilters:i}=T(),[c,l]=(0,_.useState)(!1),[u,d]=(0,_.useState)(!1),f=(n.tags?.length??0)+ +!!n.category+ +!!n.dateRange,m=e=>{let t=n.tags??[],i=t.includes(e)?t.filter(t=>t!==e):[...t,e];r({...n,tags:i})},h=e=>{r({...n,category:e}),l(!1)},g=e=>{r({...n,dateRange:{start:e,end:n.dateRange?.end??``}})},v=e=>{r({...n,dateRange:{start:n.dateRange?.start??``,end:e}})},y=()=>{r({...n,dateRange:null}),d(!1)},b=e=>In.find(t=>t.name===e)??{name:e,label:e,labelEn:e,color:`purple`};return(0,x.jsxs)(`div`,{className:`mb-8`,children:[f>0&&(0,x.jsxs)(`div`,{className:`flex flex-wrap items-center gap-2 mb-4`,children:[n.tags?.map(t=>{let n=b(t),r=e===`es`?n.label:n.labelEn;return(0,x.jsxs)(o.span,{initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.9},className:`skill-tag text-[10px] flex items-center gap-1.5 pr-1`,children:[r,(0,x.jsx)(`button`,{onClick:()=>m(t),className:`hover:text-accent transition-colors cursor-pointer`,"aria-label":`Remove ${r} filter`,children:(0,x.jsx)(s,{size:10})})]},`tag-${t}`)}),n.category&&(0,x.jsxs)(o.span,{initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.9},className:`skill-tag text-[10px] flex items-center gap-1.5 pr-1`,children:[n.category,(0,x.jsx)(`button`,{onClick:()=>h(null),className:`hover:text-accent transition-colors cursor-pointer`,"aria-label":`Remove category filter`,children:(0,x.jsx)(s,{size:10})})]},`cat-chip`),n.dateRange&&(0,x.jsxs)(o.span,{initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.9},className:`skill-tag text-[10px] flex items-center gap-1.5 pr-1`,children:[n.dateRange.start,` – `,n.dateRange.end,(0,x.jsx)(`button`,{onClick:y,className:`hover:text-accent transition-colors cursor-pointer`,"aria-label":`Remove date range filter`,children:(0,x.jsx)(s,{size:10})})]},`date-chip`),(0,x.jsx)(`button`,{onClick:i,className:`font-mono text-[9px] uppercase tracking-wider text-accent hover:text-accent-dark underline transition-colors cursor-pointer`,children:e===`es`?`Limpiar todo`:`Clear all`})]}),(0,x.jsxs)(`div`,{className:`flex flex-wrap items-center gap-3`,children:[(0,x.jsx)(`div`,{className:`flex flex-wrap gap-1.5`,children:In.map(t=>{let r=n.tags?.includes(t.name)??!1,i=e===`es`?t.label:t.labelEn;return(0,x.jsx)(`button`,{onClick:()=>m(t.name),className:`
                  skill-tag text-[10px] cursor-pointer transition-all duration-75
                  ${r?`bg-ink text-paper hover:bg-ink hover:text-paper`:``}
                `,children:i},t.name)})}),(0,x.jsxs)(`div`,{className:`relative`,children:[(0,x.jsxs)(`button`,{onClick:()=>{l(!c),d(!1)},className:`skill-tag text-[10px] flex items-center gap-1 cursor-pointer`,children:[n.category?n.category:e===`es`?`Categoría`:`Category`,(0,x.jsx)(p,{size:10})]}),(0,x.jsx)(t,{children:c&&(0,x.jsxs)(o.div,{initial:{opacity:0,y:-4},animate:{opacity:1,y:0},exit:{opacity:0,y:-4},transition:{duration:.15},className:`absolute top-full left-0 mt-1 z-20 border-2 border-rule bg-paper shadow-pixel-sm min-w-[140px]`,children:[(0,x.jsx)(`button`,{onClick:()=>h(null),className:`block w-full text-left font-mono text-[10px] px-3 py-2 hover:bg-paper-dark transition-colors cursor-pointer`,children:e===`es`?`Todas`:`All`}),Ln.map(e=>(0,x.jsx)(`button`,{onClick:()=>h(e),className:`block w-full text-left font-mono text-[10px] px-3 py-2 hover:bg-paper-dark transition-colors cursor-pointer ${n.category===e?`bg-ink text-paper`:``}`,children:e},e))]})})]}),(0,x.jsxs)(`div`,{className:`relative`,children:[(0,x.jsx)(`button`,{onClick:()=>{d(!u),l(!1)},className:`skill-tag text-[10px] flex items-center gap-1 cursor-pointer`,children:n.dateRange?`${n.dateRange.start} – ${n.dateRange.end}`:e===`es`?`Fechas`:`Dates`}),(0,x.jsx)(t,{children:u&&(0,x.jsxs)(o.div,{initial:{opacity:0,y:-4},animate:{opacity:1,y:0},exit:{opacity:0,y:-4},transition:{duration:.15},className:`absolute top-full left-0 mt-1 z-20 border-2 border-rule bg-paper shadow-pixel-sm p-3 flex flex-col gap-2`,children:[(0,x.jsx)(`label`,{className:`font-mono text-[9px] uppercase tracking-wider text-ink-muted`,children:e===`es`?`Desde`:`From`}),(0,x.jsx)(`input`,{type:`date`,value:n.dateRange?.start??``,onChange:e=>g(e.target.value),className:`border-2 border-rule bg-paper-dark font-mono text-[10px] px-2 py-1`}),(0,x.jsx)(`label`,{className:`font-mono text-[9px] uppercase tracking-wider text-ink-muted`,children:e===`es`?`Hasta`:`To`}),(0,x.jsx)(`input`,{type:`date`,value:n.dateRange?.end??``,onChange:e=>v(e.target.value),className:`border-2 border-rule bg-paper-dark font-mono text-[10px] px-2 py-1`}),n.dateRange&&(0,x.jsx)(`button`,{onClick:y,className:`font-mono text-[9px] text-accent hover:text-accent-dark underline mt-1 cursor-pointer`,children:e===`es`?`Limpiar`:`Clear`})]})})]})]})]})}var zn=`ENTRIES`,Bn=`KEYS`,Vn=`VALUES`,Q=``,Hn=class{constructor(e,t){let n=e._tree,r=Array.from(n.keys());this.set=e,this._type=t,this._path=r.length>0?[{node:n,keys:r}]:[]}next(){let e=this.dive();return this.backtrack(),e}dive(){if(this._path.length===0)return{done:!0,value:void 0};let{node:e,keys:t}=$(this._path);if($(t)===Q)return{done:!1,value:this.result()};let n=e.get($(t));return this._path.push({node:n,keys:Array.from(n.keys())}),this.dive()}backtrack(){if(this._path.length===0)return;let e=$(this._path).keys;e.pop(),!(e.length>0)&&(this._path.pop(),this.backtrack())}key(){return this.set._prefix+this._path.map(({keys:e})=>$(e)).filter(e=>e!==Q).join(``)}value(){return $(this._path).node.get(Q)}result(){switch(this._type){case Vn:return this.value();case Bn:return this.key();default:return[this.key(),this.value()]}}[Symbol.iterator](){return this}},$=e=>e[e.length-1],Un=(e,t,n)=>{let r=new Map;if(t===void 0)return r;let i=t.length+1,a=i+n,o=new Uint8Array(a*i).fill(n+1);for(let e=0;e<i;++e)o[e]=e;for(let e=1;e<a;++e)o[e*i]=e;return Wn(e,t,n,r,o,1,i,``),r},Wn=(e,t,n,r,i,a,o,s)=>{let c=a*o;key:for(let l of e.keys())if(l===Q){let t=i[c-1];t<=n&&r.set(s,[e.get(l),t])}else{let c=a;for(let e=0;e<l.length;++e,++c){let r=l[e],a=o*c,s=a-o,u=i[a],d=Math.max(0,c-n-1),f=Math.min(o-1,c+n);for(let e=d;e<f;++e){let n=r!==t[e],o=i[s+e]+ +n,c=i[s+e+1]+1,l=i[a+e]+1,d=i[a+e+1]=Math.min(o,c,l);d<u&&(u=d)}if(u>n)continue key}Wn(e.get(l),t,n,r,i,c,o,s+l)}},Gn=class e{constructor(e=new Map,t=``){this._size=void 0,this._tree=e,this._prefix=t}atPrefix(t){if(!t.startsWith(this._prefix))throw Error(`Mismatched prefix`);let[n,r]=Kn(this._tree,t.slice(this._prefix.length));if(n===void 0){let[n,i]=Qn(r);for(let r of n.keys())if(r!==Q&&r.startsWith(i)){let a=new Map;return a.set(r.slice(i.length),n.get(r)),new e(a,t)}}return new e(n,t)}clear(){this._size=void 0,this._tree.clear()}delete(e){return this._size=void 0,Yn(this._tree,e)}entries(){return new Hn(this,zn)}forEach(e){for(let[t,n]of this)e(t,n,this)}fuzzyGet(e,t){return Un(this._tree,e,t)}get(e){let t=qn(this._tree,e);return t===void 0?void 0:t.get(Q)}has(e){let t=qn(this._tree,e);return t!==void 0&&t.has(Q)}keys(){return new Hn(this,Bn)}set(e,t){if(typeof e!=`string`)throw Error(`key must be a string`);return this._size=void 0,Jn(this._tree,e).set(Q,t),this}get size(){if(this._size)return this._size;this._size=0;let e=this.entries();for(;!e.next().done;)this._size+=1;return this._size}update(e,t){if(typeof e!=`string`)throw Error(`key must be a string`);this._size=void 0;let n=Jn(this._tree,e);return n.set(Q,t(n.get(Q))),this}fetch(e,t){if(typeof e!=`string`)throw Error(`key must be a string`);this._size=void 0;let n=Jn(this._tree,e),r=n.get(Q);return r===void 0&&n.set(Q,r=t()),r}values(){return new Hn(this,Vn)}[Symbol.iterator](){return this.entries()}static from(t){let n=new e;for(let[e,r]of t)n.set(e,r);return n}static fromObject(t){return e.from(Object.entries(t))}},Kn=(e,t,n=[])=>{if(t.length===0||e==null)return[e,n];for(let r of e.keys())if(r!==Q&&t.startsWith(r))return n.push([e,r]),Kn(e.get(r),t.slice(r.length),n);return n.push([e,t]),Kn(void 0,``,n)},qn=(e,t)=>{if(t.length===0||e==null)return e;for(let n of e.keys())if(n!==Q&&t.startsWith(n))return qn(e.get(n),t.slice(n.length))},Jn=(e,t)=>{let n=t.length;outer:for(let r=0;e&&r<n;){for(let i of e.keys())if(i!==Q&&t[r]===i[0]){let a=Math.min(n-r,i.length),o=1;for(;o<a&&t[r+o]===i[o];)++o;let s=e.get(i);if(o===i.length)e=s;else{let n=new Map;n.set(i.slice(o),s),e.set(t.slice(r,r+o),n),e.delete(i),e=n}r+=o;continue outer}let i=new Map;return e.set(t.slice(r),i),i}return e},Yn=(e,t)=>{let[n,r]=Kn(e,t);if(n!==void 0){if(n.delete(Q),n.size===0)Xn(r);else if(n.size===1){let[e,t]=n.entries().next().value;Zn(r,e,t)}}},Xn=e=>{if(e.length===0)return;let[t,n]=Qn(e);if(t.delete(n),t.size===0)Xn(e.slice(0,-1));else if(t.size===1){let[n,r]=t.entries().next().value;n!==Q&&Zn(e.slice(0,-1),n,r)}},Zn=(e,t,n)=>{if(e.length===0)return;let[r,i]=Qn(e);r.set(i+t,n),r.delete(i)},Qn=e=>e[e.length-1],$n=`or`,er=`and`,tr=`and_not`,nr=class e{constructor(e){if(e?.fields==null)throw Error(`MiniSearch: option "fields" must be provided`);let t=e.autoVacuum==null||e.autoVacuum===!0?pr:e.autoVacuum;this._options={...cr,...e,autoVacuum:t,searchOptions:{...lr,...e.searchOptions||{}},autoSuggestOptions:{...ur,...e.autoSuggestOptions||{}}},this._index=new Gn,this._documentCount=0,this._documentIds=new Map,this._idToShortId=new Map,this._fieldIds={},this._fieldLength=new Map,this._avgFieldLength=[],this._nextId=0,this._storedFields=new Map,this._dirtCount=0,this._currentVacuum=null,this._enqueuedVacuum=null,this._enqueuedVacuumConditions=fr,this.addFields(this._options.fields)}add(e){let{extractField:t,stringifyField:n,tokenize:r,processTerm:i,fields:a,idField:o}=this._options,s=t(e,o);if(s==null)throw Error(`MiniSearch: document does not have ID field "${o}"`);if(this._idToShortId.has(s))throw Error(`MiniSearch: duplicate ID ${s}`);let c=this.addDocumentId(s);this.saveStoredFields(c,e);for(let o of a){let a=t(e,o);if(a==null)continue;let s=r(n(a,o),o),l=this._fieldIds[o],u=new Set(s).size;this.addFieldLength(c,l,this._documentCount-1,u);for(let e of s){let t=i(e,o);if(Array.isArray(t))for(let e of t)this.addTerm(l,c,e);else t&&this.addTerm(l,c,t)}}}addAll(e){for(let t of e)this.add(t)}addAllAsync(e,t={}){let{chunkSize:n=10}=t,r={chunk:[],promise:Promise.resolve()},{chunk:i,promise:a}=e.reduce(({chunk:e,promise:t},r,i)=>(e.push(r),(i+1)%n===0?{chunk:[],promise:t.then(()=>new Promise(e=>setTimeout(e,0))).then(()=>this.addAll(e))}:{chunk:e,promise:t}),r);return a.then(()=>this.addAll(i))}remove(e){let{tokenize:t,processTerm:n,extractField:r,stringifyField:i,fields:a,idField:o}=this._options,s=r(e,o);if(s==null)throw Error(`MiniSearch: document does not have ID field "${o}"`);let c=this._idToShortId.get(s);if(c==null)throw Error(`MiniSearch: cannot remove document with ID ${s}: it is not in the index`);for(let o of a){let a=r(e,o);if(a==null)continue;let s=t(i(a,o),o),l=this._fieldIds[o],u=new Set(s).size;this.removeFieldLength(c,l,this._documentCount,u);for(let e of s){let t=n(e,o);if(Array.isArray(t))for(let e of t)this.removeTerm(l,c,e);else t&&this.removeTerm(l,c,t)}}this._storedFields.delete(c),this._documentIds.delete(c),this._idToShortId.delete(s),this._fieldLength.delete(c),--this._documentCount}removeAll(e){if(e)for(let t of e)this.remove(t);else if(arguments.length>0)throw Error(`Expected documents to be present. Omit the argument to remove all documents.`);else this._index=new Gn,this._documentCount=0,this._documentIds=new Map,this._idToShortId=new Map,this._fieldLength=new Map,this._avgFieldLength=[],this._storedFields=new Map,this._nextId=0}discard(e){let t=this._idToShortId.get(e);if(t==null)throw Error(`MiniSearch: cannot discard document with ID ${e}: it is not in the index`);this._idToShortId.delete(e),this._documentIds.delete(t),this._storedFields.delete(t),(this._fieldLength.get(t)||[]).forEach((e,n)=>{this.removeFieldLength(t,n,this._documentCount,e)}),this._fieldLength.delete(t),--this._documentCount,this._dirtCount+=1,this.maybeAutoVacuum()}maybeAutoVacuum(){if(this._options.autoVacuum===!1)return;let{minDirtFactor:e,minDirtCount:t,batchSize:n,batchWait:r}=this._options.autoVacuum;this.conditionalVacuum({batchSize:n,batchWait:r},{minDirtCount:t,minDirtFactor:e})}discardAll(e){let t=this._options.autoVacuum;try{this._options.autoVacuum=!1;for(let t of e)this.discard(t)}finally{this._options.autoVacuum=t}this.maybeAutoVacuum()}replace(e){let{idField:t,extractField:n}=this._options,r=n(e,t);this.discard(r),this.add(e)}vacuum(e={}){return this.conditionalVacuum(e)}conditionalVacuum(e,t){return this._currentVacuum?(this._enqueuedVacuumConditions=this._enqueuedVacuumConditions&&t,this._enqueuedVacuum??=this._currentVacuum.then(()=>{let t=this._enqueuedVacuumConditions;return this._enqueuedVacuumConditions=fr,this.performVacuuming(e,t)}),this._enqueuedVacuum):this.vacuumConditionsMet(t)===!1?Promise.resolve():(this._currentVacuum=this.performVacuuming(e),this._currentVacuum)}async performVacuuming(e,t){let n=this._dirtCount;if(this.vacuumConditionsMet(t)){let t=e.batchSize||dr.batchSize,r=e.batchWait||dr.batchWait,i=1;for(let[e,n]of this._index){for(let[e,t]of n)for(let[r]of t)this._documentIds.has(r)||(t.size<=1?n.delete(e):t.delete(r));this._index.get(e).size===0&&this._index.delete(e),i%t===0&&await new Promise(e=>setTimeout(e,r)),i+=1}this._dirtCount-=n}await null,this._currentVacuum=this._enqueuedVacuum,this._enqueuedVacuum=null}vacuumConditionsMet(e){if(e==null)return!0;let{minDirtCount:t,minDirtFactor:n}=e;return t||=pr.minDirtCount,n||=pr.minDirtFactor,this.dirtCount>=t&&this.dirtFactor>=n}get isVacuuming(){return this._currentVacuum!=null}get dirtCount(){return this._dirtCount}get dirtFactor(){return this._dirtCount/(1+this._documentCount+this._dirtCount)}has(e){return this._idToShortId.has(e)}getStoredFields(e){let t=this._idToShortId.get(e);if(t!=null)return this._storedFields.get(t)}search(t,n={}){let{searchOptions:r}=this._options,i={...r,...n},a=this.executeQuery(t,n),o=[];for(let[e,{score:t,terms:n,match:r}]of a){let a=n.length||1,s={id:this._documentIds.get(e),score:t*a,terms:Object.keys(r),queryTerms:n,match:r};Object.assign(s,this._storedFields.get(e)),(i.filter==null||i.filter(s))&&o.push(s)}return t===e.wildcard&&i.boostDocument==null||o.sort(gr),o}autoSuggest(e,t={}){t={...this._options.autoSuggestOptions,...t};let n=new Map;for(let{score:r,terms:i}of this.search(e,t)){let e=i.join(` `),t=n.get(e);t==null?n.set(e,{score:r,terms:i,count:1}):(t.score+=r,t.count+=1)}let r=[];for(let[e,{score:t,terms:i,count:a}]of n)r.push({suggestion:e,terms:i,score:t/a});return r.sort(gr),r}get documentCount(){return this._documentCount}get termCount(){return this._index.size}static loadJSON(e,t){if(t==null)throw Error(`MiniSearch: loadJSON should be given the same options used when serializing the index`);return this.loadJS(JSON.parse(e),t)}static async loadJSONAsync(e,t){if(t==null)throw Error(`MiniSearch: loadJSON should be given the same options used when serializing the index`);return this.loadJSAsync(JSON.parse(e),t)}static getDefault(e){if(cr.hasOwnProperty(e))return rr(cr,e);throw Error(`MiniSearch: unknown option "${e}"`)}static loadJS(e,t){let{index:n,documentIds:r,fieldLength:i,storedFields:a,serializationVersion:o}=e,s=this.instantiateMiniSearch(e,t);s._documentIds=vr(r),s._fieldLength=vr(i),s._storedFields=vr(a);for(let[e,t]of s._documentIds)s._idToShortId.set(t,e);for(let[e,t]of n){let n=new Map;for(let e of Object.keys(t)){let r=t[e];o===1&&(r=r.ds),n.set(parseInt(e,10),vr(r))}s._index.set(e,n)}return s}static async loadJSAsync(e,t){let{index:n,documentIds:r,fieldLength:i,storedFields:a,serializationVersion:o}=e,s=this.instantiateMiniSearch(e,t);s._documentIds=await yr(r),s._fieldLength=await yr(i),s._storedFields=await yr(a);for(let[e,t]of s._documentIds)s._idToShortId.set(t,e);let c=0;for(let[e,t]of n){let n=new Map;for(let e of Object.keys(t)){let r=t[e];o===1&&(r=r.ds),n.set(parseInt(e,10),await yr(r))}++c%1e3==0&&await br(0),s._index.set(e,n)}return s}static instantiateMiniSearch(t,n){let{documentCount:r,nextId:i,fieldIds:a,averageFieldLength:o,dirtCount:s,serializationVersion:c}=t;if(c!==1&&c!==2)throw Error(`MiniSearch: cannot deserialize an index created with an incompatible version`);let l=new e(n);return l._documentCount=r,l._nextId=i,l._idToShortId=new Map,l._fieldIds=a,l._avgFieldLength=o,l._dirtCount=s||0,l._index=new Gn,l}executeQuery(t,n={}){if(t===e.wildcard)return this.executeWildcardQuery(n);if(typeof t!=`string`){let e={...n,...t,queries:void 0},r=t.queries.map(t=>this.executeQuery(t,e));return this.combineResults(r,e.combineWith)}let{tokenize:r,processTerm:i,searchOptions:a}=this._options,o={tokenize:r,processTerm:i,...a,...n},{tokenize:s,processTerm:c}=o,l=s(t).flatMap(e=>c(e)).filter(e=>!!e).map(sr(o)).map(e=>this.executeQuerySpec(e,o));return this.combineResults(l,o.combineWith)}executeQuerySpec(e,t){let n={...this._options.searchOptions,...t},r=(n.fields||this._options.fields).reduce((e,t)=>({...e,[t]:rr(n.boost,t)||1}),{}),{boostDocument:i,weights:a,maxFuzzy:o,bm25:s}=n,{fuzzy:c,prefix:l}={...lr.weights,...a},u=this._index.get(e.term),d=this.termResults(e.term,e.term,1,e.termBoost,u,r,i,s),f,p;if(e.prefix&&(f=this._index.atPrefix(e.term)),e.fuzzy){let t=e.fuzzy===!0?.2:e.fuzzy,n=t<1?Math.min(o,Math.round(e.term.length*t)):t;n&&(p=this._index.fuzzyGet(e.term,n))}if(f)for(let[t,n]of f){let a=t.length-e.term.length;if(!a)continue;p?.delete(t);let o=l*t.length/(t.length+.3*a);this.termResults(e.term,t,o,e.termBoost,n,r,i,s,d)}if(p)for(let t of p.keys()){let[n,a]=p.get(t);if(!a)continue;let o=c*t.length/(t.length+a);this.termResults(e.term,t,o,e.termBoost,n,r,i,s,d)}return d}executeWildcardQuery(e){let t=new Map,n={...this._options.searchOptions,...e};for(let[e,r]of this._documentIds){let i=n.boostDocument?n.boostDocument(r,``,this._storedFields.get(e)):1;t.set(e,{score:i,terms:[],match:{}})}return t}combineResults(e,t=$n){if(e.length===0)return new Map;let n=ir[t.toLowerCase()];if(!n)throw Error(`Invalid combination operator: ${t}`);return e.reduce(n)||new Map}toJSON(){let e=[];for(let[t,n]of this._index){let r={};for(let[e,t]of n)r[e]=Object.fromEntries(t);e.push([t,r])}return{documentCount:this._documentCount,nextId:this._nextId,documentIds:Object.fromEntries(this._documentIds),fieldIds:this._fieldIds,fieldLength:Object.fromEntries(this._fieldLength),averageFieldLength:this._avgFieldLength,storedFields:Object.fromEntries(this._storedFields),dirtCount:this._dirtCount,index:e,serializationVersion:2}}termResults(e,t,n,r,i,a,o,s,c=new Map){if(i==null)return c;for(let l of Object.keys(a)){let u=a[l],d=this._fieldIds[l],f=i.get(d);if(f==null)continue;let p=f.size,m=this._avgFieldLength[d];for(let i of f.keys()){if(!this._documentIds.has(i)){this.removeTerm(d,i,t),--p;continue}let a=o?o(this._documentIds.get(i),t,this._storedFields.get(i)):1;if(!a)continue;let h=f.get(i),g=this._fieldLength.get(i)[d],_=or(h,p,this._documentCount,g,m,s),v=n*r*u*a*_,y=c.get(i);if(y){y.score+=v,mr(y.terms,e);let n=rr(y.match,t);n?n.push(l):y.match[t]=[l]}else c.set(i,{score:v,terms:[e],match:{[t]:[l]}})}}return c}addTerm(e,t,n){let r=this._index.fetch(n,_r),i=r.get(e);if(i==null)i=new Map,i.set(t,1),r.set(e,i);else{let e=i.get(t);i.set(t,(e||0)+1)}}removeTerm(e,t,n){if(!this._index.has(n)){this.warnDocumentChanged(t,e,n);return}let r=this._index.fetch(n,_r),i=r.get(e);i==null||i.get(t)==null?this.warnDocumentChanged(t,e,n):i.get(t)<=1?i.size<=1?r.delete(e):i.delete(t):i.set(t,i.get(t)-1),this._index.get(n).size===0&&this._index.delete(n)}warnDocumentChanged(e,t,n){for(let r of Object.keys(this._fieldIds))if(this._fieldIds[r]===t){this._options.logger(`warn`,`MiniSearch: document with ID ${this._documentIds.get(e)} has changed before removal: term "${n}" was not present in field "${r}". Removing a document after it has changed can corrupt the index!`,`version_conflict`);return}}addDocumentId(e){let t=this._nextId;return this._idToShortId.set(e,t),this._documentIds.set(t,e),this._documentCount+=1,this._nextId+=1,t}addFields(e){for(let t=0;t<e.length;t++)this._fieldIds[e[t]]=t}addFieldLength(e,t,n,r){let i=this._fieldLength.get(e);i??this._fieldLength.set(e,i=[]),i[t]=r;let a=(this._avgFieldLength[t]||0)*n+r;this._avgFieldLength[t]=a/(n+1)}removeFieldLength(e,t,n,r){if(n===1){this._avgFieldLength[t]=0;return}let i=this._avgFieldLength[t]*n-r;this._avgFieldLength[t]=i/(n-1)}saveStoredFields(e,t){let{storeFields:n,extractField:r}=this._options;if(n==null||n.length===0)return;let i=this._storedFields.get(e);i??this._storedFields.set(e,i={});for(let e of n){let n=r(t,e);n!==void 0&&(i[e]=n)}}};nr.wildcard=Symbol(`*`);var rr=(e,t)=>Object.prototype.hasOwnProperty.call(e,t)?e[t]:void 0,ir={[$n]:(e,t)=>{for(let n of t.keys()){let r=e.get(n);if(r==null)e.set(n,t.get(n));else{let{score:e,terms:i,match:a}=t.get(n);r.score+=e,r.match=Object.assign(r.match,a),hr(r.terms,i)}}return e},[er]:(e,t)=>{let n=new Map;for(let r of t.keys()){let i=e.get(r);if(i==null)continue;let{score:a,terms:o,match:s}=t.get(r);hr(i.terms,o),n.set(r,{score:i.score+a,terms:i.terms,match:Object.assign(i.match,s)})}return n},[tr]:(e,t)=>{for(let n of t.keys())e.delete(n);return e}},ar={k:1.2,b:.7,d:.5},or=(e,t,n,r,i,a)=>{let{k:o,b:s,d:c}=a;return Math.log(1+(n-t+.5)/(t+.5))*(c+e*(o+1)/(e+o*(1-s+s*r/i)))},sr=e=>(t,n,r)=>({term:t,fuzzy:typeof e.fuzzy==`function`?e.fuzzy(t,n,r):e.fuzzy||!1,prefix:typeof e.prefix==`function`?e.prefix(t,n,r):e.prefix===!0,termBoost:typeof e.boostTerm==`function`?e.boostTerm(t,n,r):1}),cr={idField:`id`,extractField:(e,t)=>e[t],stringifyField:(e,t)=>e.toString(),tokenize:e=>e.split(xr),processTerm:e=>e.toLowerCase(),fields:void 0,searchOptions:void 0,storeFields:[],logger:(e,t)=>{typeof(console==null?void 0:console[e])==`function`&&console[e](t)},autoVacuum:!0},lr={combineWith:$n,prefix:!1,fuzzy:!1,maxFuzzy:6,boost:{},weights:{fuzzy:.45,prefix:.375},bm25:ar},ur={combineWith:er,prefix:(e,t,n)=>t===n.length-1},dr={batchSize:1e3,batchWait:10},fr={minDirtFactor:.1,minDirtCount:20},pr={...dr,...fr},mr=(e,t)=>{e.includes(t)||e.push(t)},hr=(e,t)=>{for(let n of t)e.includes(n)||e.push(n)},gr=({score:e},{score:t})=>t-e,_r=()=>new Map,vr=e=>{let t=new Map;for(let n of Object.keys(e))t.set(parseInt(n,10),e[n]);return t},yr=async e=>{let t=new Map,n=0;for(let r of Object.keys(e))t.set(parseInt(r,10),e[r]),++n%1e3==0&&await br(0);return t},br=e=>new Promise(t=>setTimeout(t,e)),xr=/[\n\r\p{Z}\p{P}]+/u;function Sr(e){return e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`)}function Cr(e,t){if(!t.trim())return[e];let n=Sr(t);return e.split(RegExp(`(${n})`,`gi`)).map((e,n)=>e.toLowerCase()===t.toLowerCase()?(0,x.jsx)(`mark`,{className:`bg-accent/20 text-ink font-bold px-0.5 rounded-none`,children:e},n):e)}function wr(e,t){let[n,r]=(0,_.useState)(e);return(0,_.useEffect)(()=>{let n=setTimeout(()=>r(e),t);return()=>clearTimeout(n)},[e,t]),n}function Tr({defaultQuery:e=``}){let{lang:n}=a(),{posts:r}=T(),[i,c]=(0,_.useState)(e),[l,u]=(0,_.useState)([]),[d,f]=(0,_.useState)(!1),p=(0,_.useRef)(null),m=(0,_.useRef)(null);(0,_.useEffect)(()=>{e&&c(e)},[e]);let g=wr(i,200);(0,_.useEffect)(()=>{let e=new nr({fields:[`title`,`titleEn`,`tags`,`excerpt`,`excerptEn`],storeFields:[`id`,`slug`,`title`,`titleEn`,`excerpt`,`excerptEn`,`tags`,`date`,`readingTime`],searchOptions:{boost:{title:3,titleEn:3,tags:2,excerpt:1,excerptEn:1},fuzzy:.2,prefix:!0}});return e.addAll(r),p.current=e,f(!0),()=>{p.current=null}},[r]),(0,_.useEffect)(()=>{if(!g.trim()||!p.current){u([]);return}u(p.current.search(g).map(e=>r.find(t=>t.id===e.id)).filter(e=>e!==void 0))},[g,r]);let v=(0,_.useCallback)(()=>{c(``),u([]),m.current?.focus()},[]),y=(0,_.useCallback)(e=>{window.location.hash=`#blog/article/${e.slug}`,c(``),u([])},[]),b=i.trim().length>0,S=l.length>0;return(0,x.jsxs)(`div`,{className:`mb-8`,children:[(0,x.jsxs)(`div`,{className:`relative`,children:[(0,x.jsx)(h,{size:14,className:`absolute left-3 top-1/2 -translate-y-1/2 text-ink-muted pointer-events-none`}),(0,x.jsx)(`input`,{ref:m,type:`text`,value:i,onChange:e=>c(e.target.value),placeholder:n===`es`?`Buscar artículos…`:`Search articles…`,className:`w-full border-2 border-rule bg-paper px-9 py-2.5 font-mono text-xs text-ink placeholder:text-ink-muted outline-none focus:bg-paper-dark transition-colors`,"aria-label":n===`es`?`Buscar artículos`:`Search articles`}),b&&(0,x.jsx)(`button`,{onClick:v,className:`absolute right-3 top-1/2 -translate-y-1/2 text-ink-muted hover:text-accent transition-colors cursor-pointer`,"aria-label":`Clear search`,children:(0,x.jsx)(s,{size:14})})]}),(0,x.jsx)(t,{children:b&&(0,x.jsx)(o.div,{initial:{opacity:0,y:-8},animate:{opacity:1,y:0},exit:{opacity:0,y:-8},transition:{duration:.15},className:`border-x-2 border-b-2 border-rule bg-paper shadow-pixel-sm mt-0`,children:d?S?(0,x.jsx)(`ul`,{className:`divide-y divide-rule-light`,children:l.map(e=>{let t=n===`es`?e.title:e.titleEn,r=n===`es`?e.excerpt:e.excerptEn;return(0,x.jsx)(`li`,{children:(0,x.jsxs)(`button`,{onClick:()=>y(e),className:`w-full text-left px-4 py-3 hover:bg-paper-dark transition-colors cursor-pointer`,children:[(0,x.jsx)(`h4`,{className:`font-headline text-sm font-bold text-ink leading-tight mb-1`,children:Cr(t,g)}),(0,x.jsx)(`p`,{className:`font-sans text-[11px] text-ink-light leading-relaxed line-clamp-2`,children:Cr(r,g)}),(0,x.jsxs)(`div`,{className:`flex items-center gap-2 mt-1.5`,children:[(0,x.jsx)(`span`,{className:`font-mono text-[9px] text-ink-muted`,children:e.date}),(0,x.jsxs)(`span`,{className:`font-mono text-[9px] text-ink-muted`,children:[e.readingTime,` min`]})]})]})},e.id)})}):(0,x.jsx)(`div`,{className:`p-4`,children:(0,x.jsx)(O,{context:`search`,searchQuery:g})}):(0,x.jsx)(`div`,{className:`p-4 text-center`,children:(0,x.jsx)(`p`,{className:`font-mono text-[10px] text-ink-muted`,children:n===`es`?`Indexando…`:`Indexing…`})})})})]})}function Er(){let{t:e}=a(),n=D(),{posts:r,selectedPost:i,setSelectedPost:s,setFilter:c}=T(),l=n.currentRoute===`article`&&n.selectedSlug?r.find(e=>e.slug===n.selectedSlug)??null:null;(0,_.useLayoutEffect)(()=>{n.currentRoute===`tag`&&n.currentParams.tag?c({tags:[n.currentParams.tag],category:null,dateRange:null}):(n.currentRoute===`list`||n.currentRoute===`search`)&&c({tags:[],category:null,dateRange:null}),n.currentRoute!==`article`&&s(null)},[n.currentRoute,n.selectedSlug,n.currentParams.tag]),(0,_.useLayoutEffect)(()=>{l&&l!==i&&s(l)},[l]);let u=n.currentRoute===`article`?`article-${n.selectedSlug}`:n.currentRoute;return(0,x.jsxs)(`section`,{id:`blog`,className:`py-20 px-6 max-w-7xl mx-auto`,children:[(0,x.jsxs)(`div`,{className:`mb-10`,children:[(0,x.jsx)(`div`,{className:`border-t-4 border-rule mb-1`}),(0,x.jsx)(`div`,{className:`border-t border-rule mb-4`}),(0,x.jsx)(`h2`,{className:`font-headline text-4xl md:text-5xl font-black text-ink leading-none`,children:e(`blog.title`)}),(0,x.jsx)(`p`,{className:`font-mono text-xs text-ink-muted mt-2`,children:e(`blog.subtitle`)}),(0,x.jsx)(`div`,{className:`border-t-4 border-rule mt-4`})]}),(0,x.jsx)(t,{mode:`sync`,children:(0,x.jsx)(o.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},exit:{opacity:0,y:-10},transition:{duration:.2},children:n.currentRoute===`article`?i||l?(0,x.jsx)(Fn,{}):null:(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(Rn,{}),(0,x.jsx)(Tr,{defaultQuery:n.currentRoute===`search`?n.currentParams.q??``:``}),(0,x.jsx)(ee,{})]})},u)})]})}function Dr(){return(0,x.jsx)(w,{children:(0,x.jsx)(Er,{})})}export{Dr as BlogRoot};