...
**A pixel gate is only honest if re-cutting a baseline costs effort.** Every differing region has to be attributed to an intended text change before the new image is accepted. The moment re-cutting is cheaper than explaining, the gate becomes a log of what happened rather than a control on what may happen.`},{id:`authorization-attribute-invisible-to-unit-test`,slug:`atributo-autorizacion-invisible-prueba-unitaria`,title:`El atributo de autorización que ninguna prueba unitaria puede ver`,titleEn:`The Authorization Attribute a Unit Test Cannot See`,date:`2026-09-26`,tags:[`testing`,`tdd`,`ASP.NET Core`,`dotnet`,`authorization`],category:`arquitectura`,featured:!1,excerpt:`Añadí un endpoint administrativo que sustituye una operación que antes solo un DBA podía ejecutar, protegido por un atributo de autorización. La prueba unitaria más obvia lo confirmaba en verde llamando al método del controlador directamente, y por eso mismo no probaba nada: ese atributo solo lo evalúa el middleware, nunca una llamada de método suelta. La prueba honesta necesitó un servidor de pruebas real y una mutación deliberada del atributo para demostrar que medía lo que decía medir.`,excerptEn:`I added an administrative endpoint that replaces an operation only a DBA could previously run, protected by an authorization attribute. The obvious unit test confirmed it green by calling the controller method directly, which is exactly why it proved nothing: that attribute is only ever evaluated by the middleware, never by a bare method call. The honest test needed a real test server and a deliberate mutation of the attribute to prove it measured what it claimed to measure.`,content:`Un flujo administrativo tenía un caso atascado que, hasta ese momento, solo un DBA podía resolver: una actualización manual directamente sobre la base de datos cuando el camino normal se trababa. El requisito para convertir eso en un endpoint HTTP era corto de enunciar: sin el permiso correcto, la petición responde 403 y el servicio de dominio no se ejecuta en absoluto. No 403 con trabajo hecho detrás. 403 real, sin ningún efecto secundario.
...
**El borde de lo que se mockea es una decisión, no un accidente de lo que resulta fácil de instanciar.** Mockear el servicio de dominio fue correcto porque ya estaba probado en otro lugar; mockear la autorización habría sido correcto solo si esta prueba no fuera, precisamente, la prueba de la autorización.`,contentEn:`An administrative workflow had a stuck case that, until then, only a DBA could resolve: a manual update run directly against the database whenever the normal path got stuck. The requirement for turning that into an HTTP endpoint was short to state: without the correct permission, the request returns 403 and the domain service never runs at all. Not a 403 with work done behind it. A real 403, with no side effect.
...
`;break;case-2:o=t?` `:`	`;break;case-1:if(!t&&i)continue;o=` `;break;default:o=String.fromCharCode(a)}i=a===-2,r.push(o)}return r.join(``)}function Mn(e){let t={constructs:re([yn,...(e||{}).extensions||[]]),content:n(J),defined:[],document:n(Te),flow:n(dn),lazy:{},string:n(mn),text:n(hn)};return t;function n(e){return n;function n(n){return kn(t,e,n)}}}function Nn(e){for(;!at(e););return e}var Pn=/[\0\t\n\r]/g;function Fn(){let e=1,t=``,n=!0,r;return i;function i(i,a,o){let s=[],c,l,u,d,f;for(i=t+(typeof i==`string`?i.toString():new TextDecoder(a||void 0).decode(i)),u=0,t=``,n&&=(i.charCodeAt(0)===65279&&u++,void 0);u<i.length;){if(Pn.lastIndex=u,c=Pn.exec(i),d=c&&c.index!==void 0?c.index:i.length,f=i.charCodeAt(d),!c){t=i.slice(u);break}if(f===10&&u===d&&r)s.push(-3),r=void 0;else switch(r&&=(s.push(-5),void 0),u<d&&(s.push(i.slice(u,d)),e+=d-u),f){case 0:s.push(65533),e++;break;case 9:for(l=Math.ceil(e/4)*4,s.push(-2);e++<l;)s.push(-1);break;case 10:s.push(-4),e=1;break;default:r=!0,e=1}u=d+1}return o&&(r&&s.push(-5),t&&s.push(t),s.push(null)),s}}function In(e,t,n){return typeof t!=`string`&&(n=t,t=void 0),Ce(n)(Nn(Mn(n).document().write(Fn()(e,t,!0))))}function Ln(e){return In(e,{allowDangerousHtml:!1})}function Rn(e,t,n=3){let r=t.filter(t=>t.id!==e.id).map(t=>{let n=t.tags.filter(t=>e.tags.includes(t)).length,r=(Date.now()-new Date(t.date).getTime())/(1e3*60*60*24),i=Math.max(0,14-r)*.1;return{...t,score:n+i}});return r.sort((e,t)=>t.score-e.score),r.slice(0,n)}function zn(e,t,n=3){return(0,v.useMemo)(()=>Rn(e,t,n),[e,t,n])}function Bn({currentPost:e}){let{lang:t}=l(),{posts:n}=E(),r=zn(e,n,3);if(n.length<2||r.length===0)return null;let{setSelectedPost:i}=E(),a=e=>{i(e),history.pushState(null,``,`#blog/article/${e.slug}`)};return(0,S.jsx)(s,{children:(0,S.jsxs)(`div`,{className:`border-t-4 border-rule pt-6 mt-10 mb-8`,children:[(0,S.jsx)(`h3`,{className:`font-headline text-xl md:text-2xl font-bold text-ink mb-5`,children:t===`es`?`Artículos relacionados`:`Related posts`}),(0,S.jsx)(`div`,{className:`grid md:grid-cols-3 gap-4`,children:r.map((e,n)=>{let r=t===`es`?e.title:e.titleEn,i=t===`es`?e.excerpt:e.excerptEn;return(0,S.jsx)(u.article,{initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{duration:.25,delay:n*.08},className:`border-2 border-rule bg-paper shadow-pixel-sm hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 active:shadow-none active:translate-x-0.5 active:translate-y-0.5 transition-all duration-75 flex flex-col`,children:(0,S.jsxs)(`button`,{onClick:()=>a(e),className:`flex flex-col h-full text-left cursor-pointer p-4 gap-2`,children:[(0,S.jsx)(`div`,{className:`flex flex-wrap gap-1`,children:e.tags.slice(0,2).map(e=>(0,S.jsxs)(`span`,{className:`skill-tag text-[8px] flex items-center gap-1`,children:[(0,S.jsx)(_,{size:6}),` `,e]},e))}),(0,S.jsx)(`h4`,{className:`font-headline text-sm font-bold text-ink leading-tight line-clamp-2`,children:r}),(0,S.jsx)(`p`,{className:`font-sans text-[11px] text-ink-light leading-relaxed line-clamp-2 flex-1`,children:i}),(0,S.jsxs)(`span`,{className:`font-mono text-[9px] font-bold uppercase tracking-wider text-accent hover:text-accent-dark flex items-center gap-1 mt-auto pt-2 transition-colors`,children:[t===`es`?`Leer`:`Read`,` `,(0,S.jsx)(f,{size:9})]})]})},e.id)})})]})})}function Vn(){let{lang:e}=l(),{filteredPosts:n,selectedPost:r,setSelectedPost:i}=E(),a=(0,v.useRef)(null),o=r,s=n.findIndex(e=>e.id===o?.id),c=s>0?n[s-1]:null,d=s>=0&&s<n.length-1?n[s+1]:null;(0,v.useEffect)(()=>{a.current&&a.current.scrollIntoView({block:`start`,behavior:`smooth`}),window.scrollTo({top:0,behavior:`smooth`})},[o?.id]);let m=()=>{history.pushState(null,``,`#blog`),window.dispatchEvent(new HashChangeEvent(`hashchange`))},g=()=>{c&&(i(c),history.pushState(null,``,`#blog/article/${c.slug}`))},_=()=>{d&&(i(d),history.pushState(null,``,`#blog/article/${d.slug}`))};if(!o)return null;let y=e===`es`?o.title:o.titleEn,b=e===`es`?o.content:o.contentEn,x=e===`es`?`Volver a artículos`:`Back to articles`;return(0,S.jsx)(u.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},transition:{duration:.25},ref:a,children:(0,S.jsxs)(`article`,{className:`max-w-4xl mx-auto`,children:[(0,S.jsxs)(`button`,{onClick:m,className:`flex items-center gap-1.5 font-mono text-[11px] font-bold uppercase tracking-wider text-ink-muted hover:text-accent transition-colors mb-6 cursor-pointer`,children:[(0,S.jsx)(t,{size:14}),x]}),(0,S.jsx)(`div`,{className:`border-t-4 border-rule mb-1`}),(0,S.jsx)(`div`,{className:`border-t border-rule mb-6`}),(0,S.jsx)(`h1`,{className:`font-headline text-3xl md:text-5xl lg:text-6xl font-black text-ink leading-[1.05] tracking-tight mb-4`,children:y}),(0,S.jsxs)(`div`,{className:`flex flex-wrap items-center gap-x-4 gap-y-1 mb-6 pb-4 border-b border-rule-light`,children:[(0,S.jsxs)(`span`,{className:`font-mono text-xs text-ink-muted flex items-center gap-1.5`,children:[(0,S.jsx)(p,{size:12}),o.date]}),(0,S.jsxs)(`span`,{className:`font-mono text-xs text-ink-muted flex items-center gap-1.5`,children:[(0,S.jsx)(h,{size:12}),o.readingTime,` min `,e===`es`?`de lectura`:`read`]}),(0,S.jsx)(`span`,{className:`hidden md:inline font-mono text-[10px] text-ink-muted uppercase tracking-wider`,children:`Por Edwin Trigos`})]}),(0,S.jsx)(`div`,{className:`flex flex-wrap gap-1.5 mb-8`,children:o.tags.map(e=>(0,S.jsx)(`span`,{className:`skill-tag text-[10px]`,children:e},e))}),(0,S.jsx)(`div`,{className:`
          ...
          `,dangerouslySetInnerHTML:{__html:Ln(b)}}),(0,S.jsx)(`div`,{className:`border-t-4 border-rule mt-12 mb-1`}),(0,S.jsx)(`div`,{className:`border-t border-rule mb-6`}),(0,S.jsxs)(`nav`,{className:`flex justify-between items-stretch gap-4 mb-10`,children:[c?(0,S.jsxs)(`button`,{onClick:g,className:`flex-1 flex flex-col items-start gap-1 border-2 border-rule bg-paper p-4 shadow-pixel-sm hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 active:shadow-none active:translate-x-0.5 active:translate-y-0.5 transition-all duration-75 text-left cursor-pointer`,children:[(0,S.jsxs)(`span`,{className:`font-mono text-[9px] uppercase tracking-wider text-ink-muted flex items-center gap-1`,children:[(0,S.jsx)(t,{size:10}),` `,e===`es`?`Anterior`:`Previous`]}),(0,S.jsx)(`span`,{className:`font-headline text-sm font-bold text-ink leading-tight line-clamp-2`,children:e===`es`?c.title:c.titleEn})]}):(0,S.jsx)(`div`,{className:`flex-1`}),d?(0,S.jsxs)(`button`,{onClick:_,className:`flex-1 flex flex-col items-end gap-1 border-2 border-rule bg-paper p-4 shadow-pixel-sm hover:shadow-none hover:-translate-x-0.5 hover:translate-y-0.5 active:shadow-none active:-translate-x-0.5 active:translate-y-0.5 transition-all duration-75 text-right cursor-pointer`,children:[(0,S.jsxs)(`span`,{className:`font-mono text-[9px] uppercase tracking-wider text-ink-muted flex items-center gap-1`,children:[e===`es`?`Siguiente`:`Next`,` `,(0,S.jsx)(f,{size:10})]}),(0,S.jsx)(`span`,{className:`font-headline text-sm font-bold text-ink leading-tight line-clamp-2`,children:e===`es`?d.title:d.titleEn})]}):(0,S.jsx)(`div`,{className:`flex-1`})]}),(0,S.jsxs)(`button`,{onClick:m,className:`flex items-center gap-1.5 font-mono text-[11px] font-bold uppercase tracking-wider text-ink-muted hover:text-accent transition-colors mb-6 cursor-pointer`,children:[(0,S.jsx)(t,{size:14}),x]}),o&&(0,S.jsx)(Bn,{currentPost:o})]})},`article-${o.id}`)}var Hn=[{name:`arquitectura`,label:`Arquitectura`,labelEn:`Architecture`,color:`red`},{name:`.NET`,label:`.NET`,labelEn:`.NET`,color:`blue`},{name:`clean architecture`,label:`Clean Architecture`,labelEn:`Clean Architecture`,color:`green`},{name:`DDD`,label:`DDD`,labelEn:`DDD`,color:`purple`},{name:`patrones`,label:`Patrones`,labelEn:`Patterns`,color:`orange`},{name:`C#`,label:`C#`,labelEn:`C#`,color:`blue`},{name:`design patterns`,label:`Design Patterns`,labelEn:`Design Patterns`,color:`green`}],Un=[`arquitectura`];function Wn(){let{lang:e}=l(),{filter:t,setFilter:n,clearFilters:r}=E(),[o,s]=(0,v.useState)(!1),[c,d]=(0,v.useState)(!1),f=(t.tags?.length??0)+ +!!t.category+ +!!t.dateRange,p=e=>{let r=t.tags??[],i=r.includes(e)?r.filter(t=>t!==e):[...r,e];n({...t,tags:i})},h=e=>{n({...t,category:e}),s(!1)},g=e=>{n({...t,dateRange:{start:e,end:t.dateRange?.end??``}})},_=e=>{n({...t,dateRange:{start:t.dateRange?.start??``,end:e}})},y=()=>{n({...t,dateRange:null}),d(!1)},b=e=>Hn.find(t=>t.name===e)??{name:e,label:e,labelEn:e,color:`purple`};return(0,S.jsxs)(`div`,{className:`mb-8`,children:[f>0&&(0,S.jsxs)(`div`,{className:`flex flex-wrap items-center gap-2 mb-4`,children:[t.tags?.map(t=>{let n=b(t),r=e===`es`?n.label:n.labelEn;return(0,S.jsxs)(u.span,{initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.9},className:`skill-tag text-[10px] flex items-center gap-1.5 pr-1`,children:[r,(0,S.jsx)(`button`,{onClick:()=>p(t),className:`hover:text-accent transition-colors cursor-pointer`,"aria-label":`Remove ${r} filter`,children:(0,S.jsx)(i,{size:10})})]},`tag-${t}`)}),t.category&&(0,S.jsxs)(u.span,{initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.9},className:`skill-tag text-[10px] flex items-center gap-1.5 pr-1`,children:[t.category,(0,S.jsx)(`button`,{onClick:()=>h(null),className:`hover:text-accent transition-colors cursor-pointer`,"aria-label":`Remove category filter`,children:(0,S.jsx)(i,{size:10})})]},`cat-chip`),t.dateRange&&(0,S.jsxs)(u.span,{initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.9},className:`skill-tag text-[10px] flex items-center gap-1.5 pr-1`,children:[t.dateRange.start,` – `,t.dateRange.end,(0,S.jsx)(`button`,{onClick:y,className:`hover:text-accent transition-colors cursor-pointer`,"aria-label":`Remove date range filter`,children:(0,S.jsx)(i,{size:10})})]},`date-chip`),(0,S.jsx)(`button`,{onClick:r,className:`font-mono text-[9px] uppercase tracking-wider text-accent hover:text-accent-dark underline transition-colors cursor-pointer`,children:e===`es`?`Limpiar todo`:`Clear all`})]}),(0,S.jsxs)(`div`,{className:`flex flex-wrap items-center gap-3`,children:[(0,S.jsx)(`div`,{className:`flex flex-wrap gap-1.5`,children:Hn.map(n=>{let r=t.tags?.includes(n.name)??!1,i=e===`es`?n.label:n.labelEn;return(0,S.jsx)(`button`,{onClick:()=>p(n.name),className:`
                  skill-tag text-[10px] cursor-pointer transition-all duration-75
                  ${r?`bg-ink text-paper hover:bg-ink hover:text-paper`:``}
                `,children:i},n.name)})}),(0,S.jsxs)(`div`,{className:`relative`,children:[(0,S.jsxs)(`button`,{onClick:()=>{s(!o),d(!1)},className:`skill-tag text-[10px] flex items-center gap-1 cursor-pointer`,children:[t.category?t.category:e===`es`?`Categoría`:`Category`,(0,S.jsx)(m,{size:10})]}),(0,S.jsx)(a,{children:o&&(0,S.jsxs)(u.div,{initial:{opacity:0,y:-4},animate:{opacity:1,y:0},exit:{opacity:0,y:-4},transition:{duration:.15},className:`absolute top-full left-0 mt-1 z-20 border-2 border-rule bg-paper shadow-pixel-sm min-w-[140px]`,children:[(0,S.jsx)(`button`,{onClick:()=>h(null),className:`block w-full text-left font-mono text-[10px] px-3 py-2 hover:bg-paper-dark transition-colors cursor-pointer`,children:e===`es`?`Todas`:`All`}),Un.map(e=>(0,S.jsx)(`button`,{onClick:()=>h(e),className:`block w-full text-left font-mono text-[10px] px-3 py-2 hover:bg-paper-dark transition-colors cursor-pointer ${t.category===e?`bg-ink text-paper`:``}`,children:e},e))]})})]}),(0,S.jsxs)(`div`,{className:`relative`,children:[(0,S.jsx)(`button`,{onClick:()=>{d(!c),s(!1)},className:`skill-tag text-[10px] flex items-center gap-1 cursor-pointer`,children:t.dateRange?`${t.dateRange.start} – ${t.dateRange.end}`:e===`es`?`Fechas`:`Dates`}),(0,S.jsx)(a,{children:c&&(0,S.jsxs)(u.div,{initial:{opacity:0,y:-4},animate:{opacity:1,y:0},exit:{opacity:0,y:-4},transition:{duration:.15},className:`absolute top-full left-0 mt-1 z-20 border-2 border-rule bg-paper shadow-pixel-sm p-3 flex flex-col gap-2`,children:[(0,S.jsx)(`label`,{className:`font-mono text-[9px] uppercase tracking-wider text-ink-muted`,children:e===`es`?`Desde`:`From`}),(0,S.jsx)(`input`,{type:`date`,value:t.dateRange?.start??``,onChange:e=>g(e.target.value),className:`border-2 border-rule bg-paper-dark font-mono text-[10px] px-2 py-1`}),(0,S.jsx)(`label`,{className:`font-mono text-[9px] uppercase tracking-wider text-ink-muted`,children:e===`es`?`Hasta`:`To`}),(0,S.jsx)(`input`,{type:`date`,value:t.dateRange?.end??``,onChange:e=>_(e.target.value),className:`border-2 border-rule bg-paper-dark font-mono text-[10px] px-2 py-1`}),t.dateRange&&(0,S.jsx)(`button`,{onClick:y,className:`font-mono text-[9px] text-accent hover:text-accent-dark underline mt-1 cursor-pointer`,children:e===`es`?`Limpiar`:`Clear`})]})})]})]})]})}var Gn=`ENTRIES`,Kn=`KEYS`,qn=`VALUES`,Q=``,Jn=class{constructor(e,t){let n=e._tree,r=Array.from(n.keys());this.set=e,this._type=t,this._path=r.length>0?[{node:n,keys:r}]:[]}next(){let e=this.dive();return this.backtrack(),e}dive(){if(this._path.length===0)return{done:!0,value:void 0};let{node:e,keys:t}=$(this._path);if($(t)===Q)return{done:!1,value:this.result()};let n=e.get($(t));return this._path.push({node:n,keys:Array.from(n.keys())}),this.dive()}backtrack(){if(this._path.length===0)return;let e=$(this._path).keys;e.pop(),!(e.length>0)&&(this._path.pop(),this.backtrack())}key(){return this.set._prefix+this._path.map(({keys:e})=>$(e)).filter(e=>e!==Q).join(``)}value(){return $(this._path).node.get(Q)}result(){switch(this._type){case qn:return this.value();case Kn:return this.key();default:return[this.key(),this.value()]}}[Symbol.iterator](){return this}},$=e=>e[e.length-1],Yn=(e,t,n)=>{let r=new Map;if(t===void 0)return r;let i=t.length+1,a=i+n,o=new Uint8Array(a*i).fill(n+1);for(let e=0;e<i;++e)o[e]=e;for(let e=1;e<a;++e)o[e*i]=e;return Xn(e,t,n,r,o,1,i,``),r},Xn=(e,t,n,r,i,a,o,s)=>{let c=a*o;key:for(let l of e.keys())if(l===Q){let t=i[c-1];t<=n&&r.set(s,[e.get(l),t])}else{let c=a;for(let e=0;e<l.length;++e,++c){let r=l[e],a=o*c,s=a-o,u=i[a],d=Math.max(0,c-n-1),f=Math.min(o-1,c+n);for(let e=d;e<f;++e){let n=r!==t[e],o=i[s+e]+ +n,c=i[s+e+1]+1,l=i[a+e]+1,d=i[a+e+1]=Math.min(o,c,l);d<u&&(u=d)}if(u>n)continue key}Xn(e.get(l),t,n,r,i,c,o,s+l)}},Zn=class e{constructor(e=new Map,t=``){this._size=void 0,this._tree=e,this._prefix=t}atPrefix(t){if(!t.startsWith(this._prefix))throw Error(`Mismatched prefix`);let[n,r]=Qn(this._tree,t.slice(this._prefix.length));if(n===void 0){let[n,i]=ir(r);for(let r of n.keys())if(r!==Q&&r.startsWith(i)){let a=new Map;return a.set(r.slice(i.length),n.get(r)),new e(a,t)}}return new e(n,t)}clear(){this._size=void 0,this._tree.clear()}delete(e){return this._size=void 0,tr(this._tree,e)}entries(){return new Jn(this,Gn)}forEach(e){for(let[t,n]of this)e(t,n,this)}fuzzyGet(e,t){return Yn(this._tree,e,t)}get(e){let t=$n(this._tree,e);return t===void 0?void 0:t.get(Q)}has(e){let t=$n(this._tree,e);return t!==void 0&&t.has(Q)}keys(){return new Jn(this,Kn)}set(e,t){if(typeof e!=`string`)throw Error(`key must be a string`);return this._size=void 0,er(this._tree,e).set(Q,t),this}get size(){if(this._size)return this._size;this._size=0;let e=this.entries();for(;!e.next().done;)this._size+=1;return this._size}update(e,t){if(typeof e!=`string`)throw Error(`key must be a string`);this._size=void 0;let n=er(this._tree,e);return n.set(Q,t(n.get(Q))),this}fetch(e,t){if(typeof e!=`string`)throw Error(`key must be a string`);this._size=void 0;let n=er(this._tree,e),r=n.get(Q);return r===void 0&&n.set(Q,r=t()),r}values(){return new Jn(this,qn)}[Symbol.iterator](){return this.entries()}static from(t){let n=new e;for(let[e,r]of t)n.set(e,r);return n}static fromObject(t){return e.from(Object.entries(t))}},Qn=(e,t,n=[])=>{if(t.length===0||e==null)return[e,n];for(let r of e.keys())if(r!==Q&&t.startsWith(r))return n.push([e,r]),Qn(e.get(r),t.slice(r.length),n);return n.push([e,t]),Qn(void 0,``,n)},$n=(e,t)=>{if(t.length===0||e==null)return e;for(let n of e.keys())if(n!==Q&&t.startsWith(n))return $n(e.get(n),t.slice(n.length))},er=(e,t)=>{let n=t.length;outer:for(let r=0;e&&r<n;){for(let i of e.keys())if(i!==Q&&t[r]===i[0]){let a=Math.min(n-r,i.length),o=1;for(;o<a&&t[r+o]===i[o];)++o;let s=e.get(i);if(o===i.length)e=s;else{let n=new Map;n.set(i.slice(o),s),e.set(t.slice(r,r+o),n),e.delete(i),e=n}r+=o;continue outer}let i=new Map;return e.set(t.slice(r),i),i}return e},tr=(e,t)=>{let[n,r]=Qn(e,t);if(n!==void 0){if(n.delete(Q),n.size===0)nr(r);else if(n.size===1){let[e,t]=n.entries().next().value;rr(r,e,t)}}},nr=e=>{if(e.length===0)return;let[t,n]=ir(e);if(t.delete(n),t.size===0)nr(e.slice(0,-1));else if(t.size===1){let[n,r]=t.entries().next().value;n!==Q&&rr(e.slice(0,-1),n,r)}},rr=(e,t,n)=>{if(e.length===0)return;let[r,i]=ir(e);r.set(i+t,n),r.delete(i)},ir=e=>e[e.length-1],ar=`or`,or=`and`,sr=`and_not`,cr=class e{constructor(e){if(e?.fields==null)throw Error(`MiniSearch: option "fields" must be provided`);let t=e.autoVacuum==null||e.autoVacuum===!0?yr:e.autoVacuum;this._options={...mr,...e,autoVacuum:t,searchOptions:{...hr,...e.searchOptions||{}},autoSuggestOptions:{...gr,...e.autoSuggestOptions||{}}},this._index=new Zn,this._documentCount=0,this._documentIds=new Map,this._idToShortId=new Map,this._fieldIds={},this._fieldLength=new Map,this._avgFieldLength=[],this._nextId=0,this._storedFields=new Map,this._dirtCount=0,this._currentVacuum=null,this._enqueuedVacuum=null,this._enqueuedVacuumConditions=vr,this.addFields(this._options.fields)}add(e){let{extractField:t,stringifyField:n,tokenize:r,processTerm:i,fields:a,idField:o}=this._options,s=t(e,o);if(s==null)throw Error(`MiniSearch: document does not have ID field "${o}"`);if(this._idToShortId.has(s))throw Error(`MiniSearch: duplicate ID ${s}`);let c=this.addDocumentId(s);this.saveStoredFields(c,e);for(let o of a){let a=t(e,o);if(a==null)continue;let s=r(n(a,o),o),l=this._fieldIds[o],u=new Set(s).size;this.addFieldLength(c,l,this._documentCount-1,u);for(let e of s){let t=i(e,o);if(Array.isArray(t))for(let e of t)this.addTerm(l,c,e);else t&&this.addTerm(l,c,t)}}}addAll(e){for(let t of e)this.add(t)}addAllAsync(e,t={}){let{chunkSize:n=10}=t,r={chunk:[],promise:Promise.resolve()},{chunk:i,promise:a}=e.reduce(({chunk:e,promise:t},r,i)=>(e.push(r),(i+1)%n===0?{chunk:[],promise:t.then(()=>new Promise(e=>setTimeout(e,0))).then(()=>this.addAll(e))}:{chunk:e,promise:t}),r);return a.then(()=>this.addAll(i))}remove(e){let{tokenize:t,processTerm:n,extractField:r,stringifyField:i,fields:a,idField:o}=this._options,s=r(e,o);if(s==null)throw Error(`MiniSearch: document does not have ID field "${o}"`);let c=this._idToShortId.get(s);if(c==null)throw Error(`MiniSearch: cannot remove document with ID ${s}: it is not in the index`);for(let o of a){let a=r(e,o);if(a==null)continue;let s=t(i(a,o),o),l=this._fieldIds[o],u=new Set(s).size;this.removeFieldLength(c,l,this._documentCount,u);for(let e of s){let t=n(e,o);if(Array.isArray(t))for(let e of t)this.removeTerm(l,c,e);else t&&this.removeTerm(l,c,t)}}this._storedFields.delete(c),this._documentIds.delete(c),this._idToShortId.delete(s),this._fieldLength.delete(c),--this._documentCount}removeAll(e){if(e)for(let t of e)this.remove(t);else if(arguments.length>0)throw Error(`Expected documents to be present. Omit the argument to remove all documents.`);else this._index=new Zn,this._documentCount=0,this._documentIds=new Map,this._idToShortId=new Map,this._fieldLength=new Map,this._avgFieldLength=[],this._storedFields=new Map,this._nextId=0}discard(e){let t=this._idToShortId.get(e);if(t==null)throw Error(`MiniSearch: cannot discard document with ID ${e}: it is not in the index`);this._idToShortId.delete(e),this._documentIds.delete(t),this._storedFields.delete(t),(this._fieldLength.get(t)||[]).forEach((e,n)=>{this.removeFieldLength(t,n,this._documentCount,e)}),this._fieldLength.delete(t),--this._documentCount,this._dirtCount+=1,this.maybeAutoVacuum()}maybeAutoVacuum(){if(this._options.autoVacuum===!1)return;let{minDirtFactor:e,minDirtCount:t,batchSize:n,batchWait:r}=this._options.autoVacuum;this.conditionalVacuum({batchSize:n,batchWait:r},{minDirtCount:t,minDirtFactor:e})}discardAll(e){let t=this._options.autoVacuum;try{this._options.autoVacuum=!1;for(let t of e)this.discard(t)}finally{this._options.autoVacuum=t}this.maybeAutoVacuum()}replace(e){let{idField:t,extractField:n}=this._options,r=n(e,t);this.discard(r),this.add(e)}vacuum(e={}){return this.conditionalVacuum(e)}conditionalVacuum(e,t){return this._currentVacuum?(this._enqueuedVacuumConditions=this._enqueuedVacuumConditions&&t,this._enqueuedVacuum??=this._currentVacuum.then(()=>{let t=this._enqueuedVacuumConditions;return this._enqueuedVacuumConditions=vr,this.performVacuuming(e,t)}),this._enqueuedVacuum):this.vacuumConditionsMet(t)===!1?Promise.resolve():(this._currentVacuum=this.performVacuuming(e),this._currentVacuum)}async performVacuuming(e,t){let n=this._dirtCount;if(this.vacuumConditionsMet(t)){let t=e.batchSize||_r.batchSize,r=e.batchWait||_r.batchWait,i=1;for(let[e,n]of this._index){for(let[e,t]of n)for(let[r]of t)this._documentIds.has(r)||(t.size<=1?n.delete(e):t.delete(r));this._index.get(e).size===0&&this._index.delete(e),i%t===0&&await new Promise(e=>setTimeout(e,r)),i+=1}this._dirtCount-=n}await null,this._currentVacuum=this._enqueuedVacuum,this._enqueuedVacuum=null}vacuumConditionsMet(e){if(e==null)return!0;let{minDirtCount:t,minDirtFactor:n}=e;return t||=yr.minDirtCount,n||=yr.minDirtFactor,this.dirtCount>=t&&this.dirtFactor>=n}get isVacuuming(){return this._currentVacuum!=null}get dirtCount(){return this._dirtCount}get dirtFactor(){return this._dirtCount/(1+this._documentCount+this._dirtCount)}has(e){return this._idToShortId.has(e)}getStoredFields(e){let t=this._idToShortId.get(e);if(t!=null)return this._storedFields.get(t)}search(t,n={}){let{searchOptions:r}=this._options,i={...r,...n},a=this.executeQuery(t,n),o=[];for(let[e,{score:t,terms:n,match:r}]of a){let a=n.length||1,s={id:this._documentIds.get(e),score:t*a,terms:Object.keys(r),queryTerms:n,match:r};Object.assign(s,this._storedFields.get(e)),(i.filter==null||i.filter(s))&&o.push(s)}return t===e.wildcard&&i.boostDocument==null||o.sort(Sr),o}autoSuggest(e,t={}){t={...this._options.autoSuggestOptions,...t};let n=new Map;for(let{score:r,terms:i}of this.search(e,t)){let e=i.join(` `),t=n.get(e);t==null?n.set(e,{score:r,terms:i,count:1}):(t.score+=r,t.count+=1)}let r=[];for(let[e,{score:t,terms:i,count:a}]of n)r.push({suggestion:e,terms:i,score:t/a});return r.sort(Sr),r}get documentCount(){return this._documentCount}get termCount(){return this._index.size}static loadJSON(e,t){if(t==null)throw Error(`MiniSearch: loadJSON should be given the same options used when serializing the index`);return this.loadJS(JSON.parse(e),t)}static async loadJSONAsync(e,t){if(t==null)throw Error(`MiniSearch: loadJSON should be given the same options used when serializing the index`);return this.loadJSAsync(JSON.parse(e),t)}static getDefault(e){if(mr.hasOwnProperty(e))return lr(mr,e);throw Error(`MiniSearch: unknown option "${e}"`)}static loadJS(e,t){let{index:n,documentIds:r,fieldLength:i,storedFields:a,serializationVersion:o}=e,s=this.instantiateMiniSearch(e,t);s._documentIds=wr(r),s._fieldLength=wr(i),s._storedFields=wr(a);for(let[e,t]of s._documentIds)s._idToShortId.set(t,e);for(let[e,t]of n){let n=new Map;for(let e of Object.keys(t)){let r=t[e];o===1&&(r=r.ds),n.set(parseInt(e,10),wr(r))}s._index.set(e,n)}return s}static async loadJSAsync(e,t){let{index:n,documentIds:r,fieldLength:i,storedFields:a,serializationVersion:o}=e,s=this.instantiateMiniSearch(e,t);s._documentIds=await Tr(r),s._fieldLength=await Tr(i),s._storedFields=await Tr(a);for(let[e,t]of s._documentIds)s._idToShortId.set(t,e);let c=0;for(let[e,t]of n){let n=new Map;for(let e of Object.keys(t)){let r=t[e];o===1&&(r=r.ds),n.set(parseInt(e,10),await Tr(r))}++c%1e3==0&&await Er(0),s._index.set(e,n)}return s}static instantiateMiniSearch(t,n){let{documentCount:r,nextId:i,fieldIds:a,averageFieldLength:o,dirtCount:s,serializationVersion:c}=t;if(c!==1&&c!==2)throw Error(`MiniSearch: cannot deserialize an index created with an incompatible version`);let l=new e(n);return l._documentCount=r,l._nextId=i,l._idToShortId=new Map,l._fieldIds=a,l._avgFieldLength=o,l._dirtCount=s||0,l._index=new Zn,l}executeQuery(t,n={}){if(t===e.wildcard)return this.executeWildcardQuery(n);if(typeof t!=`string`){let e={...n,...t,queries:void 0},r=t.queries.map(t=>this.executeQuery(t,e));return this.combineResults(r,e.combineWith)}let{tokenize:r,processTerm:i,searchOptions:a}=this._options,o={tokenize:r,processTerm:i,...a,...n},{tokenize:s,processTerm:c}=o,l=s(t).flatMap(e=>c(e)).filter(e=>!!e).map(pr(o)).map(e=>this.executeQuerySpec(e,o));return this.combineResults(l,o.combineWith)}executeQuerySpec(e,t){let n={...this._options.searchOptions,...t},r=(n.fields||this._options.fields).reduce((e,t)=>({...e,[t]:lr(n.boost,t)||1}),{}),{boostDocument:i,weights:a,maxFuzzy:o,bm25:s}=n,{fuzzy:c,prefix:l}={...hr.weights,...a},u=this._index.get(e.term),d=this.termResults(e.term,e.term,1,e.termBoost,u,r,i,s),f,p;if(e.prefix&&(f=this._index.atPrefix(e.term)),e.fuzzy){let t=e.fuzzy===!0?.2:e.fuzzy,n=t<1?Math.min(o,Math.round(e.term.length*t)):t;n&&(p=this._index.fuzzyGet(e.term,n))}if(f)for(let[t,n]of f){let a=t.length-e.term.length;if(!a)continue;p?.delete(t);let o=l*t.length/(t.length+.3*a);this.termResults(e.term,t,o,e.termBoost,n,r,i,s,d)}if(p)for(let t of p.keys()){let[n,a]=p.get(t);if(!a)continue;let o=c*t.length/(t.length+a);this.termResults(e.term,t,o,e.termBoost,n,r,i,s,d)}return d}executeWildcardQuery(e){let t=new Map,n={...this._options.searchOptions,...e};for(let[e,r]of this._documentIds){let i=n.boostDocument?n.boostDocument(r,``,this._storedFields.get(e)):1;t.set(e,{score:i,terms:[],match:{}})}return t}combineResults(e,t=ar){if(e.length===0)return new Map;let n=ur[t.toLowerCase()];if(!n)throw Error(`Invalid combination operator: ${t}`);return e.reduce(n)||new Map}toJSON(){let e=[];for(let[t,n]of this._index){let r={};for(let[e,t]of n)r[e]=Object.fromEntries(t);e.push([t,r])}return{documentCount:this._documentCount,nextId:this._nextId,documentIds:Object.fromEntries(this._documentIds),fieldIds:this._fieldIds,fieldLength:Object.fromEntries(this._fieldLength),averageFieldLength:this._avgFieldLength,storedFields:Object.fromEntries(this._storedFields),dirtCount:this._dirtCount,index:e,serializationVersion:2}}termResults(e,t,n,r,i,a,o,s,c=new Map){if(i==null)return c;for(let l of Object.keys(a)){let u=a[l],d=this._fieldIds[l],f=i.get(d);if(f==null)continue;let p=f.size,m=this._avgFieldLength[d];for(let i of f.keys()){if(!this._documentIds.has(i)){this.removeTerm(d,i,t),--p;continue}let a=o?o(this._documentIds.get(i),t,this._storedFields.get(i)):1;if(!a)continue;let h=f.get(i),g=this._fieldLength.get(i)[d],_=fr(h,p,this._documentCount,g,m,s),v=n*r*u*a*_,y=c.get(i);if(y){y.score+=v,br(y.terms,e);let n=lr(y.match,t);n?n.push(l):y.match[t]=[l]}else c.set(i,{score:v,terms:[e],match:{[t]:[l]}})}}return c}addTerm(e,t,n){let r=this._index.fetch(n,Cr),i=r.get(e);if(i==null)i=new Map,i.set(t,1),r.set(e,i);else{let e=i.get(t);i.set(t,(e||0)+1)}}removeTerm(e,t,n){if(!this._index.has(n)){this.warnDocumentChanged(t,e,n);return}let r=this._index.fetch(n,Cr),i=r.get(e);i==null||i.get(t)==null?this.warnDocumentChanged(t,e,n):i.get(t)<=1?i.size<=1?r.delete(e):i.delete(t):i.set(t,i.get(t)-1),this._index.get(n).size===0&&this._index.delete(n)}warnDocumentChanged(e,t,n){for(let r of Object.keys(this._fieldIds))if(this._fieldIds[r]===t){this._options.logger(`warn`,`MiniSearch: document with ID ${this._documentIds.get(e)} has changed before removal: term "${n}" was not present in field "${r}". Removing a document after it has changed can corrupt the index!`,`version_conflict`);return}}addDocumentId(e){let t=this._nextId;return this._idToShortId.set(e,t),this._documentIds.set(t,e),this._documentCount+=1,this._nextId+=1,t}addFields(e){for(let t=0;t<e.length;t++)this._fieldIds[e[t]]=t}addFieldLength(e,t,n,r){let i=this._fieldLength.get(e);i??this._fieldLength.set(e,i=[]),i[t]=r;let a=(this._avgFieldLength[t]||0)*n+r;this._avgFieldLength[t]=a/(n+1)}removeFieldLength(e,t,n,r){if(n===1){this._avgFieldLength[t]=0;return}let i=this._avgFieldLength[t]*n-r;this._avgFieldLength[t]=i/(n-1)}saveStoredFields(e,t){let{storeFields:n,extractField:r}=this._options;if(n==null||n.length===0)return;let i=this._storedFields.get(e);i??this._storedFields.set(e,i={});for(let e of n){let n=r(t,e);n!==void 0&&(i[e]=n)}}};cr.wildcard=Symbol(`*`);var lr=(e,t)=>Object.prototype.hasOwnProperty.call(e,t)?e[t]:void 0,ur={[ar]:(e,t)=>{for(let n of t.keys()){let r=e.get(n);if(r==null)e.set(n,t.get(n));else{let{score:e,terms:i,match:a}=t.get(n);r.score+=e,r.match=Object.assign(r.match,a),xr(r.terms,i)}}return e},[or]:(e,t)=>{let n=new Map;for(let r of t.keys()){let i=e.get(r);if(i==null)continue;let{score:a,terms:o,match:s}=t.get(r);xr(i.terms,o),n.set(r,{score:i.score+a,terms:i.terms,match:Object.assign(i.match,s)})}return n},[sr]:(e,t)=>{for(let n of t.keys())e.delete(n);return e}},dr={k:1.2,b:.7,d:.5},fr=(e,t,n,r,i,a)=>{let{k:o,b:s,d:c}=a;return Math.log(1+(n-t+.5)/(t+.5))*(c+e*(o+1)/(e+o*(1-s+s*r/i)))},pr=e=>(t,n,r)=>({term:t,fuzzy:typeof e.fuzzy==`function`?e.fuzzy(t,n,r):e.fuzzy||!1,prefix:typeof e.prefix==`function`?e.prefix(t,n,r):e.prefix===!0,termBoost:typeof e.boostTerm==`function`?e.boostTerm(t,n,r):1}),mr={idField:`id`,extractField:(e,t)=>e[t],stringifyField:(e,t)=>e.toString(),tokenize:e=>e.split(Dr),processTerm:e=>e.toLowerCase(),fields:void 0,searchOptions:void 0,storeFields:[],logger:(e,t)=>{typeof(console==null?void 0:console[e])==`function`&&console[e](t)},autoVacuum:!0},hr={combineWith:ar,prefix:!1,fuzzy:!1,maxFuzzy:6,boost:{},weights:{fuzzy:.45,prefix:.375},bm25:dr},gr={combineWith:or,prefix:(e,t,n)=>t===n.length-1},_r={batchSize:1e3,batchWait:10},vr={minDirtFactor:.1,minDirtCount:20},yr={..._r,...vr},br=(e,t)=>{e.includes(t)||e.push(t)},xr=(e,t)=>{for(let n of t)e.includes(n)||e.push(n)},Sr=({score:e},{score:t})=>t-e,Cr=()=>new Map,wr=e=>{let t=new Map;for(let n of Object.keys(e))t.set(parseInt(n,10),e[n]);return t},Tr=async e=>{let t=new Map,n=0;for(let r of Object.keys(e))t.set(parseInt(r,10),e[r]),++n%1e3==0&&await Er(0);return t},Er=e=>new Promise(t=>setTimeout(t,e)),Dr=/[\n\r\p{Z}\p{P}]+/u;function Or(e){return e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`)}function kr(e,t){if(!t.trim())return[e];let n=Or(t);return e.split(RegExp(`(${n})`,`gi`)).map((e,n)=>e.toLowerCase()===t.toLowerCase()?(0,S.jsx)(`mark`,{className:`bg-accent/20 text-ink font-bold px-0.5 rounded-none`,children:e},n):e)}function Ar(e,t){let[n,r]=(0,v.useState)(e);return(0,v.useEffect)(()=>{let n=setTimeout(()=>r(e),t);return()=>clearTimeout(n)},[e,t]),n}function jr({defaultQuery:e=``}){let{lang:t}=l(),{posts:n}=E(),[r,o]=(0,v.useState)(e),[s,c]=(0,v.useState)([]),[d,f]=(0,v.useState)(!1),p=(0,v.useRef)(null),m=(0,v.useRef)(null);(0,v.useEffect)(()=>{e&&o(e)},[e]);let h=Ar(r,200);(0,v.useEffect)(()=>{let e=new cr({fields:[`title`,`titleEn`,`tags`,`excerpt`,`excerptEn`],storeFields:[`id`,`slug`,`title`,`titleEn`,`excerpt`,`excerptEn`,`tags`,`date`,`readingTime`],searchOptions:{boost:{title:3,titleEn:3,tags:2,excerpt:1,excerptEn:1},fuzzy:.2,prefix:!0}});return e.addAll(n),p.current=e,f(!0),()=>{p.current=null}},[n]),(0,v.useEffect)(()=>{if(!h.trim()||!p.current){c([]);return}c(p.current.search(h).map(e=>n.find(t=>t.id===e.id)).filter(e=>e!==void 0))},[h,n]);let _=(0,v.useCallback)(()=>{o(``),c([]),m.current?.focus()},[]),y=(0,v.useCallback)(e=>{window.location.hash=`#blog/article/${e.slug}`,o(``),c([])},[]),b=r.trim().length>0,x=s.length>0;return(0,S.jsxs)(`div`,{className:`mb-8`,children:[(0,S.jsxs)(`div`,{className:`relative`,children:[(0,S.jsx)(g,{size:14,className:`absolute left-3 top-1/2 -translate-y-1/2 text-ink-muted pointer-events-none`}),(0,S.jsx)(`input`,{ref:m,type:`text`,value:r,onChange:e=>o(e.target.value),placeholder:t===`es`?`Buscar artículos…`:`Search articles…`,className:`w-full border-2 border-rule bg-paper px-9 py-2.5 font-mono text-xs text-ink placeholder:text-ink-muted outline-none focus:bg-paper-dark transition-colors`,"aria-label":t===`es`?`Buscar artículos`:`Search articles`}),b&&(0,S.jsx)(`button`,{onClick:_,className:`absolute right-3 top-1/2 -translate-y-1/2 text-ink-muted hover:text-accent transition-colors cursor-pointer`,"aria-label":`Clear search`,children:(0,S.jsx)(i,{size:14})})]}),(0,S.jsx)(a,{children:b&&(0,S.jsx)(u.div,{initial:{opacity:0,y:-8},animate:{opacity:1,y:0},exit:{opacity:0,y:-8},transition:{duration:.15},className:`border-x-2 border-b-2 border-rule bg-paper shadow-pixel-sm mt-0`,children:d?x?(0,S.jsx)(`ul`,{className:`divide-y divide-rule-light`,children:s.map(e=>{let n=t===`es`?e.title:e.titleEn,r=t===`es`?e.excerpt:e.excerptEn;return(0,S.jsx)(`li`,{children:(0,S.jsxs)(`button`,{onClick:()=>y(e),className:`w-full text-left px-4 py-3 hover:bg-paper-dark transition-colors cursor-pointer`,children:[(0,S.jsx)(`h4`,{className:`font-headline text-sm font-bold text-ink leading-tight mb-1`,children:kr(n,h)}),(0,S.jsx)(`p`,{className:`font-sans text-[11px] text-ink-light leading-relaxed line-clamp-2`,children:kr(r,h)}),(0,S.jsxs)(`div`,{className:`flex items-center gap-2 mt-1.5`,children:[(0,S.jsx)(`span`,{className:`font-mono text-[9px] text-ink-muted`,children:e.date}),(0,S.jsxs)(`span`,{className:`font-mono text-[9px] text-ink-muted`,children:[e.readingTime,` min`]})]})]})},e.id)})}):(0,S.jsx)(`div`,{className:`p-4`,children:(0,S.jsx)(k,{context:`search`,searchQuery:h})}):(0,S.jsx)(`div`,{className:`p-4 text-center`,children:(0,S.jsx)(`p`,{className:`font-mono text-[10px] text-ink-muted`,children:t===`es`?`Indexando…`:`Indexing…`})})})})]})}function Mr(){let{t:e}=l(),t=O(),{posts:n,selectedPost:r,setSelectedPost:i,setFilter:o}=E(),s=t.currentRoute===`article`&&t.selectedSlug?n.find(e=>e.slug===t.selectedSlug)??null:null;(0,v.useLayoutEffect)(()=>{t.currentRoute===`tag`&&t.currentParams.tag?o({tags:[t.currentParams.tag],category:null,dateRange:null}):(t.currentRoute===`list`||t.currentRoute===`search`)&&o({tags:[],category:null,dateRange:null}),t.currentRoute!==`article`&&i(null)},[t.currentRoute,t.selectedSlug,t.currentParams.tag]),(0,v.useLayoutEffect)(()=>{s&&s!==r&&i(s)},[s]);let c=t.currentRoute===`article`?`article-${t.selectedSlug}`:t.currentRoute;return(0,S.jsxs)(`section`,{id:`blog`,className:`py-20 px-6 max-w-7xl mx-auto`,children:[(0,S.jsx)(`div`,{className:`mb-10`,children:(0,S.jsx)(d,{section:`blog`,title:e(`blog.title`),subtitle:e(`blog.subtitle`)})}),(0,S.jsx)(a,{mode:`sync`,children:(0,S.jsx)(u.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},exit:{opacity:0,y:-10},transition:{duration:.2},children:t.currentRoute===`article`?r||s?(0,S.jsx)(Vn,{}):null:(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(Wn,{}),(0,S.jsx)(jr,{defaultQuery:t.currentRoute===`search`?t.currentParams.q??``:``}),(0,S.jsx)(I,{})]})},c)})]})}function Nr(){return(0,S.jsx)(T,{children:(0,S.jsx)(Mr,{})})}export{Nr as BlogRoot};