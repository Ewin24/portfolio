...
If you are designing a validation system with human fallback, assume the bot will fail. Design for failure. And the way to design for failure is to have plan B as first-class code, not as a \`catch\` branch.`,relatedIds:[`clean-architecture-los`,`catalog-driven-decision-engine`,`domain-exception-problemdetails-pipeline`]}].map(e=>({...e,readingTime:S(e.content)}));C.filter(e=>e.featured);function w(e,t){return e.filter(e=>{if(t.tags.length>0&&!t.tags.every(t=>e.tags.includes(t))||t.category&&e.category!==t.category)return!1;if(t.dateRange){let n=new Date(e.date),r=new Date(t.dateRange.start),i=new Date(t.dateRange.end);if(n<r||n>i)return!1}return!0})}var T=i(),E={tags:[],category:null,dateRange:null},D=(0,x.createContext)(null);function O({children:e}){let[t,n]=(0,x.useState)(E),[r,i]=(0,x.useState)(``),[a,o]=(0,x.useState)(null),[s,c]=(0,x.useState)(`list`),[l,u]=(0,x.useState)(1),d=(0,x.useCallback)(()=>{n(E),i(``),u(1)},[]),f={posts:C,filteredPosts:(0,x.useMemo)(()=>w([...C].sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime()),t),[t]),selectedPost:a,filter:t,searchQuery:r,currentRoute:s,page:l,setFilter:n,setSearchQuery:i,setSelectedPost:o,setCurrentRoute:c,setPage:u,clearFilters:d};return(0,T.jsx)(D.Provider,{value:f,children:e})}function k(){let e=(0,x.useContext)(D);if(!e)throw Error(`useBlogContext must be used within BlogProvider`);return e}function A(){let e=window.location.hash.slice(1);if(e===`blog/list`||e===`blog`||e===``)return{currentRoute:`list`,selectedSlug:null,currentParams:{}};let t=e.match(/^blog\/article\/(.+)$/);if(t)return{currentRoute:`article`,selectedSlug:t[1],currentParams:{}};let n=e.match(/^blog\/tag\/(.+)$/);if(n)return{currentRoute:`tag`,selectedSlug:n[1],currentParams:{tag:n[1]}};let r=e.match(/^blog\/search\?(.+)$/);if(r){let e=Object.fromEntries(new URLSearchParams(r[1]));return{currentRoute:`search`,selectedSlug:e.q??null,currentParams:e}}return{currentRoute:`list`,selectedSlug:null,currentParams:{}}}function ee(){let[e,t]=(0,x.useState)(A);(0,x.useEffect)(()=>{let e=()=>t(A());return window.addEventListener(`hashchange`,e),window.addEventListener(`popstate`,e),()=>{window.removeEventListener(`hashchange`,e),window.removeEventListener(`popstate`,e)}},[]);let n=(0,x.useCallback)(e=>{window.location.hash=e},[]);return{...e,navigate:n}}function j({context:e,searchQuery:t=``}){let{lang:n}=a(),{title:r,description:i}={filters:{title:n===`es`?`Sin resultados`:`No results`,description:n===`es`?`No hay artículos que coincidan con los filtros seleccionados. Probá ajustando los criterios.`:`No posts match your current filters. Try adjusting your criteria.`},search:{title:n===`es`?`Sin resultados para "${t}"`:`No results for "${t}"`,description:n===`es`?`No encontramos artículos con ese término. Probá con otras palabras.`:`We couldn't find posts matching that term. Try different keywords.`},none:{title:n===`es`?`Próximamente`:`Coming soon`,description:n===`es`?`Todavía no hay artículos publicados. Volvé pronto.`:`No articles published yet. Check back soon.`}}[e];return(0,T.jsx)(l,{children:(0,T.jsx)(`div`,{className:`border-2 border-rule bg-paper-dark p-8 md:p-12 text-center`,children:(0,T.jsxs)(`div`,{className:`max-w-md mx-auto`,children:[(0,T.jsx)(`h3`,{className:`font-headline text-xl md:text-2xl font-bold text-ink mb-3`,children:r}),(0,T.jsx)(`p`,{className:`font-sans text-sm text-ink-light leading-relaxed`,children:i})]})})})}var M=6;function te({post:e,index:t,onRead:n}){let{lang:i}=a(),{theme:s,stillness:c}=r(),u=o(),f=s===`book`,p=!!u||c,m=i===`es`?e.title:e.titleEn,g=i===`es`?e.excerpt:e.excerptEn;return(0,T.jsx)(l,{delay:t*.08,children:(0,T.jsx)(`article`,{className:`border-2 border-rule bg-paper shadow-pixel-sm hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 active:shadow-none active:translate-x-0.5 active:translate-y-0.5 transition-all duration-75 flex flex-col h-full`,children:(0,T.jsxs)(`div`,{className:`p-5 flex-1 flex flex-col gap-3`,children:[(0,T.jsx)(`div`,{className:`flex flex-wrap gap-1`,children:e.tags.slice(0,3).map(e=>(0,T.jsxs)(`span`,{className:`skill-tag text-[9px] flex items-center gap-1`,children:[(0,T.jsx)(b,{size:7}),` `,e]},e))}),(0,T.jsx)(`h3`,{className:`font-headline text-lg font-bold text-ink leading-tight line-clamp-2`,children:(0,T.jsx)(d,{text:m,active:f,still:p,delay:t%6*110})}),(0,T.jsx)(`p`,{className:`font-sans text-xs text-ink-light leading-relaxed line-clamp-3 flex-1`,children:g}),(0,T.jsxs)(`div`,{className:`flex items-center justify-between pt-3 border-t border-rule-light mt-auto`,children:[(0,T.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,T.jsx)(`span`,{className:`font-mono text-[10px] text-ink-muted`,children:e.date}),(0,T.jsxs)(`span`,{className:`font-mono text-[10px] text-ink-muted flex items-center gap-1`,children:[(0,T.jsx)(v,{size:9}),` `,e.readingTime,` min`]})]}),(0,T.jsxs)(`button`,{onClick:n,className:`font-mono text-[10px] font-bold uppercase tracking-wider text-accent hover:text-accent-dark flex items-center gap-1 transition-colors cursor-pointer`,children:[i===`es`?`Leer`:`Read`,` `,(0,T.jsx)(h,{size:10})]})]})]})})})}function N(){let{lang:e}=a(),{filteredPosts:t,page:r,setPage:i}=k(),[o,s]=(0,x.useState)(!1),c=t.length,l=o?c:Math.min(r*M,c),u=l<c,d=()=>{i(r+1)},f=()=>{s(!0)},p=e=>{history.pushState(null,``,`#blog/article/${e.slug}`),window.dispatchEvent(new HashChangeEvent(`hashchange`))};return c===0?(0,T.jsx)(j,{context:`filters`}):(0,T.jsxs)(`div`,{children:[(0,T.jsx)(`div`,{className:`grid md:grid-cols-2 lg:grid-cols-3 gap-5`,children:t.slice(0,l).map((e,t)=>(0,T.jsx)(n.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.3,delay:t%M*.05},children:(0,T.jsx)(te,{post:e,index:t,onRead:()=>p(e)})},e.id))}),(0,T.jsxs)(`div`,{className:`flex justify-center gap-3 mt-8`,children:[u&&(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(`button`,{onClick:d,className:`px-btn`,children:e===`es`?`Cargar más`:`Load more`}),(0,T.jsx)(`button`,{onClick:f,className:`px-btn px-btn-outline`,children:e===`es`?`Mostrar todos`:`Show all`})]}),!u&&c>M&&(0,T.jsxs)(`p`,{className:`font-mono text-[10px] text-ink-muted`,children:[c,` `,e===`es`?`artículos`:`articles`]})]})]})}var P=document.createElement(`i`);function F(e){let t=`&`+e+`;`;P.innerHTML=t;let n=P.textContent;return n.charCodeAt(n.length-1)===59&&e!==`semi`||n===t?!1:n}function I(e,t,n,r){let i=e.length,a=0,o;if(t=t<0?-t>i?0:i+t:t>i?i:t,n=n>0?n:0,r.length<1e4)o=Array.from(r),o.unshift(t,n),e.splice(...o);else for(n&&e.splice(t,n);a<r.length;)o=r.slice(a,a+1e4),o.unshift(t,0),e.splice(...o),a+=1e4,t+=1e4}function L(e,t){return e.length>0?(I(e,e.length,0,t),e):t}var ne={}.hasOwnProperty;function re(e){let t={},n=-1;for(;++n<e.length;)ie(t,e[n]);return t}function ie(e,t){let n;for(n in t){let r=(ne.call(e,n)?e[n]:void 0)||(e[n]={}),i=t[n],a;if(i)for(a in i){ne.call(r,a)||(r[a]=[]);let e=i[a];ae(r[a],Array.isArray(e)?e:e?[e]:[])}}}function ae(e,t){let n=-1,r=[];for(;++n<t.length;)(t[n].add===`after`?e:r).push(t[n]);I(e,0,0,r)}function oe(e){let t={},n=-1;for(;++n<e.length;)se(t,e[n]);return t}function se(e,t){let n;for(n in t){let r=(ne.call(e,n)?e[n]:void 0)||(e[n]={}),i=t[n],a;if(i)for(a in i)r[a]=i[a]}}function ce(e,t){let n=Number.parseInt(e,t);return n<9||n===11||n>13&&n<32||n>126&&n<160||n>55295&&n<57344||n>64975&&n<65008||(n&65535)==65535||(n&65535)==65534||n>1114111?`�`:String.fromCodePoint(n)}var le={'"':`quot`,"&":`amp`,"<":`lt`,">":`gt`};function ue(e){return e.replace(/["&<>]/g,t);function t(e){return`&`+le[e]+`;`}}function de(e){return e.replace(/[\t\n\r ]+/g,` `).replace(/^ | $/g,``).toLowerCase().toUpperCase()}var R=W(/[A-Za-z]/),z=W(/[\dA-Za-z]/),fe=W(/[#-'*+\--9=?A-Z^-~]/);function pe(e){return e!==null&&(e<32||e===127)}var B=W(/\d/),me=W(/[\dA-Fa-f]/),he=W(/[!-/:-@[-`{-~]/);function V(e){return e!==null&&e<-2}function H(e){return e!==null&&(e<0||e===32)}function U(e){return e===-2||e===-1||e===32}var ge=W(/\p{P}|\p{S}/u),_e=W(/\s/);function W(e){return t;function t(t){return t!==null&&t>-1&&e.test(String.fromCharCode(t))}}function ve(e,t){let n=ue(ye(e||``));if(!t)return n;let r=n.indexOf(`:`),i=n.indexOf(`?`),a=n.indexOf(`#`),o=n.indexOf(`/`);return r<0||o>-1&&r>o||i>-1&&r>i||a>-1&&r>a||t.test(n.slice(0,r))?n:``}function ye(e){let t=[],n=-1,r=0,i=0;for(;++n<e.length;){let a=e.charCodeAt(n),o=``;if(a===37&&z(e.charCodeAt(n+1))&&z(e.charCodeAt(n+2)))i=2;else if(a<128)/[!#$&-;=?-Z_a-z~]/.test(String.fromCharCode(a))||(o=String.fromCharCode(a));else if(a>55295&&a<57344){let t=e.charCodeAt(n+1);a<56320&&t>56319&&t<57344?(o=String.fromCharCode(a,t),i=1):o=`�`}else o=String.fromCharCode(a);o&&=(t.push(e.slice(r,n),encodeURIComponent(o)),r=n+i+1,``),i&&=(n+=i,0)}return t.join(``)+e.slice(r)}var be={}.hasOwnProperty,xe=/^(https?|ircs?|mailto|xmpp)$/i,Se=/^https?$/i;function Ce(e){let t=e||{},n=!0,r={},i=[[]],a=[],o=[],s=oe([{enter:{blockQuote:A,codeFenced:te,codeFencedFenceInfo:h,codeFencedFenceMeta:h,codeIndented:I,codeText:Me,content:_e,definition:me,definitionDestinationString:V,definitionLabelString:h,definitionTitleString:h,emphasis:Ae,htmlFlow:ke,htmlText:J,image:re,label:h,link:ie,listItemMarker:E,listItemValue:T,listOrdered:C,listUnordered:w,paragraph:j,reference:h,resource:R,resourceDestinationString:z,resourceTitleString:h,setextHeading:ye,strong:je},exit:{atxHeading:G,atxHeadingSequence:W,autolinkEmail:ze,autolinkProtocol:Re,blockQuote:ee,characterEscapeValue:K,characterReferenceMarkerHexadecimal:Ie,characterReferenceMarkerNumeric:Ie,characterReferenceValue:Le,codeFenced:ne,codeFencedFence:P,codeFencedFenceInfo:N,codeFencedFenceMeta:S,codeFlowValue:De,codeIndented:ne,codeText:Ne,codeTextData:K,data:K,definition:ge,definitionDestinationString:H,definitionLabelString:he,definitionTitleString:U,emphasis:Pe,hardBreakEscape:Oe,hardBreakTrailing:Oe,htmlFlow:q,htmlFlowData:K,htmlText:q,htmlTextData:K,image:B,label:se,labelText:ae,lineEnding:Ee,link:B,listOrdered:D,listUnordered:O,paragraph:M,reference:S,referenceString:le,resource:S,resourceDestinationString:fe,resourceTitleString:pe,setextHeading:Te,setextHeadingLineSequence:we,setextHeadingText:Ce,strong:Y,thematicBreak:Fe}},...t.htmlExtensions||[]]),c={definitions:r,tightStack:o},l={buffer:h,encode:x,getData:m,lineEndingIfNeeded:b,options:t,raw:v,resume:g,setData:p,tag:_},u=t.defaultLineEnding;return d;function d(e){let t=-1,n=0,r=[],a=[],o=[];for(;++t<e.length;)!u&&(e[t][1].type===`lineEnding`||e[t][1].type===`lineEndingBlank`)&&(u=e[t][2].sliceSerialize(e[t][1])),(e[t][1].type===`listOrdered`||e[t][1].type===`listUnordered`)&&(e[t][0]===`enter`?r.push(t):f(e.slice(r.pop(),t))),e[t][1].type===`definition`&&(e[t][0]===`enter`?(o=L(o,e.slice(n,t)),n=t):(a=L(a,e.slice(n,t+1)),n=t+1));a=L(a,o),a=L(a,e.slice(n)),t=-1;let c=a;for(s.enter.null&&s.enter.null.call(l);++t<e.length;){let e=s[c[t][0]],n=c[t][1].type,r=e[n];be.call(e,n)&&r&&r.call({sliceSerialize:c[t][2].sliceSerialize,...l},c[t][1])}return s.exit.null&&s.exit.null.call(l),i[0].join(``)}function f(e){let t=e.length,n=0,r=0,i=!1,a;for(;++n<t;){let t=e[n];if(t[1]._container)a=void 0,t[0]===`enter`?r++:r--;else switch(t[1].type){case`listItemPrefix`:t[0]===`exit`&&(a=!0);break;case`linePrefix`:break;case`lineEndingBlank`:t[0]===`enter`&&!r&&(a?a=void 0:i=!0);break;default:a=void 0}}e[0][1]._loose=i}function p(e,t){c[e]=t}function m(e){return c[e]}function h(){i.push([])}function g(){return i.pop().join(``)}function _(e){n&&(p(`lastWasTag`,!0),i[i.length-1].push(e))}function v(e){p(`lastWasTag`),i[i.length-1].push(e)}function y(){v(u||`
`)}function b(){let e=i[i.length-1],t=e[e.length-1],n=t?t.charCodeAt(t.length-1):null;n===10||n===13||n===null||y()}function x(e){return m(`ignoreEncode`)?e:ue(e)}function S(){g()}function C(e){o.push(!e._loose),b(),_(`<ol`),p(`expectFirstItem`,!0)}function w(e){o.push(!e._loose),b(),_(`<ul`),p(`expectFirstItem`,!0)}function T(e){if(m(`expectFirstItem`)){let t=Number.parseInt(this.sliceSerialize(e),10);t!==1&&_(` start="`+x(String(t))+`"`)}}function E(){m(`expectFirstItem`)?_(`>`):k(),b(),_(`<li>`),p(`expectFirstItem`),p(`lastWasTag`)}function D(){k(),o.pop(),y(),_(`</ol>`)}function O(){k(),o.pop(),y(),_(`</ul>`)}function k(){m(`lastWasTag`)&&!m(`slurpAllLineEndings`)&&b(),_(`</li>`),p(`slurpAllLineEndings`)}function A(){o.push(!1),b(),_(`<blockquote>`)}function ee(){o.pop(),b(),_(`</blockquote>`),p(`slurpAllLineEndings`)}function j(){o[o.length-1]||(b(),_(`<p>`)),p(`slurpAllLineEndings`)}function M(){o[o.length-1]?p(`slurpAllLineEndings`,!0):_(`</p>`)}function te(){b(),_(`<pre><code`),p(`fencesCount`,0)}function N(){_(` class="language-`+g()+`"`)}function P(){let e=m(`fencesCount`)||0;e||(_(`>`),p(`slurpOneLineEnding`,!0)),p(`fencesCount`,e+1)}function I(){b(),_(`<pre><code>`)}function ne(){let e=m(`fencesCount`);e!==void 0&&e<2&&c.tightStack.length>0&&!m(`lastWasTag`)&&y(),m(`flowCodeSeenData`)&&b(),_(`</code></pre>`),e!==void 0&&e<2&&b(),p(`flowCodeSeenData`),p(`fencesCount`),p(`slurpOneLineEnding`)}function re(){a.push({image:!0}),n=void 0}function ie(){a.push({})}function ae(e){a[a.length-1].labelId=this.sliceSerialize(e)}function se(){a[a.length-1].label=g()}function le(e){a[a.length-1].referenceId=this.sliceSerialize(e)}function R(){h(),a[a.length-1].destination=``}function z(){h(),p(`ignoreEncode`,!0)}function fe(){a[a.length-1].destination=g(),p(`ignoreEncode`)}function pe(){a[a.length-1].title=g()}function B(){let e=a.length-1,i=a[e],o=i.referenceId||i.labelId,s=i.destination===void 0?r[de(o)]:i;for(n=!0;e--;)if(a[e].image){n=void 0;break}i.image?(_(`<img src="`+ve(s.destination,t.allowDangerousProtocol?void 0:Se)+`" alt="`),v(i.label),_(`"`)):_(`<a href="`+ve(s.destination,t.allowDangerousProtocol?void 0:xe)+`"`),_(s.title?` title="`+s.title+`"`:``),i.image?_(` />`):(_(`>`),v(i.label),_(`</a>`)),a.pop()}function me(){h(),a.push({})}function he(e){g(),a[a.length-1].labelId=this.sliceSerialize(e)}function V(){h(),p(`ignoreEncode`,!0)}function H(){a[a.length-1].destination=g(),p(`ignoreEncode`)}function U(){a[a.length-1].title=g()}function ge(){let e=a[a.length-1],t=de(e.labelId);g(),be.call(r,t)||(r[t]=a[a.length-1]),a.pop()}function _e(){p(`slurpAllLineEndings`,!0)}function W(e){m(`headingRank`)||(p(`headingRank`,this.sliceSerialize(e).length),b(),_(`<h`+m(`headingRank`)+`>`))}function ye(){h(),p(`slurpAllLineEndings`)}function Ce(){p(`slurpAllLineEndings`,!0)}function G(){_(`</h`+m(`headingRank`)+`>`),p(`headingRank`)}function we(e){p(`headingRank`,this.sliceSerialize(e).charCodeAt(0)===61?1:2)}function Te(){let e=g();b(),_(`<h`+m(`headingRank`)+`>`),v(e),_(`</h`+m(`headingRank`)+`>`),p(`slurpAllLineEndings`),p(`headingRank`)}function K(e){v(x(this.sliceSerialize(e)))}function Ee(e){if(!m(`slurpAllLineEndings`)){if(m(`slurpOneLineEnding`)){p(`slurpOneLineEnding`);return}if(m(`inCodeText`)){v(` `);return}v(x(this.sliceSerialize(e)))}}function De(e){v(x(this.sliceSerialize(e))),p(`flowCodeSeenData`,!0)}function Oe(){_(`<br />`)}function ke(){b(),J()}function q(){p(`ignoreEncode`)}function J(){t.allowDangerousHtml&&p(`ignoreEncode`,!0)}function Ae(){_(`<em>`)}function je(){_(`<strong>`)}function Me(){p(`inCodeText`,!0),_(`<code>`)}function Ne(){p(`inCodeText`),_(`</code>`)}function Pe(){_(`</em>`)}function Y(){_(`</strong>`)}function Fe(){b(),_(`<hr />`)}function Ie(e){p(`characterReferenceType`,e.type)}function Le(e){let t=this.sliceSerialize(e);v(x(m(`characterReferenceType`)?ce(t,m(`characterReferenceType`)===`characterReferenceMarkerNumeric`?10:16):F(t))),p(`characterReferenceType`)}function Re(e){let n=this.sliceSerialize(e);_(`<a href="`+ve(n,t.allowDangerousProtocol?void 0:xe)+`">`),v(x(n)),_(`</a>`)}function ze(e){let t=this.sliceSerialize(e);_(`<a href="`+ve(`mailto:`+t)+`">`),v(x(t)),_(`</a>`)}}function G(e,t,n,r){let i=r?r-1:1/0,a=0;return o;function o(r){return U(r)?(e.enter(n),s(r)):t(r)}function s(r){return U(r)&&a++<i?(e.consume(r),s):(e.exit(n),t(r))}}var we={tokenize:Te};function Te(e){let t=e.attempt(this.parser.constructs.contentInitial,r,i),n;return t;function r(n){if(n===null){e.consume(n);return}return e.enter(`lineEnding`),e.consume(n),e.exit(`lineEnding`),G(e,t,`linePrefix`)}function i(t){return e.enter(`paragraph`),a(t)}function a(t){let r=e.enter(`chunkText`,{contentType:`text`,previous:n});return n&&(n.next=r),n=r,o(t)}function o(t){if(t===null){e.exit(`chunkText`),e.exit(`paragraph`),e.consume(t);return}return V(t)?(e.consume(t),e.exit(`chunkText`),a):(e.consume(t),o)}}var K={tokenize:De},Ee={tokenize:Oe};function De(e){let t=this,n=[],r=0,i,a,o;return s;function s(i){if(r<n.length){let a=n[r];return t.containerState=a[1],e.attempt(a[0].continuation,c,l)(i)}return l(i)}function c(e){if(r++,t.containerState._closeFlow){t.containerState._closeFlow=void 0,i&&v();let n=t.events.length,a=n,o;for(;a--;)if(t.events[a][0]===`exit`&&t.events[a][1].type===`chunkFlow`){o=t.events[a][1].end;break}_(r);let s=n;for(;s<t.events.length;)t.events[s][1].end={...o},s++;return I(t.events,a+1,0,t.events.slice(n)),t.events.length=s,l(e)}return s(e)}function l(a){if(r===n.length){if(!i)return f(a);if(i.currentConstruct&&i.currentConstruct.concrete)return m(a);t.interrupt=!!(i.currentConstruct&&!i._gfmTableDynamicInterruptHack)}return t.containerState={},e.check(Ee,u,d)(a)}function u(e){return i&&v(),_(r),f(e)}function d(e){return t.parser.lazy[t.now().line]=r!==n.length,o=t.now().offset,m(e)}function f(n){return t.containerState={},e.attempt(Ee,p,m)(n)}function p(e){return r++,n.push([t.currentConstruct,t.containerState]),f(e)}function m(n){if(n===null){i&&v(),_(0),e.consume(n);return}return i||=t.parser.flow(t.now()),e.enter(`chunkFlow`,{_tokenizer:i,contentType:`flow`,previous:a}),h(n)}function h(n){if(n===null){g(e.exit(`chunkFlow`),!0),_(0),e.consume(n);return}return V(n)?(e.consume(n),g(e.exit(`chunkFlow`)),r=0,t.interrupt=void 0,s):(e.consume(n),h)}function g(e,n){let s=t.sliceStream(e);if(n&&s.push(null),e.previous=a,a&&(a.next=e),a=e,i.defineSkip(e.start),i.write(s),t.parser.lazy[e.start.line]){let e=i.events.length;for(;e--;)if(i.events[e][1].start.offset<o&&(!i.events[e][1].end||i.events[e][1].end.offset>o))return;let n=t.events.length,a=n,s,c;for(;a--;)if(t.events[a][0]===`exit`&&t.events[a][1].type===`chunkFlow`){if(s){c=t.events[a][1].end;break}s=!0}for(_(r),e=n;e<t.events.length;)t.events[e][1].end={...c},e++;I(t.events,a+1,0,t.events.slice(n)),t.events.length=e}}function _(r){let i=n.length;for(;i-- >r;){let r=n[i];t.containerState=r[1],r[0].exit.call(t,e)}n.length=r}function v(){i.write([null]),a=void 0,i=void 0,t.containerState._closeFlow=void 0}}function Oe(e,t,n){return G(e,e.attempt(this.parser.constructs.document,t,n),`linePrefix`,this.parser.constructs.disable.null.includes(`codeIndented`)?void 0:4)}function ke(e){if(e===null||H(e)||_e(e))return 1;if(ge(e))return 2}function q(e,t,n){let r=[],i=-1;for(;++i<e.length;){let a=e[i].resolveAll;a&&!r.includes(a)&&(t=a(t,n),r.push(a))}return t}var J={name:`attention`,resolveAll:Ae,tokenize:je};function Ae(e,t){let n=-1,r,i,a,o,s,c,l,u;for(;++n<e.length;)if(e[n][0]===`enter`&&e[n][1].type===`attentionSequence`&&e[n][1]._close){for(r=n;r--;)if(e[r][0]===`exit`&&e[r][1].type===`attentionSequence`&&e[r][1]._open&&t.sliceSerialize(e[r][1]).charCodeAt(0)===t.sliceSerialize(e[n][1]).charCodeAt(0)){if((e[r][1]._close||e[n][1]._open)&&(e[n][1].end.offset-e[n][1].start.offset)%3&&!((e[r][1].end.offset-e[r][1].start.offset+e[n][1].end.offset-e[n][1].start.offset)%3))continue;c=e[r][1].end.offset-e[r][1].start.offset>1&&e[n][1].end.offset-e[n][1].start.offset>1?2:1;let d={...e[r][1].end},f={...e[n][1].start};Me(d,-c),Me(f,c),o={type:c>1?`strongSequence`:`emphasisSequence`,start:d,end:{...e[r][1].end}},s={type:c>1?`strongSequence`:`emphasisSequence`,start:{...e[n][1].start},end:f},a={type:c>1?`strongText`:`emphasisText`,start:{...e[r][1].end},end:{...e[n][1].start}},i={type:c>1?`strong`:`emphasis`,start:{...o.start},end:{...s.end}},e[r][1].end={...o.start},e[n][1].start={...s.end},l=[],e[r][1].end.offset-e[r][1].start.offset&&(l=L(l,[[`enter`,e[r][1],t],[`exit`,e[r][1],t]])),l=L(l,[[`enter`,i,t],[`enter`,o,t],[`exit`,o,t],[`enter`,a,t]]),l=L(l,q(t.parser.constructs.insideSpan.null,e.slice(r+1,n),t)),l=L(l,[[`exit`,a,t],[`enter`,s,t],[`exit`,s,t],[`exit`,i,t]]),e[n][1].end.offset-e[n][1].start.offset?(u=2,l=L(l,[[`enter`,e[n][1],t],[`exit`,e[n][1],t]])):u=0,I(e,r-1,n-r+3,l),n=r+l.length-u-2;break}}for(n=-1;++n<e.length;)e[n][1].type===`attentionSequence`&&(e[n][1].type=`data`);return e}function je(e,t){let n=this.parser.constructs.attentionMarkers.null,r=this.previous,i=ke(r),a;return o;function o(t){return a=t,e.enter(`attentionSequence`),s(t)}function s(o){if(o===a)return e.consume(o),s;let c=e.exit(`attentionSequence`),l=ke(o),u=!l||l===2&&i||n.includes(o),d=!i||i===2&&l||n.includes(r);return c._open=!!(a===42?u:u&&(i||!d)),c._close=!!(a===42?d:d&&(l||!u)),t(o)}}function Me(e,t){e.column+=t,e.offset+=t,e._bufferIndex+=t}var Ne={name:`autolink`,tokenize:Pe};function Pe(e,t,n){let r=0;return i;function i(t){return e.enter(`autolink`),e.enter(`autolinkMarker`),e.consume(t),e.exit(`autolinkMarker`),e.enter(`autolinkProtocol`),a}function a(t){return R(t)?(e.consume(t),o):t===64?n(t):l(t)}function o(e){return e===43||e===45||e===46||z(e)?(r=1,s(e)):l(e)}function s(t){return t===58?(e.consume(t),r=0,c):(t===43||t===45||t===46||z(t))&&r++<32?(e.consume(t),s):(r=0,l(t))}function c(r){return r===62?(e.exit(`autolinkProtocol`),e.enter(`autolinkMarker`),e.consume(r),e.exit(`autolinkMarker`),e.exit(`autolink`),t):r===null||r===32||r===60||pe(r)?n(r):(e.consume(r),c)}function l(t){return t===64?(e.consume(t),u):fe(t)?(e.consume(t),l):n(t)}function u(e){return z(e)?d(e):n(e)}function d(n){return n===46?(e.consume(n),r=0,u):n===62?(e.exit(`autolinkProtocol`).type=`autolinkEmail`,e.enter(`autolinkMarker`),e.consume(n),e.exit(`autolinkMarker`),e.exit(`autolink`),t):f(n)}function f(t){if((t===45||z(t))&&r++<63){let n=t===45?f:d;return e.consume(t),n}return n(t)}}var Y={partial:!0,tokenize:Fe};function Fe(e,t,n){return r;function r(t){return U(t)?G(e,i,`linePrefix`)(t):i(t)}function i(e){return e===null||V(e)?t(e):n(e)}}var Ie={continuation:{tokenize:Re},exit:ze,name:`blockQuote`,tokenize:Le};function Le(e,t,n){let r=this;return i;function i(t){if(t===62){let n=r.containerState;return n.open||=(e.enter(`blockQuote`,{_container:!0}),!0),e.enter(`blockQuotePrefix`),e.enter(`blockQuoteMarker`),e.consume(t),e.exit(`blockQuoteMarker`),a}return n(t)}function a(n){return U(n)?(e.enter(`blockQuotePrefixWhitespace`),e.consume(n),e.exit(`blockQuotePrefixWhitespace`),e.exit(`blockQuotePrefix`),t):(e.exit(`blockQuotePrefix`),t(n))}}function Re(e,t,n){let r=this;return i;function i(t){return U(t)?G(e,a,`linePrefix`,r.parser.constructs.disable.null.includes(`codeIndented`)?void 0:4)(t):a(t)}function a(r){return e.attempt(Ie,t,n)(r)}}function ze(e){e.exit(`blockQuote`)}var Be={name:`characterEscape`,tokenize:Ve};function Ve(e,t,n){return r;function r(t){return e.enter(`characterEscape`),e.enter(`escapeMarker`),e.consume(t),e.exit(`escapeMarker`),i}function i(r){return he(r)?(e.enter(`characterEscapeValue`),e.consume(r),e.exit(`characterEscapeValue`),e.exit(`characterEscape`),t):n(r)}}var He={name:`characterReference`,tokenize:Ue};function Ue(e,t,n){let r=this,i=0,a,o;return s;function s(t){return e.enter(`characterReference`),e.enter(`characterReferenceMarker`),e.consume(t),e.exit(`characterReferenceMarker`),c}function c(t){return t===35?(e.enter(`characterReferenceMarkerNumeric`),e.consume(t),e.exit(`characterReferenceMarkerNumeric`),l):(e.enter(`characterReferenceValue`),a=31,o=z,u(t))}function l(t){return t===88||t===120?(e.enter(`characterReferenceMarkerHexadecimal`),e.consume(t),e.exit(`characterReferenceMarkerHexadecimal`),e.enter(`characterReferenceValue`),a=6,o=me,u):(e.enter(`characterReferenceValue`),a=7,o=B,u(t))}function u(s){if(s===59&&i){let i=e.exit(`characterReferenceValue`);return o===z&&!F(r.sliceSerialize(i))?n(s):(e.enter(`characterReferenceMarker`),e.consume(s),e.exit(`characterReferenceMarker`),e.exit(`characterReference`),t)}return o(s)&&i++<a?(e.consume(s),u):n(s)}}var We={partial:!0,tokenize:qe},Ge={concrete:!0,name:`codeFenced`,tokenize:Ke};function Ke(e,t,n){let r=this,i={partial:!0,tokenize:x},a=0,o=0,s;return c;function c(e){return l(e)}function l(t){let n=r.events[r.events.length-1];return a=n&&n[1].type===`linePrefix`?n[2].sliceSerialize(n[1],!0).length:0,s=t,e.enter(`codeFenced`),e.enter(`codeFencedFence`),e.enter(`codeFencedFenceSequence`),u(t)}function u(t){return t===s?(o++,e.consume(t),u):o<3?n(t):(e.exit(`codeFencedFenceSequence`),U(t)?G(e,d,`whitespace`)(t):d(t))}function d(n){return n===null||V(n)?(e.exit(`codeFencedFence`),r.interrupt?t(n):e.check(We,h,b)(n)):(e.enter(`codeFencedFenceInfo`),e.enter(`chunkString`,{contentType:`string`}),f(n))}function f(t){return t===null||V(t)?(e.exit(`chunkString`),e.exit(`codeFencedFenceInfo`),d(t)):U(t)?(e.exit(`chunkString`),e.exit(`codeFencedFenceInfo`),G(e,p,`whitespace`)(t)):t===96&&t===s?n(t):(e.consume(t),f)}function p(t){return t===null||V(t)?d(t):(e.enter(`codeFencedFenceMeta`),e.enter(`chunkString`,{contentType:`string`}),m(t))}function m(t){return t===null||V(t)?(e.exit(`chunkString`),e.exit(`codeFencedFenceMeta`),d(t)):t===96&&t===s?n(t):(e.consume(t),m)}function h(t){return e.attempt(i,b,g)(t)}function g(t){return e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),_}function _(t){return a>0&&U(t)?G(e,v,`linePrefix`,a+1)(t):v(t)}function v(t){return t===null||V(t)?e.check(We,h,b)(t):(e.enter(`codeFlowValue`),y(t))}function y(t){return t===null||V(t)?(e.exit(`codeFlowValue`),v(t)):(e.consume(t),y)}function b(n){return e.exit(`codeFenced`),t(n)}function x(e,t,n){let i=0;return a;function a(t){return e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),c}function c(t){return e.enter(`codeFencedFence`),U(t)?G(e,l,`linePrefix`,r.parser.constructs.disable.null.includes(`codeIndented`)?void 0:4)(t):l(t)}function l(t){return t===s?(e.enter(`codeFencedFenceSequence`),u(t)):n(t)}function u(t){return t===s?(i++,e.consume(t),u):i>=o?(e.exit(`codeFencedFenceSequence`),U(t)?G(e,d,`whitespace`)(t):d(t)):n(t)}function d(r){return r===null||V(r)?(e.exit(`codeFencedFence`),t(r)):n(r)}}}function qe(e,t,n){let r=this;return i;function i(t){return t===null?n(t):(e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),a)}function a(e){return r.parser.lazy[r.now().line]?n(e):t(e)}}var Je={name:`codeIndented`,tokenize:Xe},Ye={partial:!0,tokenize:Ze};function Xe(e,t,n){let r=this;return i;function i(t){return e.enter(`codeIndented`),G(e,a,`linePrefix`,5)(t)}function a(e){let t=r.events[r.events.length-1];return t&&t[1].type===`linePrefix`&&t[2].sliceSerialize(t[1],!0).length>=4?o(e):n(e)}function o(t){return t===null?c(t):V(t)?e.attempt(Ye,o,c)(t):(e.enter(`codeFlowValue`),s(t))}function s(t){return t===null||V(t)?(e.exit(`codeFlowValue`),o(t)):(e.consume(t),s)}function c(n){return e.exit(`codeIndented`),t(n)}}function Ze(e,t,n){let r=this;return i;function i(t){return r.parser.lazy[r.now().line]?n(t):V(t)?(e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),i):G(e,a,`linePrefix`,5)(t)}function a(e){let a=r.events[r.events.length-1];return a&&a[1].type===`linePrefix`&&a[2].sliceSerialize(a[1],!0).length>=4?t(e):V(e)?i(e):n(e)}}var Qe={name:`codeText`,previous:et,resolve:$e,tokenize:tt};function $e(e){let t=e.length-4,n=3,r,i;if((e[n][1].type===`lineEnding`||e[n][1].type===`space`)&&(e[t][1].type===`lineEnding`||e[t][1].type===`space`)){for(r=n;++r<t;)if(e[r][1].type===`codeTextData`){e[n][1].type=`codeTextPadding`,e[t][1].type=`codeTextPadding`,n+=2,t-=2;break}}for(r=n-1,t++;++r<=t;)i===void 0?r!==t&&e[r][1].type!==`lineEnding`&&(i=r):(r===t||e[r][1].type===`lineEnding`)&&(e[i][1].type=`codeTextData`,r!==i+2&&(e[i][1].end=e[r-1][1].end,e.splice(i+2,r-i-2),t-=r-i-2,r=i+2),i=void 0);return e}function et(e){return e!==96||this.events[this.events.length-1][1].type===`characterEscape`}function tt(e,t,n){let r=0,i,a;return o;function o(t){return e.enter(`codeText`),e.enter(`codeTextSequence`),s(t)}function s(t){return t===96?(e.consume(t),r++,s):(e.exit(`codeTextSequence`),c(t))}function c(t){return t===null?n(t):t===32?(e.enter(`space`),e.consume(t),e.exit(`space`),c):t===96?(a=e.enter(`codeTextSequence`),i=0,u(t)):V(t)?(e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),c):(e.enter(`codeTextData`),l(t))}function l(t){return t===null||t===32||t===96||V(t)?(e.exit(`codeTextData`),c(t)):(e.consume(t),l)}function u(n){return n===96?(e.consume(n),i++,u):i===r?(e.exit(`codeTextSequence`),e.exit(`codeText`),t(n)):(a.type=`codeTextData`,l(n))}}var nt=class{constructor(e){this.left=e?[...e]:[],this.right=[]}get(e){if(e<0||e>=this.left.length+this.right.length)throw RangeError("Cannot access index `"+e+"` in a splice buffer of size `"+(this.left.length+this.right.length)+"`");return e<this.left.length?this.left[e]:this.right[this.right.length-e+this.left.length-1]}get length(){return this.left.length+this.right.length}shift(){return this.setCursor(0),this.right.pop()}slice(e,t){let n=t??1/0;return n<this.left.length?this.left.slice(e,n):e>this.left.length?this.right.slice(this.right.length-n+this.left.length,this.right.length-e+this.left.length).reverse():this.left.slice(e).concat(this.right.slice(this.right.length-n+this.left.length).reverse())}splice(e,t,n){let r=t||0;this.setCursor(Math.trunc(e));let i=this.right.splice(this.right.length-r,1/0);return n&&X(this.left,n),i.reverse()}pop(){return this.setCursor(1/0),this.left.pop()}push(e){this.setCursor(1/0),this.left.push(e)}pushMany(e){this.setCursor(1/0),X(this.left,e)}unshift(e){this.setCursor(0),this.right.push(e)}unshiftMany(e){this.setCursor(0),X(this.right,e.reverse())}setCursor(e){if(!(e===this.left.length||e>this.left.length&&this.right.length===0||e<0&&this.left.length===0))if(e<this.left.length){let t=this.left.splice(e,1/0);X(this.right,t.reverse())}else{let t=this.right.splice(this.left.length+this.right.length-e,1/0);X(this.left,t.reverse())}}};function X(e,t){let n=0;if(t.length<1e4)e.push(...t);else for(;n<t.length;)e.push(...t.slice(n,n+1e4)),n+=1e4}function rt(e){let t={},n=-1,r,i,a,o,s,c,l,u=new nt(e);for(;++n<u.length;){for(;n in t;)n=t[n];if(r=u.get(n),n&&r[1].type===`chunkFlow`&&u.get(n-1)[1].type===`listItemPrefix`&&(c=r[1]._tokenizer.events,a=0,a<c.length&&c[a][1].type===`lineEndingBlank`&&(a+=2),a<c.length&&c[a][1].type===`content`))for(;++a<c.length&&c[a][1].type!==`content`;)c[a][1].type===`chunkText`&&(c[a][1]._isInFirstContentOfListItem=!0,a++);if(r[0]===`enter`)r[1].contentType&&(Object.assign(t,it(u,n)),n=t[n],l=!0);else if(r[1]._container){for(a=n,i=void 0;a--;)if(o=u.get(a),o[1].type===`lineEnding`||o[1].type===`lineEndingBlank`)o[0]===`enter`&&(i&&(u.get(i)[1].type=`lineEndingBlank`),o[1].type=`lineEnding`,i=a);else if(!(o[1].type===`linePrefix`||o[1].type===`listItemIndent`))break;i&&(r[1].end={...u.get(i)[1].start},s=u.slice(i,n),s.unshift(r),u.splice(i,n-i+1,s))}}return I(e,0,1/0,u.slice(0)),!l}function it(e,t){let n=e.get(t)[1],r=e.get(t)[2],i=t-1,a=[],o=n._tokenizer;o||(o=r.parser[n.contentType](n.start),n._contentTypeTextTrailing&&(o._contentTypeTextTrailing=!0));let s=o.events,c=[],l={},u,d,f=-1,p=n,m=0,h=0,g=[h];for(;p;){for(;e.get(++i)[1]!==p;);a.push(i),p._tokenizer||(u=r.sliceStream(p),p.next||u.push(null),d&&o.defineSkip(p.start),p._isInFirstContentOfListItem&&(o._gfmTasklistFirstContentOfListItem=!0),o.write(u),p._isInFirstContentOfListItem&&(o._gfmTasklistFirstContentOfListItem=void 0)),d=p,p=p.next}for(p=n;++f<s.length;)s[f][0]===`exit`&&s[f-1][0]===`enter`&&s[f][1].type===s[f-1][1].type&&s[f][1].start.line!==s[f][1].end.line&&(h=f+1,g.push(h),p._tokenizer=void 0,p.previous=void 0,p=p.next);for(o.events=[],p?(p._tokenizer=void 0,p.previous=void 0):g.pop(),f=g.length;f--;){let t=s.slice(g[f],g[f+1]),n=a.pop();c.push([n,n+t.length-1]),e.splice(n,2,t)}for(c.reverse(),f=-1;++f<c.length;)l[m+c[f][0]]=m+c[f][1],m+=c[f][1]-c[f][0]-1;return l}var at={resolve:st,tokenize:ct},ot={partial:!0,tokenize:lt};function st(e){return rt(e),e}function ct(e,t){let n;return r;function r(t){return e.enter(`content`),n=e.enter(`chunkContent`,{contentType:`content`}),i(t)}function i(t){return t===null?a(t):V(t)?e.check(ot,o,a)(t):(e.consume(t),i)}function a(n){return e.exit(`chunkContent`),e.exit(`content`),t(n)}function o(t){return e.consume(t),e.exit(`chunkContent`),n.next=e.enter(`chunkContent`,{contentType:`content`,previous:n}),n=n.next,i}}function lt(e,t,n){let r=this;return i;function i(t){return e.exit(`chunkContent`),e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),G(e,a,`linePrefix`)}function a(i){if(i===null||V(i))return n(i);let a=r.events[r.events.length-1];return!r.parser.constructs.disable.null.includes(`codeIndented`)&&a&&a[1].type===`linePrefix`&&a[2].sliceSerialize(a[1],!0).length>=4?t(i):e.interrupt(r.parser.constructs.flow,n,t)(i)}}function ut(e,t,n,r,i,a,o,s,c){let l=c||1/0,u=0;return d;function d(t){return t===60?(e.enter(r),e.enter(i),e.enter(a),e.consume(t),e.exit(a),f):t===null||t===32||t===41||pe(t)?n(t):(e.enter(r),e.enter(o),e.enter(s),e.enter(`chunkString`,{contentType:`string`}),h(t))}function f(n){return n===62?(e.enter(a),e.consume(n),e.exit(a),e.exit(i),e.exit(r),t):(e.enter(s),e.enter(`chunkString`,{contentType:`string`}),p(n))}function p(t){return t===62?(e.exit(`chunkString`),e.exit(s),f(t)):t===null||t===60||V(t)?n(t):(e.consume(t),t===92?m:p)}function m(t){return t===60||t===62||t===92?(e.consume(t),p):p(t)}function h(i){return!u&&(i===null||i===41||H(i))?(e.exit(`chunkString`),e.exit(s),e.exit(o),e.exit(r),t(i)):u<l&&i===40?(e.consume(i),u++,h):i===41?(e.consume(i),u--,h):i===null||i===32||i===40||pe(i)?n(i):(e.consume(i),i===92?g:h)}function g(t){return t===40||t===41||t===92?(e.consume(t),h):h(t)}}function dt(e,t,n,r,i,a){let o=this,s=0,c;return l;function l(t){return e.enter(r),e.enter(i),e.consume(t),e.exit(i),e.enter(a),u}function u(l){return s>999||l===null||l===91||l===93&&!c||l===94&&!s&&`_hiddenFootnoteSupport`in o.parser.constructs?n(l):l===93?(e.exit(a),e.enter(i),e.consume(l),e.exit(i),e.exit(r),t):V(l)?(e.enter(`lineEnding`),e.consume(l),e.exit(`lineEnding`),u):(e.enter(`chunkString`,{contentType:`string`}),d(l))}function d(t){return t===null||t===91||t===93||V(t)||s++>999?(e.exit(`chunkString`),u(t)):(e.consume(t),c||=!U(t),t===92?f:d)}function f(t){return t===91||t===92||t===93?(e.consume(t),s++,d):d(t)}}function ft(e,t,n,r,i,a){let o;return s;function s(t){return t===34||t===39||t===40?(e.enter(r),e.enter(i),e.consume(t),e.exit(i),o=t===40?41:t,c):n(t)}function c(n){return n===o?(e.enter(i),e.consume(n),e.exit(i),e.exit(r),t):(e.enter(a),l(n))}function l(t){return t===o?(e.exit(a),c(o)):t===null?n(t):V(t)?(e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),G(e,l,`linePrefix`)):(e.enter(`chunkString`,{contentType:`string`}),u(t))}function u(t){return t===o||t===null||V(t)?(e.exit(`chunkString`),l(t)):(e.consume(t),t===92?d:u)}function d(t){return t===o||t===92?(e.consume(t),u):u(t)}}function pt(e,t){let n;return r;function r(i){return V(i)?(e.enter(`lineEnding`),e.consume(i),e.exit(`lineEnding`),n=!0,r):U(i)?G(e,r,n?`linePrefix`:`lineSuffix`)(i):t(i)}}var mt={name:`definition`,tokenize:gt},ht={partial:!0,tokenize:_t};function gt(e,t,n){let r=this,i;return a;function a(t){return e.enter(`definition`),o(t)}function o(t){return dt.call(r,e,s,n,`definitionLabel`,`definitionLabelMarker`,`definitionLabelString`)(t)}function s(t){return i=de(r.sliceSerialize(r.events[r.events.length-1][1]).slice(1,-1)),t===58?(e.enter(`definitionMarker`),e.consume(t),e.exit(`definitionMarker`),c):n(t)}function c(t){return H(t)?pt(e,l)(t):l(t)}function l(t){return ut(e,u,n,`definitionDestination`,`definitionDestinationLiteral`,`definitionDestinationLiteralMarker`,`definitionDestinationRaw`,`definitionDestinationString`)(t)}function u(t){return e.attempt(ht,d,d)(t)}function d(t){return U(t)?G(e,f,`whitespace`)(t):f(t)}function f(a){return a===null||V(a)?(e.exit(`definition`),r.parser.defined.push(i),t(a)):n(a)}}function _t(e,t,n){return r;function r(t){return H(t)?pt(e,i)(t):n(t)}function i(t){return ft(e,a,n,`definitionTitle`,`definitionTitleMarker`,`definitionTitleString`)(t)}function a(t){return U(t)?G(e,o,`whitespace`)(t):o(t)}function o(e){return e===null||V(e)?t(e):n(e)}}var vt={name:`hardBreakEscape`,tokenize:yt};function yt(e,t,n){return r;function r(t){return e.enter(`hardBreakEscape`),e.consume(t),i}function i(r){return V(r)?(e.exit(`hardBreakEscape`),t(r)):n(r)}}var bt={name:`headingAtx`,resolve:xt,tokenize:St};function xt(e,t){let n=e.length-2,r=3,i,a;return e[r][1].type===`whitespace`&&(r+=2),n-2>r&&e[n][1].type===`whitespace`&&(n-=2),e[n][1].type===`atxHeadingSequence`&&(r===n-1||n-4>r&&e[n-2][1].type===`whitespace`)&&(n-=r+1===n?2:4),n>r&&(i={type:`atxHeadingText`,start:e[r][1].start,end:e[n][1].end},a={type:`chunkText`,start:e[r][1].start,end:e[n][1].end,contentType:`text`},I(e,r,n-r+1,[[`enter`,i,t],[`enter`,a,t],[`exit`,a,t],[`exit`,i,t]])),e}function St(e,t,n){let r=0;return i;function i(t){return e.enter(`atxHeading`),a(t)}function a(t){return e.enter(`atxHeadingSequence`),o(t)}function o(t){return t===35&&r++<6?(e.consume(t),o):t===null||H(t)?(e.exit(`atxHeadingSequence`),s(t)):n(t)}function s(n){return n===35?(e.enter(`atxHeadingSequence`),c(n)):n===null||V(n)?(e.exit(`atxHeading`),t(n)):U(n)?G(e,s,`whitespace`)(n):(e.enter(`atxHeadingText`),l(n))}function c(t){return t===35?(e.consume(t),c):(e.exit(`atxHeadingSequence`),s(t))}function l(t){return t===null||t===35||H(t)?(e.exit(`atxHeadingText`),s(t)):(e.consume(t),l)}}var Ct=`address.article.aside.base.basefont.blockquote.body.caption.center.col.colgroup.dd.details.dialog.dir.div.dl.dt.fieldset.figcaption.figure.footer.form.frame.frameset.h1.h2.h3.h4.h5.h6.head.header.hr.html.iframe.legend.li.link.main.menu.menuitem.nav.noframes.ol.optgroup.option.p.param.search.section.summary.table.tbody.td.tfoot.th.thead.title.tr.track.ul`.split(`.`),wt=[`pre`,`script`,`style`,`textarea`],Tt={concrete:!0,name:`htmlFlow`,resolveTo:Ot,tokenize:kt},Et={partial:!0,tokenize:jt},Dt={partial:!0,tokenize:At};function Ot(e){let t=e.length;for(;t--&&!(e[t][0]===`enter`&&e[t][1].type===`htmlFlow`););return t>1&&e[t-2][1].type===`linePrefix`&&(e[t][1].start=e[t-2][1].start,e[t+1][1].start=e[t-2][1].start,e.splice(t-2,2)),e}function kt(e,t,n){let r=this,i,a,o,s,c;return l;function l(e){return u(e)}function u(t){return e.enter(`htmlFlow`),e.enter(`htmlFlowData`),e.consume(t),d}function d(s){return s===33?(e.consume(s),f):s===47?(e.consume(s),a=!0,h):s===63?(e.consume(s),i=3,r.interrupt?t:P):R(s)?(e.consume(s),o=String.fromCharCode(s),g):n(s)}function f(a){return a===45?(e.consume(a),i=2,p):a===91?(e.consume(a),i=5,s=0,m):R(a)?(e.consume(a),i=4,r.interrupt?t:P):n(a)}function p(i){return i===45?(e.consume(i),r.interrupt?t:P):n(i)}function m(i){return i===`CDATA[`.charCodeAt(s++)?(e.consume(i),s===6?r.interrupt?t:O:m):n(i)}function h(t){return R(t)?(e.consume(t),o=String.fromCharCode(t),g):n(t)}function g(s){if(s===null||s===47||s===62||H(s)){let c=s===47,l=o.toLowerCase();return!c&&!a&&wt.includes(l)?(i=1,r.interrupt?t(s):O(s)):Ct.includes(o.toLowerCase())?(i=6,c?(e.consume(s),_):r.interrupt?t(s):O(s)):(i=7,r.interrupt&&!r.parser.lazy[r.now().line]?n(s):a?v(s):y(s))}return s===45||z(s)?(e.consume(s),o+=String.fromCharCode(s),g):n(s)}function _(i){return i===62?(e.consume(i),r.interrupt?t:O):n(i)}function v(t){return U(t)?(e.consume(t),v):E(t)}function y(t){return t===47?(e.consume(t),E):t===58||t===95||R(t)?(e.consume(t),b):U(t)?(e.consume(t),y):E(t)}function b(t){return t===45||t===46||t===58||t===95||z(t)?(e.consume(t),b):x(t)}function x(t){return t===61?(e.consume(t),S):U(t)?(e.consume(t),x):y(t)}function S(t){return t===null||t===60||t===61||t===62||t===96?n(t):t===34||t===39?(e.consume(t),c=t,C):U(t)?(e.consume(t),S):w(t)}function C(t){return t===c?(e.consume(t),c=null,T):t===null||V(t)?n(t):(e.consume(t),C)}function w(t){return t===null||t===34||t===39||t===47||t===60||t===61||t===62||t===96||H(t)?x(t):(e.consume(t),w)}function T(e){return e===47||e===62||U(e)?y(e):n(e)}function E(t){return t===62?(e.consume(t),D):n(t)}function D(t){return t===null||V(t)?O(t):U(t)?(e.consume(t),D):n(t)}function O(t){return t===45&&i===2?(e.consume(t),j):t===60&&i===1?(e.consume(t),M):t===62&&i===4?(e.consume(t),F):t===63&&i===3?(e.consume(t),P):t===93&&i===5?(e.consume(t),N):V(t)&&(i===6||i===7)?(e.exit(`htmlFlowData`),e.check(Et,I,k)(t)):t===null||V(t)?(e.exit(`htmlFlowData`),k(t)):(e.consume(t),O)}function k(t){return e.check(Dt,A,I)(t)}function A(t){return e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),ee}function ee(t){return t===null||V(t)?k(t):(e.enter(`htmlFlowData`),O(t))}function j(t){return t===45?(e.consume(t),P):O(t)}function M(t){return t===47?(e.consume(t),o=``,te):O(t)}function te(t){if(t===62){let n=o.toLowerCase();return wt.includes(n)?(e.consume(t),F):O(t)}return R(t)&&o.length<8?(e.consume(t),o+=String.fromCharCode(t),te):O(t)}function N(t){return t===93?(e.consume(t),P):O(t)}function P(t){return t===62?(e.consume(t),F):t===45&&i===2?(e.consume(t),P):O(t)}function F(t){return t===null||V(t)?(e.exit(`htmlFlowData`),I(t)):(e.consume(t),F)}function I(n){return e.exit(`htmlFlow`),t(n)}}function At(e,t,n){let r=this;return i;function i(t){return V(t)?(e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),a):n(t)}function a(e){return r.parser.lazy[r.now().line]?n(e):t(e)}}function jt(e,t,n){return r;function r(r){return e.enter(`lineEnding`),e.consume(r),e.exit(`lineEnding`),e.attempt(Y,t,n)}}var Mt={name:`htmlText`,tokenize:Nt};function Nt(e,t,n){let r=this,i,a,o;return s;function s(t){return e.enter(`htmlText`),e.enter(`htmlTextData`),e.consume(t),c}function c(t){return t===33?(e.consume(t),l):t===47?(e.consume(t),x):t===63?(e.consume(t),y):R(t)?(e.consume(t),w):n(t)}function l(t){return t===45?(e.consume(t),u):t===91?(e.consume(t),a=0,m):R(t)?(e.consume(t),v):n(t)}function u(t){return t===45?(e.consume(t),p):n(t)}function d(t){return t===null?n(t):t===45?(e.consume(t),f):V(t)?(o=d,M(t)):(e.consume(t),d)}function f(t){return t===45?(e.consume(t),p):d(t)}function p(e){return e===62?j(e):e===45?f(e):d(e)}function m(t){return t===`CDATA[`.charCodeAt(a++)?(e.consume(t),a===6?h:m):n(t)}function h(t){return t===null?n(t):t===93?(e.consume(t),g):V(t)?(o=h,M(t)):(e.consume(t),h)}function g(t){return t===93?(e.consume(t),_):h(t)}function _(t){return t===62?j(t):t===93?(e.consume(t),_):h(t)}function v(t){return t===null||t===62?j(t):V(t)?(o=v,M(t)):(e.consume(t),v)}function y(t){return t===null?n(t):t===63?(e.consume(t),b):V(t)?(o=y,M(t)):(e.consume(t),y)}function b(e){return e===62?j(e):y(e)}function x(t){return R(t)?(e.consume(t),S):n(t)}function S(t){return t===45||z(t)?(e.consume(t),S):C(t)}function C(t){return V(t)?(o=C,M(t)):U(t)?(e.consume(t),C):j(t)}function w(t){return t===45||z(t)?(e.consume(t),w):t===47||t===62||H(t)?T(t):n(t)}function T(t){return t===47?(e.consume(t),j):t===58||t===95||R(t)?(e.consume(t),E):V(t)?(o=T,M(t)):U(t)?(e.consume(t),T):j(t)}function E(t){return t===45||t===46||t===58||t===95||z(t)?(e.consume(t),E):D(t)}function D(t){return t===61?(e.consume(t),O):V(t)?(o=D,M(t)):U(t)?(e.consume(t),D):T(t)}function O(t){return t===null||t===60||t===61||t===62||t===96?n(t):t===34||t===39?(e.consume(t),i=t,k):V(t)?(o=O,M(t)):U(t)?(e.consume(t),O):(e.consume(t),A)}function k(t){return t===i?(e.consume(t),i=void 0,ee):t===null?n(t):V(t)?(o=k,M(t)):(e.consume(t),k)}function A(t){return t===null||t===34||t===39||t===60||t===61||t===96?n(t):t===47||t===62||H(t)?T(t):(e.consume(t),A)}function ee(e){return e===47||e===62||H(e)?T(e):n(e)}function j(r){return r===62?(e.consume(r),e.exit(`htmlTextData`),e.exit(`htmlText`),t):n(r)}function M(t){return e.exit(`htmlTextData`),e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),te}function te(t){return U(t)?G(e,N,`linePrefix`,r.parser.constructs.disable.null.includes(`codeIndented`)?void 0:4)(t):N(t)}function N(t){return e.enter(`htmlTextData`),o(t)}}var Pt={name:`labelEnd`,resolveAll:Rt,resolveTo:zt,tokenize:Bt},Ft={tokenize:Vt},It={tokenize:Ht},Lt={tokenize:Ut};function Rt(e){let t=-1,n=[];for(;++t<e.length;){let r=e[t][1];if(n.push(e[t]),r.type===`labelImage`||r.type===`labelLink`||r.type===`labelEnd`){let e=r.type===`labelImage`?4:2;r.type=`data`,t+=e}}return e.length!==n.length&&I(e,0,e.length,n),e}function zt(e,t){let n=e.length,r=0,i,a,o,s;for(;n--;)if(i=e[n][1],a){if(i.type===`link`||i.type===`labelLink`&&i._inactive)break;e[n][0]===`enter`&&i.type===`labelLink`&&(i._inactive=!0)}else if(o){if(e[n][0]===`enter`&&(i.type===`labelImage`||i.type===`labelLink`)&&!i._balanced&&(a=n,i.type!==`labelLink`)){r=2;break}}else i.type===`labelEnd`&&(o=n);let c={type:e[a][1].type===`labelLink`?`link`:`image`,start:{...e[a][1].start},end:{...e[e.length-1][1].end}},l={type:`label`,start:{...e[a][1].start},end:{...e[o][1].end}},u={type:`labelText`,start:{...e[a+r+2][1].end},end:{...e[o-2][1].start}};return s=[[`enter`,c,t],[`enter`,l,t]],s=L(s,e.slice(a+1,a+r+3)),s=L(s,[[`enter`,u,t]]),s=L(s,q(t.parser.constructs.insideSpan.null,e.slice(a+r+4,o-3),t)),s=L(s,[[`exit`,u,t],e[o-2],e[o-1],[`exit`,l,t]]),s=L(s,e.slice(o+1)),s=L(s,[[`exit`,c,t]]),I(e,a,e.length,s),e}function Bt(e,t,n){let r=this,i=r.events.length,a,o;for(;i--;)if((r.events[i][1].type===`labelImage`||r.events[i][1].type===`labelLink`)&&!r.events[i][1]._balanced){a=r.events[i][1];break}return s;function s(t){return a?a._inactive?d(t):(o=r.parser.defined.includes(de(r.sliceSerialize({start:a.end,end:r.now()}))),e.enter(`labelEnd`),e.enter(`labelMarker`),e.consume(t),e.exit(`labelMarker`),e.exit(`labelEnd`),c):n(t)}function c(t){return t===40?e.attempt(Ft,u,o?u:d)(t):t===91?e.attempt(It,u,o?l:d)(t):o?u(t):d(t)}function l(t){return e.attempt(Lt,u,d)(t)}function u(e){return t(e)}function d(e){return a._balanced=!0,n(e)}}function Vt(e,t,n){return r;function r(t){return e.enter(`resource`),e.enter(`resourceMarker`),e.consume(t),e.exit(`resourceMarker`),i}function i(t){return H(t)?pt(e,a)(t):a(t)}function a(t){return t===41?u(t):ut(e,o,s,`resourceDestination`,`resourceDestinationLiteral`,`resourceDestinationLiteralMarker`,`resourceDestinationRaw`,`resourceDestinationString`,32)(t)}function o(t){return H(t)?pt(e,c)(t):u(t)}function s(e){return n(e)}function c(t){return t===34||t===39||t===40?ft(e,l,n,`resourceTitle`,`resourceTitleMarker`,`resourceTitleString`)(t):u(t)}function l(t){return H(t)?pt(e,u)(t):u(t)}function u(r){return r===41?(e.enter(`resourceMarker`),e.consume(r),e.exit(`resourceMarker`),e.exit(`resource`),t):n(r)}}function Ht(e,t,n){let r=this;return i;function i(t){return dt.call(r,e,a,o,`reference`,`referenceMarker`,`referenceString`)(t)}function a(e){return r.parser.defined.includes(de(r.sliceSerialize(r.events[r.events.length-1][1]).slice(1,-1)))?t(e):n(e)}function o(e){return n(e)}}function Ut(e,t,n){return r;function r(t){return e.enter(`reference`),e.enter(`referenceMarker`),e.consume(t),e.exit(`referenceMarker`),i}function i(r){return r===93?(e.enter(`referenceMarker`),e.consume(r),e.exit(`referenceMarker`),e.exit(`reference`),t):n(r)}}var Wt={name:`labelStartImage`,resolveAll:Pt.resolveAll,tokenize:Gt};function Gt(e,t,n){let r=this;return i;function i(t){return e.enter(`labelImage`),e.enter(`labelImageMarker`),e.consume(t),e.exit(`labelImageMarker`),a}function a(t){return t===91?(e.enter(`labelMarker`),e.consume(t),e.exit(`labelMarker`),e.exit(`labelImage`),o):n(t)}function o(e){return e===94&&`_hiddenFootnoteSupport`in r.parser.constructs?n(e):t(e)}}var Kt={name:`labelStartLink`,resolveAll:Pt.resolveAll,tokenize:qt};function qt(e,t,n){let r=this;return i;function i(t){return e.enter(`labelLink`),e.enter(`labelMarker`),e.consume(t),e.exit(`labelMarker`),e.exit(`labelLink`),a}function a(e){return e===94&&`_hiddenFootnoteSupport`in r.parser.constructs?n(e):t(e)}}var Jt={name:`lineEnding`,tokenize:Yt};function Yt(e,t){return n;function n(n){return e.enter(`lineEnding`),e.consume(n),e.exit(`lineEnding`),G(e,t,`linePrefix`)}}var Xt={name:`thematicBreak`,tokenize:Zt};function Zt(e,t,n){let r=0,i;return a;function a(t){return e.enter(`thematicBreak`),o(t)}function o(e){return i=e,s(e)}function s(a){return a===i?(e.enter(`thematicBreakSequence`),c(a)):r>=3&&(a===null||V(a))?(e.exit(`thematicBreak`),t(a)):n(a)}function c(t){return t===i?(e.consume(t),r++,c):(e.exit(`thematicBreakSequence`),U(t)?G(e,s,`whitespace`)(t):s(t))}}var Z={continuation:{tokenize:tn},exit:rn,name:`list`,tokenize:en},Qt={partial:!0,tokenize:an},$t={partial:!0,tokenize:nn};function en(e,t,n){let r=this,i=r.events[r.events.length-1],a=i&&i[1].type===`linePrefix`?i[2].sliceSerialize(i[1],!0).length:0,o=0;return s;function s(t){let i=r.containerState.type||(t===42||t===43||t===45?`listUnordered`:`listOrdered`);if(i===`listUnordered`?!r.containerState.marker||t===r.containerState.marker:B(t)){if(r.containerState.type||(r.containerState.type=i,e.enter(i,{_container:!0})),i===`listUnordered`)return e.enter(`listItemPrefix`),t===42||t===45?e.check(Xt,n,l)(t):l(t);if(!r.interrupt||t===49)return e.enter(`listItemPrefix`),e.enter(`listItemValue`),c(t)}return n(t)}function c(t){return B(t)&&++o<10?(e.consume(t),c):(!r.interrupt||o<2)&&(r.containerState.marker?t===r.containerState.marker:t===41||t===46)?(e.exit(`listItemValue`),l(t)):n(t)}function l(t){return e.enter(`listItemMarker`),e.consume(t),e.exit(`listItemMarker`),r.containerState.marker=r.containerState.marker||t,e.check(Y,r.interrupt?n:u,e.attempt(Qt,f,d))}function u(e){return r.containerState.initialBlankLine=!0,a++,f(e)}function d(t){return U(t)?(e.enter(`listItemPrefixWhitespace`),e.consume(t),e.exit(`listItemPrefixWhitespace`),f):n(t)}function f(n){return r.containerState.size=a+r.sliceSerialize(e.exit(`listItemPrefix`),!0).length,t(n)}}function tn(e,t,n){let r=this;return r.containerState._closeFlow=void 0,e.check(Y,i,a);function i(n){return r.containerState.furtherBlankLines=r.containerState.furtherBlankLines||r.containerState.initialBlankLine,G(e,t,`listItemIndent`,r.containerState.size+1)(n)}function a(n){return r.containerState.furtherBlankLines||!U(n)?(r.containerState.furtherBlankLines=void 0,r.containerState.initialBlankLine=void 0,o(n)):(r.containerState.furtherBlankLines=void 0,r.containerState.initialBlankLine=void 0,e.attempt($t,t,o)(n))}function o(i){return r.containerState._closeFlow=!0,r.interrupt=void 0,G(e,e.attempt(Z,t,n),`linePrefix`,r.parser.constructs.disable.null.includes(`codeIndented`)?void 0:4)(i)}}function nn(e,t,n){let r=this;return G(e,i,`listItemIndent`,r.containerState.size+1);function i(e){let i=r.events[r.events.length-1];return i&&i[1].type===`listItemIndent`&&i[2].sliceSerialize(i[1],!0).length===r.containerState.size?t(e):n(e)}}function rn(e){e.exit(this.containerState.type)}function an(e,t,n){let r=this;return G(e,i,`listItemPrefixWhitespace`,r.parser.constructs.disable.null.includes(`codeIndented`)?void 0:5);function i(e){let i=r.events[r.events.length-1];return!U(e)&&i&&i[1].type===`listItemPrefixWhitespace`?t(e):n(e)}}var on={name:`setextUnderline`,resolveTo:sn,tokenize:cn};function sn(e,t){let n=e.length,r,i,a;for(;n--;)if(e[n][0]===`enter`){if(e[n][1].type===`content`){r=n;break}e[n][1].type===`paragraph`&&(i=n)}else e[n][1].type===`content`&&e.splice(n,1),!a&&e[n][1].type===`definition`&&(a=n);let o={type:`setextHeading`,start:{...e[r][1].start},end:{...e[e.length-1][1].end}};return e[i][1].type=`setextHeadingText`,a?(e.splice(i,0,[`enter`,o,t]),e.splice(a+1,0,[`exit`,e[r][1],t]),e[r][1].end={...e[a][1].end}):e[r][1]=o,e.push([`exit`,o,t]),e}function cn(e,t,n){let r=this,i;return a;function a(t){let a=r.events.length,s;for(;a--;)if(r.events[a][1].type!==`lineEnding`&&r.events[a][1].type!==`linePrefix`&&r.events[a][1].type!==`content`){s=r.events[a][1].type===`paragraph`;break}return!r.parser.lazy[r.now().line]&&(r.interrupt||s)?(e.enter(`setextHeadingLine`),i=t,o(t)):n(t)}function o(t){return e.enter(`setextHeadingLineSequence`),s(t)}function s(t){return t===i?(e.consume(t),s):(e.exit(`setextHeadingLineSequence`),U(t)?G(e,c,`lineSuffix`)(t):c(t))}function c(r){return r===null||V(r)?(e.exit(`setextHeadingLine`),t(r)):n(r)}}var ln={tokenize:un};function un(e){let t=this,n=e.attempt(Y,r,e.attempt(this.parser.constructs.flowInitial,i,G(e,e.attempt(this.parser.constructs.flow,i,e.attempt(at,i)),`linePrefix`)));return n;function r(r){if(r===null){e.consume(r);return}return e.enter(`lineEndingBlank`),e.consume(r),e.exit(`lineEndingBlank`),t.currentConstruct=void 0,n}function i(r){if(r===null){e.consume(r);return}return e.enter(`lineEnding`),e.consume(r),e.exit(`lineEnding`),t.currentConstruct=void 0,n}}var dn={resolveAll:hn()},fn=mn(`string`),pn=mn(`text`);function mn(e){return{resolveAll:hn(e===`text`?gn:void 0),tokenize:t};function t(t){let n=this,r=this.parser.constructs[e],i=t.attempt(r,a,o);return a;function a(e){return c(e)?i(e):o(e)}function o(e){if(e===null){t.consume(e);return}return t.enter(`data`),t.consume(e),s}function s(e){return c(e)?(t.exit(`data`),i(e)):(t.consume(e),s)}function c(e){if(e===null)return!0;let t=r[e],i=-1;if(t)for(;++i<t.length;){let e=t[i];if(!e.previous||e.previous.call(n,n.previous))return!0}return!1}}}function hn(e){return t;function t(t,n){let r=-1,i;for(;++r<=t.length;)i===void 0?t[r]&&t[r][1].type===`data`&&(i=r,r++):(!t[r]||t[r][1].type!==`data`)&&(r!==i+2&&(t[i][1].end=t[r-1][1].end,t.splice(i+2,r-i-2),r=i+2),i=void 0);return e?e(t,n):t}}function gn(e,t){let n=0;for(;++n<=e.length;)if((n===e.length||e[n][1].type===`lineEnding`)&&e[n-1][1].type===`data`){let r=e[n-1][1],i=t.sliceStream(r),a=i.length,o=-1,s=0,c;for(;a--;){let e=i[a];if(typeof e==`string`){for(o=e.length;e.charCodeAt(o-1)===32;)s++,o--;if(o)break;o=-1}else if(e===-2)c=!0,s++;else if(e!==-1){a++;break}}if(t._contentTypeTextTrailing&&n===e.length&&(s=0),s){let i={type:n===e.length||c||s<2?`lineSuffix`:`hardBreakTrailing`,start:{_bufferIndex:a?o:r.start._bufferIndex+o,_index:r.start._index+a,line:r.end.line,column:r.end.column-s,offset:r.end.offset-s},end:{...r.end}};r.end={...i.start},r.start.offset===r.end.offset?Object.assign(r,i):(e.splice(n,0,[`enter`,i,t],[`exit`,i,t]),n+=2)}n++}return e}var _n=t({attentionMarkers:()=>Tn,contentInitial:()=>yn,disable:()=>En,document:()=>vn,flow:()=>xn,flowInitial:()=>bn,insideSpan:()=>wn,string:()=>Sn,text:()=>Cn}),vn={42:Z,43:Z,45:Z,48:Z,49:Z,50:Z,51:Z,52:Z,53:Z,54:Z,55:Z,56:Z,57:Z,62:Ie},yn={91:mt},bn={[-2]:Je,[-1]:Je,32:Je},xn={35:bt,42:Xt,45:[on,Xt],60:Tt,61:on,95:Xt,96:Ge,126:Ge},Sn={38:He,92:Be},Cn={[-5]:Jt,[-4]:Jt,[-3]:Jt,33:Wt,38:He,42:J,60:[Ne,Mt],91:Kt,92:[vt,Be],93:Pt,95:J,96:Qe},wn={null:[J,dn]},Tn={null:[42,95]},En={null:[]};function Dn(e,t,n){let r={_bufferIndex:-1,_index:0,line:n&&n.line||1,column:n&&n.column||1,offset:n&&n.offset||0},i={},a=[],o=[],s=[],c={attempt:C(x),check:C(S),consume:v,enter:y,exit:b,interrupt:C(S,{interrupt:!0})},l={code:null,containerState:{},defineSkip:h,events:[],now:m,parser:e,previous:null,sliceSerialize:f,sliceStream:p,write:d},u=t.tokenize.call(l,c);return t.resolveAll&&a.push(t),l;function d(e){return o=L(o,e),g(),o[o.length-1]===null?(w(t,0),l.events=q(a,l.events,l),l.events):[]}function f(e,t){return kn(p(e),t)}function p(e){return On(o,e)}function m(){let{_bufferIndex:e,_index:t,line:n,column:i,offset:a}=r;return{_bufferIndex:e,_index:t,line:n,column:i,offset:a}}function h(e){i[e.line]=e.column,E()}function g(){let e;for(;r._index<o.length;){let t=o[r._index];if(typeof t==`string`)for(e=r._index,r._bufferIndex<0&&(r._bufferIndex=0);r._index===e&&r._bufferIndex<t.length;)_(t.charCodeAt(r._bufferIndex));else _(t)}}function _(e){u=u(e)}function v(e){V(e)?(r.line++,r.column=1,r.offset+=e===-3?2:1,E()):e!==-1&&(r.column++,r.offset++),r._bufferIndex<0?r._index++:(r._bufferIndex++,r._bufferIndex===o[r._index].length&&(r._bufferIndex=-1,r._index++)),l.previous=e}function y(e,t){let n=t||{};return n.type=e,n.start=m(),l.events.push([`enter`,n,l]),s.push(n),n}function b(e){let t=s.pop();return t.end=m(),l.events.push([`exit`,t,l]),t}function x(e,t){w(e,t.from)}function S(e,t){t.restore()}function C(e,t){return n;function n(n,r,i){let a,o,s,u;return Array.isArray(n)?f(n):`tokenize`in n?f([n]):d(n);function d(e){return t;function t(t){let n=t!==null&&e[t],r=t!==null&&e.null;return f([...Array.isArray(n)?n:n?[n]:[],...Array.isArray(r)?r:r?[r]:[]])(t)}}function f(e){return a=e,o=0,e.length===0?i:p(e[o])}function p(e){return n;function n(n){return u=T(),s=e,e.partial||(l.currentConstruct=e),e.name&&l.parser.constructs.disable.null.includes(e.name)?h(n):e.tokenize.call(t?Object.assign(Object.create(l),t):l,c,m,h)(n)}}function m(t){return e(s,u),r}function h(e){return u.restore(),++o<a.length?p(a[o]):i}}}function w(e,t){e.resolveAll&&!a.includes(e)&&a.push(e),e.resolve&&I(l.events,t,l.events.length-t,e.resolve(l.events.slice(t),l)),e.resolveTo&&(l.events=e.resolveTo(l.events,l))}function T(){let e=m(),t=l.previous,n=l.currentConstruct,i=l.events.length,a=Array.from(s);return{from:i,restore:o};function o(){r=e,l.previous=t,l.currentConstruct=n,l.events.length=i,s=a,E()}}function E(){r.line in i&&r.column<2&&(r.column=i[r.line],r.offset+=i[r.line]-1)}}function On(e,t){let n=t.start._index,r=t.start._bufferIndex,i=t.end._index,a=t.end._bufferIndex,o;if(n===i)o=[e[n].slice(r,a)];else{if(o=e.slice(n,i),r>-1){let e=o[0];typeof e==`string`?o[0]=e.slice(r):o.shift()}a>0&&o.push(e[i].slice(0,a))}return o}function kn(e,t){let n=-1,r=[],i;for(;++n<e.length;){let a=e[n],o;if(typeof a==`string`)o=a;else switch(a){case-5:o=`\r`;break;case-4:o=`
`;break;case-3:o=`\r
`;break;case-2:o=t?` `:`	`;break;case-1:if(!t&&i)continue;o=` `;break;default:o=String.fromCharCode(a)}i=a===-2,r.push(o)}return r.join(``)}function An(e){let t={constructs:re([_n,...(e||{}).extensions||[]]),content:n(we),defined:[],document:n(K),flow:n(ln),lazy:{},string:n(fn),text:n(pn)};return t;function n(e){return n;function n(n){return Dn(t,e,n)}}}function jn(e){for(;!rt(e););return e}var Mn=/[\0\t\n\r]/g;function Nn(){let e=1,t=``,n=!0,r;return i;function i(i,a,o){let s=[],c,l,u,d,f;for(i=t+(typeof i==`string`?i.toString():new TextDecoder(a||void 0).decode(i)),u=0,t=``,n&&=(i.charCodeAt(0)===65279&&u++,void 0);u<i.length;){if(Mn.lastIndex=u,c=Mn.exec(i),d=c&&c.index!==void 0?c.index:i.length,f=i.charCodeAt(d),!c){t=i.slice(u);break}if(f===10&&u===d&&r)s.push(-3),r=void 0;else switch(r&&=(s.push(-5),void 0),u<d&&(s.push(i.slice(u,d)),e+=d-u),f){case 0:s.push(65533),e++;break;case 9:for(l=Math.ceil(e/4)*4,s.push(-2);e++<l;)s.push(-1);break;case 10:s.push(-4),e=1;break;default:r=!0,e=1}u=d+1}return o&&(r&&s.push(-5),t&&s.push(t),s.push(null)),s}}function Pn(e,t,n){return typeof t!=`string`&&(n=t,t=void 0),Ce(n)(jn(An(n).document().write(Nn()(e,t,!0))))}function Fn(e){return Pn(e,{allowDangerousHtml:!1})}function In(e,t,n=3){let r=t.filter(t=>t.id!==e.id).map(t=>{let n=t.tags.filter(t=>e.tags.includes(t)).length,r=(Date.now()-new Date(t.date).getTime())/(1e3*60*60*24),i=Math.max(0,14-r)*.1;return{...t,score:n+i}});return r.sort((e,t)=>t.score-e.score),r.slice(0,n)}function Ln(e,t,n=3){return(0,x.useMemo)(()=>In(e,t,n),[e,t,n])}function Rn({currentPost:e}){let{lang:t}=a(),{posts:r}=k(),i=Ln(e,r,3);if(r.length<2||i.length===0)return null;let{setSelectedPost:o}=k(),s=e=>{o(e),history.pushState(null,``,`#blog/article/${e.slug}`)};return(0,T.jsx)(l,{children:(0,T.jsxs)(`div`,{className:`border-t-4 border-rule pt-6 mt-10 mb-8`,children:[(0,T.jsx)(`h3`,{className:`font-headline text-xl md:text-2xl font-bold text-ink mb-5`,children:t===`es`?`Artículos relacionados`:`Related posts`}),(0,T.jsx)(`div`,{className:`grid md:grid-cols-3 gap-4`,children:i.map((e,r)=>{let i=t===`es`?e.title:e.titleEn,a=t===`es`?e.excerpt:e.excerptEn;return(0,T.jsx)(n.article,{initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{duration:.25,delay:r*.08},className:`border-2 border-rule bg-paper shadow-pixel-sm hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 active:shadow-none active:translate-x-0.5 active:translate-y-0.5 transition-all duration-75 flex flex-col`,children:(0,T.jsxs)(`button`,{onClick:()=>s(e),className:`flex flex-col h-full text-left cursor-pointer p-4 gap-2`,children:[(0,T.jsx)(`div`,{className:`flex flex-wrap gap-1`,children:e.tags.slice(0,2).map(e=>(0,T.jsxs)(`span`,{className:`skill-tag text-[8px] flex items-center gap-1`,children:[(0,T.jsx)(b,{size:6}),` `,e]},e))}),(0,T.jsx)(`h4`,{className:`font-headline text-sm font-bold text-ink leading-tight line-clamp-2`,children:i}),(0,T.jsx)(`p`,{className:`font-sans text-[11px] text-ink-light leading-relaxed line-clamp-2 flex-1`,children:a}),(0,T.jsxs)(`span`,{className:`font-mono text-[9px] font-bold uppercase tracking-wider text-accent hover:text-accent-dark flex items-center gap-1 mt-auto pt-2 transition-colors`,children:[t===`es`?`Leer`:`Read`,` `,(0,T.jsx)(h,{size:9})]})]})},e.id)})})]})})}function zn(){let{lang:e}=a(),{filteredPosts:t,selectedPost:r,setSelectedPost:i}=k(),o=(0,x.useRef)(null),s=r,l=t.findIndex(e=>e.id===s?.id),u=l>0?t[l-1]:null,d=l>=0&&l<t.length-1?t[l+1]:null;(0,x.useEffect)(()=>{o.current&&o.current.scrollIntoView({block:`start`,behavior:`smooth`}),window.scrollTo({top:0,behavior:`smooth`})},[s?.id]);let f=()=>{history.pushState(null,``,`#blog`),window.dispatchEvent(new HashChangeEvent(`hashchange`))},p=()=>{u&&(i(u),history.pushState(null,``,`#blog/article/${u.slug}`))},m=()=>{d&&(i(d),history.pushState(null,``,`#blog/article/${d.slug}`))};if(!s)return null;let _=e===`es`?s.title:s.titleEn,y=e===`es`?s.content:s.contentEn,b=e===`es`?`Volver a artículos`:`Back to articles`;return(0,T.jsx)(n.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},transition:{duration:.25},ref:o,children:(0,T.jsxs)(`article`,{className:`max-w-4xl mx-auto`,children:[(0,T.jsxs)(`button`,{onClick:f,className:`flex items-center gap-1.5 font-mono text-[11px] font-bold uppercase tracking-wider text-ink-muted hover:text-accent transition-colors mb-6 cursor-pointer`,children:[(0,T.jsx)(c,{size:14}),b]}),(0,T.jsx)(`div`,{className:`border-t-4 border-rule mb-1`}),(0,T.jsx)(`div`,{className:`border-t border-rule mb-6`}),(0,T.jsx)(`h1`,{className:`font-headline text-3xl md:text-5xl lg:text-6xl font-black text-ink leading-[1.05] tracking-tight mb-4`,children:_}),(0,T.jsxs)(`div`,{className:`flex flex-wrap items-center gap-x-4 gap-y-1 mb-6 pb-4 border-b border-rule-light`,children:[(0,T.jsxs)(`span`,{className:`font-mono text-xs text-ink-muted flex items-center gap-1.5`,children:[(0,T.jsx)(g,{size:12}),s.date]}),(0,T.jsxs)(`span`,{className:`font-mono text-xs text-ink-muted flex items-center gap-1.5`,children:[(0,T.jsx)(v,{size:12}),s.readingTime,` min `,e===`es`?`de lectura`:`read`]}),(0,T.jsx)(`span`,{className:`hidden md:inline font-mono text-[10px] text-ink-muted uppercase tracking-wider`,children:`Por Edwin Trigos`})]}),(0,T.jsx)(`div`,{className:`flex flex-wrap gap-1.5 mb-8`,children:s.tags.map(e=>(0,T.jsx)(`span`,{className:`skill-tag text-[10px]`,children:e},e))}),(0,T.jsx)(`div`,{className:`
            blog-article-body
          ...
          `,dangerouslySetInnerHTML:{__html:Fn(y)}}),(0,T.jsx)(`div`,{className:`border-t-4 border-rule mt-12 mb-1`}),(0,T.jsx)(`div`,{className:`border-t border-rule mb-6`}),(0,T.jsxs)(`nav`,{className:`flex justify-between items-stretch gap-4 mb-10`,children:[u?(0,T.jsxs)(`button`,{onClick:p,className:`flex-1 flex flex-col items-start gap-1 border-2 border-rule bg-paper p-4 shadow-pixel-sm hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 active:shadow-none active:translate-x-0.5 active:translate-y-0.5 transition-all duration-75 text-left cursor-pointer`,children:[(0,T.jsxs)(`span`,{className:`font-mono text-[9px] uppercase tracking-wider text-ink-muted flex items-center gap-1`,children:[(0,T.jsx)(c,{size:10}),` `,e===`es`?`Anterior`:`Previous`]}),(0,T.jsx)(`span`,{className:`font-headline text-sm font-bold text-ink leading-tight line-clamp-2`,children:e===`es`?u.title:u.titleEn})]}):(0,T.jsx)(`div`,{className:`flex-1`}),d?(0,T.jsxs)(`button`,{onClick:m,className:`flex-1 flex flex-col items-end gap-1 border-2 border-rule bg-paper p-4 shadow-pixel-sm hover:shadow-none hover:-translate-x-0.5 hover:translate-y-0.5 active:shadow-none active:-translate-x-0.5 active:translate-y-0.5 transition-all duration-75 text-right cursor-pointer`,children:[(0,T.jsxs)(`span`,{className:`font-mono text-[9px] uppercase tracking-wider text-ink-muted flex items-center gap-1`,children:[e===`es`?`Siguiente`:`Next`,` `,(0,T.jsx)(h,{size:10})]}),(0,T.jsx)(`span`,{className:`font-headline text-sm font-bold text-ink leading-tight line-clamp-2`,children:e===`es`?d.title:d.titleEn})]}):(0,T.jsx)(`div`,{className:`flex-1`})]}),(0,T.jsxs)(`button`,{onClick:f,className:`flex items-center gap-1.5 font-mono text-[11px] font-bold uppercase tracking-wider text-ink-muted hover:text-accent transition-colors mb-6 cursor-pointer`,children:[(0,T.jsx)(c,{size:14}),b]}),s&&(0,T.jsx)(Rn,{currentPost:s})]})},`article-${s.id}`)}var Bn=[{name:`arquitectura`,label:`Arquitectura`,labelEn:`Architecture`,color:`red`},{name:`.NET`,label:`.NET`,labelEn:`.NET`,color:`blue`},{name:`clean architecture`,label:`Clean Architecture`,labelEn:`Clean Architecture`,color:`green`},{name:`DDD`,label:`DDD`,labelEn:`DDD`,color:`purple`},{name:`patrones`,label:`Patrones`,labelEn:`Patterns`,color:`orange`},{name:`C#`,label:`C#`,labelEn:`C#`,color:`blue`},{name:`design patterns`,label:`Design Patterns`,labelEn:`Design Patterns`,color:`green`}],Vn=[`arquitectura`];function Hn(){let{lang:t}=a(),{filter:r,setFilter:i,clearFilters:o}=k(),[s,c]=(0,x.useState)(!1),[l,u]=(0,x.useState)(!1),d=(r.tags?.length??0)+ +!!r.category+ +!!r.dateRange,p=e=>{let t=r.tags??[],n=t.includes(e)?t.filter(t=>t!==e):[...t,e];i({...r,tags:n})},m=e=>{i({...r,category:e}),c(!1)},h=e=>{i({...r,dateRange:{start:e,end:r.dateRange?.end??``}})},g=e=>{i({...r,dateRange:{start:r.dateRange?.start??``,end:e}})},v=()=>{i({...r,dateRange:null}),u(!1)},y=e=>Bn.find(t=>t.name===e)??{name:e,label:e,labelEn:e,color:`purple`};return(0,T.jsxs)(`div`,{className:`mb-8`,children:[d>0&&(0,T.jsxs)(`div`,{className:`flex flex-wrap items-center gap-2 mb-4`,children:[r.tags?.map(r=>{let i=y(r),a=t===`es`?i.label:i.labelEn;return(0,T.jsxs)(n.span,{initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.9},className:`skill-tag text-[10px] flex items-center gap-1.5 pr-1`,children:[a,(0,T.jsx)(`button`,{onClick:()=>p(r),className:`hover:text-accent transition-colors cursor-pointer`,"aria-label":`Remove ${a} filter`,children:(0,T.jsx)(e,{size:10})})]},`tag-${r}`)}),r.category&&(0,T.jsxs)(n.span,{initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.9},className:`skill-tag text-[10px] flex items-center gap-1.5 pr-1`,children:[r.category,(0,T.jsx)(`button`,{onClick:()=>m(null),className:`hover:text-accent transition-colors cursor-pointer`,"aria-label":`Remove category filter`,children:(0,T.jsx)(e,{size:10})})]},`cat-chip`),r.dateRange&&(0,T.jsxs)(n.span,{initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.9},className:`skill-tag text-[10px] flex items-center gap-1.5 pr-1`,children:[r.dateRange.start,` – `,r.dateRange.end,(0,T.jsx)(`button`,{onClick:v,className:`hover:text-accent transition-colors cursor-pointer`,"aria-label":`Remove date range filter`,children:(0,T.jsx)(e,{size:10})})]},`date-chip`),(0,T.jsx)(`button`,{onClick:o,className:`font-mono text-[9px] uppercase tracking-wider text-accent hover:text-accent-dark underline transition-colors cursor-pointer`,children:t===`es`?`Limpiar todo`:`Clear all`})]}),(0,T.jsxs)(`div`,{className:`flex flex-wrap items-center gap-3`,children:[(0,T.jsx)(`div`,{className:`flex flex-wrap gap-1.5`,children:Bn.map(e=>{let n=r.tags?.includes(e.name)??!1,i=t===`es`?e.label:e.labelEn;return(0,T.jsx)(`button`,{onClick:()=>p(e.name),className:`
                  skill-tag text-[10px] cursor-pointer transition-all duration-75
                  ${n?`bg-ink text-paper hover:bg-ink hover:text-paper`:``}
                `,children:i},e.name)})}),(0,T.jsxs)(`div`,{className:`relative`,children:[(0,T.jsxs)(`button`,{onClick:()=>{c(!s),u(!1)},className:`skill-tag text-[10px] flex items-center gap-1 cursor-pointer`,children:[r.category?r.category:t===`es`?`Categoría`:`Category`,(0,T.jsx)(_,{size:10})]}),(0,T.jsx)(f,{children:s&&(0,T.jsxs)(n.div,{initial:{opacity:0,y:-4},animate:{opacity:1,y:0},exit:{opacity:0,y:-4},transition:{duration:.15},className:`absolute top-full left-0 mt-1 z-20 border-2 border-rule bg-paper shadow-pixel-sm min-w-[140px]`,children:[(0,T.jsx)(`button`,{onClick:()=>m(null),className:`block w-full text-left font-mono text-[10px] px-3 py-2 hover:bg-paper-dark transition-colors cursor-pointer`,children:t===`es`?`Todas`:`All`}),Vn.map(e=>(0,T.jsx)(`button`,{onClick:()=>m(e),className:`block w-full text-left font-mono text-[10px] px-3 py-2 hover:bg-paper-dark transition-colors cursor-pointer ${r.category===e?`bg-ink text-paper`:``}`,children:e},e))]})})]}),(0,T.jsxs)(`div`,{className:`relative`,children:[(0,T.jsx)(`button`,{onClick:()=>{u(!l),c(!1)},className:`skill-tag text-[10px] flex items-center gap-1 cursor-pointer`,children:r.dateRange?`${r.dateRange.start} – ${r.dateRange.end}`:t===`es`?`Fechas`:`Dates`}),(0,T.jsx)(f,{children:l&&(0,T.jsxs)(n.div,{initial:{opacity:0,y:-4},animate:{opacity:1,y:0},exit:{opacity:0,y:-4},transition:{duration:.15},className:`absolute top-full left-0 mt-1 z-20 border-2 border-rule bg-paper shadow-pixel-sm p-3 flex flex-col gap-2`,children:[(0,T.jsx)(`label`,{className:`font-mono text-[9px] uppercase tracking-wider text-ink-muted`,children:t===`es`?`Desde`:`From`}),(0,T.jsx)(`input`,{type:`date`,value:r.dateRange?.start??``,onChange:e=>h(e.target.value),className:`border-2 border-rule bg-paper-dark font-mono text-[10px] px-2 py-1`}),(0,T.jsx)(`label`,{className:`font-mono text-[9px] uppercase tracking-wider text-ink-muted`,children:t===`es`?`Hasta`:`To`}),(0,T.jsx)(`input`,{type:`date`,value:r.dateRange?.end??``,onChange:e=>g(e.target.value),className:`border-2 border-rule bg-paper-dark font-mono text-[10px] px-2 py-1`}),r.dateRange&&(0,T.jsx)(`button`,{onClick:v,className:`font-mono text-[9px] text-accent hover:text-accent-dark underline mt-1 cursor-pointer`,children:t===`es`?`Limpiar`:`Clear`})]})})]})]})]})}var Un=`ENTRIES`,Wn=`KEYS`,Gn=`VALUES`,Q=``,Kn=class{constructor(e,t){let n=e._tree,r=Array.from(n.keys());this.set=e,this._type=t,this._path=r.length>0?[{node:n,keys:r}]:[]}next(){let e=this.dive();return this.backtrack(),e}dive(){if(this._path.length===0)return{done:!0,value:void 0};let{node:e,keys:t}=$(this._path);if($(t)===Q)return{done:!1,value:this.result()};let n=e.get($(t));return this._path.push({node:n,keys:Array.from(n.keys())}),this.dive()}backtrack(){if(this._path.length===0)return;let e=$(this._path).keys;e.pop(),!(e.length>0)&&(this._path.pop(),this.backtrack())}key(){return this.set._prefix+this._path.map(({keys:e})=>$(e)).filter(e=>e!==Q).join(``)}value(){return $(this._path).node.get(Q)}result(){switch(this._type){case Gn:return this.value();case Wn:return this.key();default:return[this.key(),this.value()]}}[Symbol.iterator](){return this}},$=e=>e[e.length-1],qn=(e,t,n)=>{let r=new Map;if(t===void 0)return r;let i=t.length+1,a=i+n,o=new Uint8Array(a*i).fill(n+1);for(let e=0;e<i;++e)o[e]=e;for(let e=1;e<a;++e)o[e*i]=e;return Jn(e,t,n,r,o,1,i,``),r},Jn=(e,t,n,r,i,a,o,s)=>{let c=a*o;key:for(let l of e.keys())if(l===Q){let t=i[c-1];t<=n&&r.set(s,[e.get(l),t])}else{let c=a;for(let e=0;e<l.length;++e,++c){let r=l[e],a=o*c,s=a-o,u=i[a],d=Math.max(0,c-n-1),f=Math.min(o-1,c+n);for(let e=d;e<f;++e){let n=r!==t[e],o=i[s+e]+ +n,c=i[s+e+1]+1,l=i[a+e]+1,d=i[a+e+1]=Math.min(o,c,l);d<u&&(u=d)}if(u>n)continue key}Jn(e.get(l),t,n,r,i,c,o,s+l)}},Yn=class e{constructor(e=new Map,t=``){this._size=void 0,this._tree=e,this._prefix=t}atPrefix(t){if(!t.startsWith(this._prefix))throw Error(`Mismatched prefix`);let[n,r]=Xn(this._tree,t.slice(this._prefix.length));if(n===void 0){let[n,i]=nr(r);for(let r of n.keys())if(r!==Q&&r.startsWith(i)){let a=new Map;return a.set(r.slice(i.length),n.get(r)),new e(a,t)}}return new e(n,t)}clear(){this._size=void 0,this._tree.clear()}delete(e){return this._size=void 0,$n(this._tree,e)}entries(){return new Kn(this,Un)}forEach(e){for(let[t,n]of this)e(t,n,this)}fuzzyGet(e,t){return qn(this._tree,e,t)}get(e){let t=Zn(this._tree,e);return t===void 0?void 0:t.get(Q)}has(e){let t=Zn(this._tree,e);return t!==void 0&&t.has(Q)}keys(){return new Kn(this,Wn)}set(e,t){if(typeof e!=`string`)throw Error(`key must be a string`);return this._size=void 0,Qn(this._tree,e).set(Q,t),this}get size(){if(this._size)return this._size;this._size=0;let e=this.entries();for(;!e.next().done;)this._size+=1;return this._size}update(e,t){if(typeof e!=`string`)throw Error(`key must be a string`);this._size=void 0;let n=Qn(this._tree,e);return n.set(Q,t(n.get(Q))),this}fetch(e,t){if(typeof e!=`string`)throw Error(`key must be a string`);this._size=void 0;let n=Qn(this._tree,e),r=n.get(Q);return r===void 0&&n.set(Q,r=t()),r}values(){return new Kn(this,Gn)}[Symbol.iterator](){return this.entries()}static from(t){let n=new e;for(let[e,r]of t)n.set(e,r);return n}static fromObject(t){return e.from(Object.entries(t))}},Xn=(e,t,n=[])=>{if(t.length===0||e==null)return[e,n];for(let r of e.keys())if(r!==Q&&t.startsWith(r))return n.push([e,r]),Xn(e.get(r),t.slice(r.length),n);return n.push([e,t]),Xn(void 0,``,n)},Zn=(e,t)=>{if(t.length===0||e==null)return e;for(let n of e.keys())if(n!==Q&&t.startsWith(n))return Zn(e.get(n),t.slice(n.length))},Qn=(e,t)=>{let n=t.length;outer:for(let r=0;e&&r<n;){for(let i of e.keys())if(i!==Q&&t[r]===i[0]){let a=Math.min(n-r,i.length),o=1;for(;o<a&&t[r+o]===i[o];)++o;let s=e.get(i);if(o===i.length)e=s;else{let n=new Map;n.set(i.slice(o),s),e.set(t.slice(r,r+o),n),e.delete(i),e=n}r+=o;continue outer}let i=new Map;return e.set(t.slice(r),i),i}return e},$n=(e,t)=>{let[n,r]=Xn(e,t);if(n!==void 0){if(n.delete(Q),n.size===0)er(r);else if(n.size===1){let[e,t]=n.entries().next().value;tr(r,e,t)}}},er=e=>{if(e.length===0)return;let[t,n]=nr(e);if(t.delete(n),t.size===0)er(e.slice(0,-1));else if(t.size===1){let[n,r]=t.entries().next().value;n!==Q&&tr(e.slice(0,-1),n,r)}},tr=(e,t,n)=>{if(e.length===0)return;let[r,i]=nr(e);r.set(i+t,n),r.delete(i)},nr=e=>e[e.length-1],rr=`or`,ir=`and`,ar=`and_not`,or=class e{constructor(e){if(e?.fields==null)throw Error(`MiniSearch: option "fields" must be provided`);let t=e.autoVacuum==null||e.autoVacuum===!0?_r:e.autoVacuum;this._options={...fr,...e,autoVacuum:t,searchOptions:{...pr,...e.searchOptions||{}},autoSuggestOptions:{...mr,...e.autoSuggestOptions||{}}},this._index=new Yn,this._documentCount=0,this._documentIds=new Map,this._idToShortId=new Map,this._fieldIds={},this._fieldLength=new Map,this._avgFieldLength=[],this._nextId=0,this._storedFields=new Map,this._dirtCount=0,this._currentVacuum=null,this._enqueuedVacuum=null,this._enqueuedVacuumConditions=gr,this.addFields(this._options.fields)}add(e){let{extractField:t,stringifyField:n,tokenize:r,processTerm:i,fields:a,idField:o}=this._options,s=t(e,o);if(s==null)throw Error(`MiniSearch: document does not have ID field "${o}"`);if(this._idToShortId.has(s))throw Error(`MiniSearch: duplicate ID ${s}`);let c=this.addDocumentId(s);this.saveStoredFields(c,e);for(let o of a){let a=t(e,o);if(a==null)continue;let s=r(n(a,o),o),l=this._fieldIds[o],u=new Set(s).size;this.addFieldLength(c,l,this._documentCount-1,u);for(let e of s){let t=i(e,o);if(Array.isArray(t))for(let e of t)this.addTerm(l,c,e);else t&&this.addTerm(l,c,t)}}}addAll(e){for(let t of e)this.add(t)}addAllAsync(e,t={}){let{chunkSize:n=10}=t,r={chunk:[],promise:Promise.resolve()},{chunk:i,promise:a}=e.reduce(({chunk:e,promise:t},r,i)=>(e.push(r),(i+1)%n===0?{chunk:[],promise:t.then(()=>new Promise(e=>setTimeout(e,0))).then(()=>this.addAll(e))}:{chunk:e,promise:t}),r);return a.then(()=>this.addAll(i))}remove(e){let{tokenize:t,processTerm:n,extractField:r,stringifyField:i,fields:a,idField:o}=this._options,s=r(e,o);if(s==null)throw Error(`MiniSearch: document does not have ID field "${o}"`);let c=this._idToShortId.get(s);if(c==null)throw Error(`MiniSearch: cannot remove document with ID ${s}: it is not in the index`);for(let o of a){let a=r(e,o);if(a==null)continue;let s=t(i(a,o),o),l=this._fieldIds[o],u=new Set(s).size;this.removeFieldLength(c,l,this._documentCount,u);for(let e of s){let t=n(e,o);if(Array.isArray(t))for(let e of t)this.removeTerm(l,c,e);else t&&this.removeTerm(l,c,t)}}this._storedFields.delete(c),this._documentIds.delete(c),this._idToShortId.delete(s),this._fieldLength.delete(c),--this._documentCount}removeAll(e){if(e)for(let t of e)this.remove(t);else if(arguments.length>0)throw Error(`Expected documents to be present. Omit the argument to remove all documents.`);else this._index=new Yn,this._documentCount=0,this._documentIds=new Map,this._idToShortId=new Map,this._fieldLength=new Map,this._avgFieldLength=[],this._storedFields=new Map,this._nextId=0}discard(e){let t=this._idToShortId.get(e);if(t==null)throw Error(`MiniSearch: cannot discard document with ID ${e}: it is not in the index`);this._idToShortId.delete(e),this._documentIds.delete(t),this._storedFields.delete(t),(this._fieldLength.get(t)||[]).forEach((e,n)=>{this.removeFieldLength(t,n,this._documentCount,e)}),this._fieldLength.delete(t),--this._documentCount,this._dirtCount+=1,this.maybeAutoVacuum()}maybeAutoVacuum(){if(this._options.autoVacuum===!1)return;let{minDirtFactor:e,minDirtCount:t,batchSize:n,batchWait:r}=this._options.autoVacuum;this.conditionalVacuum({batchSize:n,batchWait:r},{minDirtCount:t,minDirtFactor:e})}discardAll(e){let t=this._options.autoVacuum;try{this._options.autoVacuum=!1;for(let t of e)this.discard(t)}finally{this._options.autoVacuum=t}this.maybeAutoVacuum()}replace(e){let{idField:t,extractField:n}=this._options,r=n(e,t);this.discard(r),this.add(e)}vacuum(e={}){return this.conditionalVacuum(e)}conditionalVacuum(e,t){return this._currentVacuum?(this._enqueuedVacuumConditions=this._enqueuedVacuumConditions&&t,this._enqueuedVacuum??=this._currentVacuum.then(()=>{let t=this._enqueuedVacuumConditions;return this._enqueuedVacuumConditions=gr,this.performVacuuming(e,t)}),this._enqueuedVacuum):this.vacuumConditionsMet(t)===!1?Promise.resolve():(this._currentVacuum=this.performVacuuming(e),this._currentVacuum)}async performVacuuming(e,t){let n=this._dirtCount;if(this.vacuumConditionsMet(t)){let t=e.batchSize||hr.batchSize,r=e.batchWait||hr.batchWait,i=1;for(let[e,n]of this._index){for(let[e,t]of n)for(let[r]of t)this._documentIds.has(r)||(t.size<=1?n.delete(e):t.delete(r));this._index.get(e).size===0&&this._index.delete(e),i%t===0&&await new Promise(e=>setTimeout(e,r)),i+=1}this._dirtCount-=n}await null,this._currentVacuum=this._enqueuedVacuum,this._enqueuedVacuum=null}vacuumConditionsMet(e){if(e==null)return!0;let{minDirtCount:t,minDirtFactor:n}=e;return t||=_r.minDirtCount,n||=_r.minDirtFactor,this.dirtCount>=t&&this.dirtFactor>=n}get isVacuuming(){return this._currentVacuum!=null}get dirtCount(){return this._dirtCount}get dirtFactor(){return this._dirtCount/(1+this._documentCount+this._dirtCount)}has(e){return this._idToShortId.has(e)}getStoredFields(e){let t=this._idToShortId.get(e);if(t!=null)return this._storedFields.get(t)}search(t,n={}){let{searchOptions:r}=this._options,i={...r,...n},a=this.executeQuery(t,n),o=[];for(let[e,{score:t,terms:n,match:r}]of a){let a=n.length||1,s={id:this._documentIds.get(e),score:t*a,terms:Object.keys(r),queryTerms:n,match:r};Object.assign(s,this._storedFields.get(e)),(i.filter==null||i.filter(s))&&o.push(s)}return t===e.wildcard&&i.boostDocument==null||o.sort(br),o}autoSuggest(e,t={}){t={...this._options.autoSuggestOptions,...t};let n=new Map;for(let{score:r,terms:i}of this.search(e,t)){let e=i.join(` `),t=n.get(e);t==null?n.set(e,{score:r,terms:i,count:1}):(t.score+=r,t.count+=1)}let r=[];for(let[e,{score:t,terms:i,count:a}]of n)r.push({suggestion:e,terms:i,score:t/a});return r.sort(br),r}get documentCount(){return this._documentCount}get termCount(){return this._index.size}static loadJSON(e,t){if(t==null)throw Error(`MiniSearch: loadJSON should be given the same options used when serializing the index`);return this.loadJS(JSON.parse(e),t)}static async loadJSONAsync(e,t){if(t==null)throw Error(`MiniSearch: loadJSON should be given the same options used when serializing the index`);return this.loadJSAsync(JSON.parse(e),t)}static getDefault(e){if(fr.hasOwnProperty(e))return sr(fr,e);throw Error(`MiniSearch: unknown option "${e}"`)}static loadJS(e,t){let{index:n,documentIds:r,fieldLength:i,storedFields:a,serializationVersion:o}=e,s=this.instantiateMiniSearch(e,t);s._documentIds=Sr(r),s._fieldLength=Sr(i),s._storedFields=Sr(a);for(let[e,t]of s._documentIds)s._idToShortId.set(t,e);for(let[e,t]of n){let n=new Map;for(let e of Object.keys(t)){let r=t[e];o===1&&(r=r.ds),n.set(parseInt(e,10),Sr(r))}s._index.set(e,n)}return s}static async loadJSAsync(e,t){let{index:n,documentIds:r,fieldLength:i,storedFields:a,serializationVersion:o}=e,s=this.instantiateMiniSearch(e,t);s._documentIds=await Cr(r),s._fieldLength=await Cr(i),s._storedFields=await Cr(a);for(let[e,t]of s._documentIds)s._idToShortId.set(t,e);let c=0;for(let[e,t]of n){let n=new Map;for(let e of Object.keys(t)){let r=t[e];o===1&&(r=r.ds),n.set(parseInt(e,10),await Cr(r))}++c%1e3==0&&await wr(0),s._index.set(e,n)}return s}static instantiateMiniSearch(t,n){let{documentCount:r,nextId:i,fieldIds:a,averageFieldLength:o,dirtCount:s,serializationVersion:c}=t;if(c!==1&&c!==2)throw Error(`MiniSearch: cannot deserialize an index created with an incompatible version`);let l=new e(n);return l._documentCount=r,l._nextId=i,l._idToShortId=new Map,l._fieldIds=a,l._avgFieldLength=o,l._dirtCount=s||0,l._index=new Yn,l}executeQuery(t,n={}){if(t===e.wildcard)return this.executeWildcardQuery(n);if(typeof t!=`string`){let e={...n,...t,queries:void 0},r=t.queries.map(t=>this.executeQuery(t,e));return this.combineResults(r,e.combineWith)}let{tokenize:r,processTerm:i,searchOptions:a}=this._options,o={tokenize:r,processTerm:i,...a,...n},{tokenize:s,processTerm:c}=o,l=s(t).flatMap(e=>c(e)).filter(e=>!!e).map(dr(o)).map(e=>this.executeQuerySpec(e,o));return this.combineResults(l,o.combineWith)}executeQuerySpec(e,t){let n={...this._options.searchOptions,...t},r=(n.fields||this._options.fields).reduce((e,t)=>({...e,[t]:sr(n.boost,t)||1}),{}),{boostDocument:i,weights:a,maxFuzzy:o,bm25:s}=n,{fuzzy:c,prefix:l}={...pr.weights,...a},u=this._index.get(e.term),d=this.termResults(e.term,e.term,1,e.termBoost,u,r,i,s),f,p;if(e.prefix&&(f=this._index.atPrefix(e.term)),e.fuzzy){let t=e.fuzzy===!0?.2:e.fuzzy,n=t<1?Math.min(o,Math.round(e.term.length*t)):t;n&&(p=this._index.fuzzyGet(e.term,n))}if(f)for(let[t,n]of f){let a=t.length-e.term.length;if(!a)continue;p?.delete(t);let o=l*t.length/(t.length+.3*a);this.termResults(e.term,t,o,e.termBoost,n,r,i,s,d)}if(p)for(let t of p.keys()){let[n,a]=p.get(t);if(!a)continue;let o=c*t.length/(t.length+a);this.termResults(e.term,t,o,e.termBoost,n,r,i,s,d)}return d}executeWildcardQuery(e){let t=new Map,n={...this._options.searchOptions,...e};for(let[e,r]of this._documentIds){let i=n.boostDocument?n.boostDocument(r,``,this._storedFields.get(e)):1;t.set(e,{score:i,terms:[],match:{}})}return t}combineResults(e,t=rr){if(e.length===0)return new Map;let n=cr[t.toLowerCase()];if(!n)throw Error(`Invalid combination operator: ${t}`);return e.reduce(n)||new Map}toJSON(){let e=[];for(let[t,n]of this._index){let r={};for(let[e,t]of n)r[e]=Object.fromEntries(t);e.push([t,r])}return{documentCount:this._documentCount,nextId:this._nextId,documentIds:Object.fromEntries(this._documentIds),fieldIds:this._fieldIds,fieldLength:Object.fromEntries(this._fieldLength),averageFieldLength:this._avgFieldLength,storedFields:Object.fromEntries(this._storedFields),dirtCount:this._dirtCount,index:e,serializationVersion:2}}termResults(e,t,n,r,i,a,o,s,c=new Map){if(i==null)return c;for(let l of Object.keys(a)){let u=a[l],d=this._fieldIds[l],f=i.get(d);if(f==null)continue;let p=f.size,m=this._avgFieldLength[d];for(let i of f.keys()){if(!this._documentIds.has(i)){this.removeTerm(d,i,t),--p;continue}let a=o?o(this._documentIds.get(i),t,this._storedFields.get(i)):1;if(!a)continue;let h=f.get(i),g=this._fieldLength.get(i)[d],_=ur(h,p,this._documentCount,g,m,s),v=n*r*u*a*_,y=c.get(i);if(y){y.score+=v,vr(y.terms,e);let n=sr(y.match,t);n?n.push(l):y.match[t]=[l]}else c.set(i,{score:v,terms:[e],match:{[t]:[l]}})}}return c}addTerm(e,t,n){let r=this._index.fetch(n,xr),i=r.get(e);if(i==null)i=new Map,i.set(t,1),r.set(e,i);else{let e=i.get(t);i.set(t,(e||0)+1)}}removeTerm(e,t,n){if(!this._index.has(n)){this.warnDocumentChanged(t,e,n);return}let r=this._index.fetch(n,xr),i=r.get(e);i==null||i.get(t)==null?this.warnDocumentChanged(t,e,n):i.get(t)<=1?i.size<=1?r.delete(e):i.delete(t):i.set(t,i.get(t)-1),this._index.get(n).size===0&&this._index.delete(n)}warnDocumentChanged(e,t,n){for(let r of Object.keys(this._fieldIds))if(this._fieldIds[r]===t){this._options.logger(`warn`,`MiniSearch: document with ID ${this._documentIds.get(e)} has changed before removal: term "${n}" was not present in field "${r}". Removing a document after it has changed can corrupt the index!`,`version_conflict`);return}}addDocumentId(e){let t=this._nextId;return this._idToShortId.set(e,t),this._documentIds.set(t,e),this._documentCount+=1,this._nextId+=1,t}addFields(e){for(let t=0;t<e.length;t++)this._fieldIds[e[t]]=t}addFieldLength(e,t,n,r){let i=this._fieldLength.get(e);i??this._fieldLength.set(e,i=[]),i[t]=r;let a=(this._avgFieldLength[t]||0)*n+r;this._avgFieldLength[t]=a/(n+1)}removeFieldLength(e,t,n,r){if(n===1){this._avgFieldLength[t]=0;return}let i=this._avgFieldLength[t]*n-r;this._avgFieldLength[t]=i/(n-1)}saveStoredFields(e,t){let{storeFields:n,extractField:r}=this._options;if(n==null||n.length===0)return;let i=this._storedFields.get(e);i??this._storedFields.set(e,i={});for(let e of n){let n=r(t,e);n!==void 0&&(i[e]=n)}}};or.wildcard=Symbol(`*`);var sr=(e,t)=>Object.prototype.hasOwnProperty.call(e,t)?e[t]:void 0,cr={[rr]:(e,t)=>{for(let n of t.keys()){let r=e.get(n);if(r==null)e.set(n,t.get(n));else{let{score:e,terms:i,match:a}=t.get(n);r.score+=e,r.match=Object.assign(r.match,a),yr(r.terms,i)}}return e},[ir]:(e,t)=>{let n=new Map;for(let r of t.keys()){let i=e.get(r);if(i==null)continue;let{score:a,terms:o,match:s}=t.get(r);yr(i.terms,o),n.set(r,{score:i.score+a,terms:i.terms,match:Object.assign(i.match,s)})}return n},[ar]:(e,t)=>{for(let n of t.keys())e.delete(n);return e}},lr={k:1.2,b:.7,d:.5},ur=(e,t,n,r,i,a)=>{let{k:o,b:s,d:c}=a;return Math.log(1+(n-t+.5)/(t+.5))*(c+e*(o+1)/(e+o*(1-s+s*r/i)))},dr=e=>(t,n,r)=>({term:t,fuzzy:typeof e.fuzzy==`function`?e.fuzzy(t,n,r):e.fuzzy||!1,prefix:typeof e.prefix==`function`?e.prefix(t,n,r):e.prefix===!0,termBoost:typeof e.boostTerm==`function`?e.boostTerm(t,n,r):1}),fr={idField:`id`,extractField:(e,t)=>e[t],stringifyField:(e,t)=>e.toString(),tokenize:e=>e.split(Tr),processTerm:e=>e.toLowerCase(),fields:void 0,searchOptions:void 0,storeFields:[],logger:(e,t)=>{typeof(console==null?void 0:console[e])==`function`&&console[e](t)},autoVacuum:!0},pr={combineWith:rr,prefix:!1,fuzzy:!1,maxFuzzy:6,boost:{},weights:{fuzzy:.45,prefix:.375},bm25:lr},mr={combineWith:ir,prefix:(e,t,n)=>t===n.length-1},hr={batchSize:1e3,batchWait:10},gr={minDirtFactor:.1,minDirtCount:20},_r={...hr,...gr},vr=(e,t)=>{e.includes(t)||e.push(t)},yr=(e,t)=>{for(let n of t)e.includes(n)||e.push(n)},br=({score:e},{score:t})=>t-e,xr=()=>new Map,Sr=e=>{let t=new Map;for(let n of Object.keys(e))t.set(parseInt(n,10),e[n]);return t},Cr=async e=>{let t=new Map,n=0;for(let r of Object.keys(e))t.set(parseInt(r,10),e[r]),++n%1e3==0&&await wr(0);return t},wr=e=>new Promise(t=>setTimeout(t,e)),Tr=/[\n\r\p{Z}\p{P}]+/u;function Er(e){return e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`)}function Dr(e,t){if(!t.trim())return[e];let n=Er(t);return e.split(RegExp(`(${n})`,`gi`)).map((e,n)=>e.toLowerCase()===t.toLowerCase()?(0,T.jsx)(`mark`,{className:`bg-accent/20 text-ink font-bold px-0.5 rounded-none`,children:e},n):e)}function Or(e,t){let[n,r]=(0,x.useState)(e);return(0,x.useEffect)(()=>{let n=setTimeout(()=>r(e),t);return()=>clearTimeout(n)},[e,t]),n}function kr({defaultQuery:t=``}){let{lang:r}=a(),{posts:i}=k(),[o,s]=(0,x.useState)(t),[c,l]=(0,x.useState)([]),[u,d]=(0,x.useState)(!1),p=(0,x.useRef)(null),m=(0,x.useRef)(null);(0,x.useEffect)(()=>{t&&s(t)},[t]);let h=Or(o,200);(0,x.useEffect)(()=>{let e=new or({fields:[`title`,`titleEn`,`tags`,`excerpt`,`excerptEn`],storeFields:[`id`,`slug`,`title`,`titleEn`,`excerpt`,`excerptEn`,`tags`,`date`,`readingTime`],searchOptions:{boost:{title:3,titleEn:3,tags:2,excerpt:1,excerptEn:1},fuzzy:.2,prefix:!0}});return e.addAll(i),p.current=e,d(!0),()=>{p.current=null}},[i]),(0,x.useEffect)(()=>{if(!h.trim()||!p.current){l([]);return}l(p.current.search(h).map(e=>i.find(t=>t.id===e.id)).filter(e=>e!==void 0))},[h,i]);let g=(0,x.useCallback)(()=>{s(``),l([]),m.current?.focus()},[]),_=(0,x.useCallback)(e=>{window.location.hash=`#blog/article/${e.slug}`,s(``),l([])},[]),v=o.trim().length>0,b=c.length>0;return(0,T.jsxs)(`div`,{className:`mb-8`,children:[(0,T.jsxs)(`div`,{className:`relative`,children:[(0,T.jsx)(y,{size:14,className:`absolute left-3 top-1/2 -translate-y-1/2 text-ink-muted pointer-events-none`}),(0,T.jsx)(`input`,{ref:m,type:`text`,value:o,onChange:e=>s(e.target.value),placeholder:r===`es`?`Buscar artículos…`:`Search articles…`,className:`w-full border-2 border-rule bg-paper px-9 py-2.5 font-mono text-xs text-ink placeholder:text-ink-muted outline-none focus:bg-paper-dark transition-colors`,"aria-label":r===`es`?`Buscar artículos`:`Search articles`}),v&&(0,T.jsx)(`button`,{onClick:g,className:`absolute right-3 top-1/2 -translate-y-1/2 text-ink-muted hover:text-accent transition-colors cursor-pointer`,"aria-label":`Clear search`,children:(0,T.jsx)(e,{size:14})})]}),(0,T.jsx)(f,{children:v&&(0,T.jsx)(n.div,{initial:{opacity:0,y:-8},animate:{opacity:1,y:0},exit:{opacity:0,y:-8},transition:{duration:.15},className:`border-x-2 border-b-2 border-rule bg-paper shadow-pixel-sm mt-0`,children:u?b?(0,T.jsx)(`ul`,{className:`divide-y divide-rule-light`,children:c.map(e=>{let t=r===`es`?e.title:e.titleEn,n=r===`es`?e.excerpt:e.excerptEn;return(0,T.jsx)(`li`,{children:(0,T.jsxs)(`button`,{onClick:()=>_(e),className:`w-full text-left px-4 py-3 hover:bg-paper-dark transition-colors cursor-pointer`,children:[(0,T.jsx)(`h4`,{className:`font-headline text-sm font-bold text-ink leading-tight mb-1`,children:Dr(t,h)}),(0,T.jsx)(`p`,{className:`font-sans text-[11px] text-ink-light leading-relaxed line-clamp-2`,children:Dr(n,h)}),(0,T.jsxs)(`div`,{className:`flex items-center gap-2 mt-1.5`,children:[(0,T.jsx)(`span`,{className:`font-mono text-[9px] text-ink-muted`,children:e.date}),(0,T.jsxs)(`span`,{className:`font-mono text-[9px] text-ink-muted`,children:[e.readingTime,` min`]})]})]})},e.id)})}):(0,T.jsx)(`div`,{className:`p-4`,children:(0,T.jsx)(j,{context:`search`,searchQuery:h})}):(0,T.jsx)(`div`,{className:`p-4 text-center`,children:(0,T.jsx)(`p`,{className:`font-mono text-[10px] text-ink-muted`,children:r===`es`?`Indexando…`:`Indexing…`})})})})]})}function Ar(){let{t:e}=a(),t=ee(),{posts:r,selectedPost:i,setSelectedPost:o,setFilter:c}=k(),l=t.currentRoute===`article`&&t.selectedSlug?r.find(e=>e.slug===t.selectedSlug)??null:null;(0,x.useLayoutEffect)(()=>{t.currentRoute===`tag`&&t.currentParams.tag?c({tags:[t.currentParams.tag],category:null,dateRange:null}):(t.currentRoute===`list`||t.currentRoute===`search`)&&c({tags:[],category:null,dateRange:null}),t.currentRoute!==`article`&&o(null)},[t.currentRoute,t.selectedSlug,t.currentParams.tag]),(0,x.useLayoutEffect)(()=>{l&&l!==i&&o(l)},[l]);let u=t.currentRoute===`article`?`article-${t.selectedSlug}`:t.currentRoute;return(0,T.jsxs)(`section`,{id:`blog`,className:`py-20 px-6 max-w-7xl mx-auto`,children:[(0,T.jsx)(`div`,{className:`mb-10`,children:(0,T.jsx)(s,{section:`blog`,title:e(`blog.title`),subtitle:e(`blog.subtitle`)})}),(0,T.jsx)(f,{mode:`sync`,children:(0,T.jsx)(n.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},exit:{opacity:0,y:-10},transition:{duration:.2},children:t.currentRoute===`article`?i||l?(0,T.jsx)(zn,{}):null:(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(Hn,{}),(0,T.jsx)(kr,{defaultQuery:t.currentRoute===`search`?t.currentParams.q??``:``}),(0,T.jsx)(N,{})]})},u)})]})}function jr(){return(0,T.jsx)(O,{children:(0,T.jsx)(Ar,{})})}export{jr as BlogRoot};