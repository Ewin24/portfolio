          ...
          {recommendations.map((post, i) => {
            ...
            return (
              <motion.article
                ...
                className="border-2 border-ink bg-paper shadow-pixel-sm hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 transition-all duration-75 flex flex-col"
              >
                <button
