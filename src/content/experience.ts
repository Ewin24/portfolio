...
export const workExperience: WorkExperience[] = [
  ...
  // ═════════════════════════════════════════════════════════════════════════
  {
    ...
    achievements: [
      ...
      'Extendí el sistema de generación de documentos del ERP Baguer para soportar 3 nuevos tipos de nómina cliente de franquicias, creando 21 plantillas Crystal Reports sin afectar 45+ tipos legacy',
    ],
    achievementsEn: [
      ...
      'Extended the ERP Baguer document generation system to support 3 new franchise-chain payroll types, creating 21 Crystal Reports templates without affecting 45+ legacy types',
    ],
